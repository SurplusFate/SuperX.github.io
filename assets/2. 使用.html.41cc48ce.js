import{_ as n}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as s,c as a,e as t}from"./app.4eaed3b5.js";const p={},e=t(`<h1 id="_2-使用" tabindex="-1"><a class="header-anchor" href="#_2-使用" aria-hidden="true">#</a> 2. 使用</h1><h2 id="编写实体类-pojo-bean-层" tabindex="-1"><a class="header-anchor" href="#编写实体类-pojo-bean-层" aria-hidden="true">#</a> 编写实体类(pojo/bean 层)</h2><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">User</span> <span class="token punctuation">{</span>
