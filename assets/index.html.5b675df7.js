import{_ as a}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as i,c as d,a as s,b as l,d as r,e,r as c}from"./app.b8ec8d86.js";const t={},o=e(`<h1 id="安装-redis" tabindex="-1"><a class="header-anchor" href="#安装-redis" aria-hidden="true">#</a> 安装 Redis</h1><p>大多数企业都是基于 Linux 服务器来部署项目，而且 Redis 官方也没有提供 Windows 版本的安装包。</p><p>此处选择的 Linux 版本为 CentOS 7.</p><h2 id="依赖库" tabindex="-1"><a class="header-anchor" href="#依赖库" aria-hidden="true">#</a> 依赖库</h2><p>Redis 是基于 C 语言编写的，因此首先需要安装 Redis 所需要的 gcc 依赖：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> gcc tcl
