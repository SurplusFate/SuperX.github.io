<template><div><h1 id="_10-面向对象-下" tabindex="-1"><a class="header-anchor" href="#_10-面向对象-下" aria-hidden="true">#</a> 10. 面向对象（下）</h1>
<h2 id="包装类" tabindex="-1"><a class="header-anchor" href="#包装类" aria-hidden="true">#</a> 包装类</h2>
<p>Java 的 8 种基本数据类型不支持面向对象的编程机制，基本数据类型的数据也不具备“对象”的特性：没有 Field、方法可以被调用。</p>
<p>在某些时候，基本数据类型会有一些制约，例如所有引用类型的变量都继承了 Object 类，都可当成 Object 类型变量使用。但基本数据类型的变量就不可以，如果有个方法需要 Object 类型的参数，但实际需要的值却是 2、3 等数值，这可能就比较难以处理。</p>
<p>为了解决 8 种基本数据类型的变量不能当成 Object 类型变量使用的问题，Java 提供了包装类（Wrapper Class）的概念，为 8 种基本数据类型分别定义了相应的引用类型，并称之为基本数据类型的包装类。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207121505498.jpeg" alt="img"></p>
<p>把基本数据类型变量包装成包装类实例是通过对应包装类的构造器来实现的，8 个包装类中除了 <code v-pre>Character</code> 之外，还可以通过传入一个字符串参数来构建包装类对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Primitive2Wrapper</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当试图使用一个字符串来创建 <code v-pre>Boolean</code> 对象时，如果传入的字符串是&quot;true&quot;，或是此字符串不同字母的大小写变化形式，如&quot;True&quot;，都将创建 <code v-pre>true</code> 对应的 <code v-pre>Boolean</code> 对象；如果传入其他字符串，则会创建 <code v-pre>false</code> 对应的 <code v-pre>Boolean</code> 对象。</p>
<p>如果希望获得包装类对象中包装的基本类型变量，则可以使用包装类提供的 <code v-pre>xxxValue()</code> 实例方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 取出Boolean对象里的boolean变量</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>基本类型变量和包装类对象之间的转换关系如图：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207121606801.jpeg" alt="img"></p>
<p>JDK 1.5 提供了自动装箱（<code v-pre>Autoboxing</code>）和自动拆箱（<code v-pre>AutoUnboxing</code>）功能。</p>
<p>所谓自动装箱，就是可以把一个基本类型变量直接赋给对应的包装类变量，或者赋给 <code v-pre>Object</code> 变量（Object 是所有类的父类，子类对象可以直接赋给父类变量）；自动拆箱则与之相反，允许直接把包装类对象直接赋给一个对应的基本类型变量。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AutoBoxingUnboxing</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>进行自动装箱和自动拆箱时必须注意类型匹配，例如 <code v-pre>Integer</code> 只能自动拆箱成 <code v-pre>int</code> 类型变量，不要试图拆箱成 <code v-pre>boolean</code> 类型变量；与之类似的是，<code v-pre>int</code> 类型变量只能自动装箱成 <code v-pre>Integer</code> 对象（即使赋给 Object 类型变量，那也只是利用了 Java 的向上自动转型特性），不要试图装箱成 <code v-pre>Boolean</code> 对象。</p>
<p>包装类还可实现基本类型变量和字符串之间的转换。把字符串类型的值转换为基本类型的值有两种方式。</p>
<blockquote>
<ol>
<li>利用包装类提供的 <code v-pre>parseXxx(String s)</code> 静态方法（除了 <code v-pre>Character</code> 之外的所有包装类都提供了该方法。</li>
<li>利用包装类提供的 <code v-pre>Xxx(String s)</code> 构造器。</li>
</ol>
</blockquote>
<p><code v-pre>String</code> 类提供了多个重载 <code v-pre>valueOf()</code> 方法，用于将基本类型变量转换成字符串。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Primitive2String</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>基本类型变量和字符串之间的转换关系：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207121652801.jpeg" alt="img"></p>
<p>如果希望把基本类型变量转换成字符串，还有一种更简单的方法：将基本类型变量和 <code v-pre>&quot;&quot;</code> 进行连接运算，系统会自动把基本类型变量转换成字符串。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// intStr的值为"5"</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>虽然包装类型的变量是引用数据类型，但包装类的实例可以与数值类型的值进行比较，这种比较是直接取出包装类实例所包装的数值来进行比较的。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>两个包装类的实例进行比较的情况就比较复杂，因为包装类的实例实际上是引用类型，只有两个包装类引用指向同一个对象时才会返回 <code v-pre>true</code>。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 输出false</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>自动装箱可以直接把一个基本类型值赋给一个包装类实例，在这种情况下可能会出现一些特别的情形。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 通过自动装箱，允许把基本类型值赋值给包装类实例</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>查看 Java 系统中 <code v-pre>java.lang.Integer</code> 类的源代码，如下所示。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 定义一个长度为256的Integer数组</span>
...
<p>系统把一个 -128 ～ 127 之间的整数自动装箱成 <code v-pre>Integer</code> 实例，并放入了一个名为 <code v-pre>cache</code> 的数组中缓存起来。如果以后把一个 -128 ～ 127 之间的整数自动装箱成一个 <code v-pre>Integer</code> 实例时，实际上是直接指向对应的数组元素，因此 -128 ～ 127 之间的同一个整数自动装箱成 <code v-pre>Integer</code> 实例时，永远都是引用 <code v-pre>cache</code> 数组的同一个数组元素，所以它们全部相等；但每次把一个不在 -128 ～ 127 范围内的整数自动装箱成 <code v-pre>Integer</code> 实例时，系统总是重新创建一个 <code v-pre>Integer</code> 实例，所以出现程序中的运行结果。</p>
</blockquote>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>Java 会把一些创建成本大、需要频繁使用的对象缓存起来，从而提高程序的运行性能。</p>
<p>缓存是一种非常优秀的设计模式，在 Java、Java EE 平台的很多地方都会通过缓存来提高系统的运行性能。</p>
<p>简单地说，如果你需要一台电脑，那么你就去买了一台电脑。但你不可能一直使用这台电脑，你总会离开这台电脑——在你离开电脑的这段时间内，你会不会立即把电脑扔掉？</p>
<p>当然不会，你会把电脑放在房间里，等下次又需要电脑时直接开机使用，而不是再次去购买一台。假设电脑是内存中的对象，而你的房间是内存，如果房间足够大，则可以把所有曾经用过的各种东西都缓存起来，但这不可能，房间的空间是有限制的，因此有些东西你用过一次就扔掉了。</p>
<p>你只会把一些购买成本大、需要频繁使用的东西保存下来。</p>
</div>
<p>Java 为所有的包装类都提供了一个静态的 <code v-pre>compare(xxx val1, xxx val2)</code> 方法，这样开发者就可以通过包装类提供的 <code v-pre>compare(xxx val1, xxx val2)</code> 方法来比较两个基本类型值的大小，包括比较两个 <code v-pre>boolean</code> 类型值，两个 <code v-pre>boolean</code> 类型值进行比较时，<code v-pre>true &gt; false</code>。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 输出1</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="处理对象" tabindex="-1"><a class="header-anchor" href="#处理对象" aria-hidden="true">#</a> 处理对象</h2>
<p>Java 对象都是 Object 类的实例，都可直接调用该类中定义的方法，这些方法提供了处理 Java 对象的通用方法。</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PrintObject</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编译、运行上面程序，看到如下运行结果：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>Person@f58205
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>@符号后的 6 位十六进制数字可能发生改变。但这个输出结果是怎么来的呢？</p>
<p><code v-pre>System.out.println</code> 方法只能在控制台输出字符串，而 <code v-pre>Person</code> 实例是一个内存中的对象，当使用该方法输出 <code v-pre>Person</code> 对象时，实际上输出的是 <code v-pre>Person</code> 对象的 <code v-pre>toString()</code> 方法的返回值。</p>
<p>下面两行代码的效果完全一样。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span>p<span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>toString()</code> 方法是 Object 类里的一个实例方法，所有的 Java 类都是 Object 类的子类，因此所有的 Java 对象都具有 <code v-pre>toString()</code> 方法。</p>
<p>所有的 Java 对象都可以和字符串进行连接运算，当 Java 对象和字符串进行连接运算时，系统自动调用 Java 对象 <code v-pre>toString</code> 方法的返回值和字符串进行连接运算，即下面两行代码的结果也完全相同。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> pStr <span class="token operator">=</span> p <span class="token operator">+</span> <span class="token string">""</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>toString</code> 方法是一个非常特殊的方法，它是一个“自我描述”方法，该方法通常用于实现这样一个功能：当程序员直接打印该对象时，系统将会输出该对象的“自我描述”信息，用以告诉外界该对象具有的状态信息。</p>
<p>Object 类提供的 <code v-pre>toString</code> 方法总是返回该对象实现类的 <code v-pre>类名+@+hashCode</code> 值，这个返回值并不能真正实现“自我描述”的功能，因此如果用户需要自定义类能实现“自我描述”的功能，就必须重写 Object 类的 <code v-pre>toString</code> 方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Apple</span> <span class="token punctuation">{</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>一个苹果，颜色是:红色，重量是:5.68
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>大部分时候，重写 <code v-pre>toString</code> 方法总是返回该对象的所有令人感兴趣的信息所组成的字符串。通常可返回如下格式的字符串：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>类名<span class="token punctuation">[</span>Field1 <span class="token operator">=</span> 值1，Field2 <span class="token operator">=</span> 值2,<span class="token punctuation">..</span>.<span class="token punctuation">]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>将上面 <code v-pre>Apple</code> 类的 <code v-pre>toString</code> 方法改为如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token class-name">String</span> <span class="token function">toString</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个 <code v-pre>toString</code> 方法提供了足够的有效信息来描述 <code v-pre>Apple</code> 对象，也就实现了 <code v-pre>toString</code> 方法的功能。</p>
<h3 id="equals" tabindex="-1"><a class="header-anchor" href="#equals" aria-hidden="true">#</a> <code v-pre>equals</code></h3>
<p>Java 程序中测试两个变量是否相等有两种方式：一种是利用 <code v-pre>==</code> 运算符，另一种是利用 <code v-pre>equals</code> 方法。</p>
<p>当使用 <code v-pre>==</code> 来判断两个变量是否相等时，如果两个变量是基本类型变量，且都是数值类型（不一定要求数据类型严格相同），则只要两个变量的值相等，就将返回 <code v-pre>true</code>。</p>
<p>但对于两个引用类型变量，它们必须指向同一个对象时，<code v-pre>==</code> 判断才会返回 <code v-pre>true</code>。</p>
<p><code v-pre>==</code> 不可用于比较类型上没有父子关系的两个对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">EqualTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>&quot;hello&quot;</code> 直接量和 <code v-pre>new String(&quot;hello&quot;)</code> 有什么区别呢？</p>
<p>当 Java 程序直接使用形如 <code v-pre>&quot;hello&quot;</code> 的字符串直接量（包括可以在编译时就计算出来的字符串值）时，JVM 将会使用常量池来管理这些字符串；当使用 <code v-pre>new String(&quot;hello&quot;)</code> 时，JVM 会先使用常量池来管理 <code v-pre>&quot;hello&quot;</code> 直接量，再调用 <code v-pre>String</code> 类的构造器来创建一个新的 <code v-pre>String</code> 对象，新创建的 String 对象被保存在堆内存中。</p>
<p>换句话说，<code v-pre>new String(&quot;hello&quot;)</code> 一共产生了两个对象。</p>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>常量池（constant pool）专门用于管理在编译期被确定并被保存在已编译的 <code v-pre>.class</code> 文件中的一些数据。它包括了关于类、方法、接口中的常量，还包括字符串常量。</p>
</div>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringCompareTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>使用 <code v-pre>new String()</code> 创建的字符串对象是运行时创建出来的，它被保存在运行时内存区内（即堆内存），不会放入常量池中。</p>
<blockquote>
<p>很多时候，程序判断两个引用变量是否相等时，也希望有一种类似于“值相等”的判断规则，并不严格要求两个引用变量指向同一个对象。</p>
<p>例如对于两个字符串变量，可能只是要求它们引用字符串对象里包含的字符序列相同即可认为相等。</p>
<p>此时就可以利用 <code v-pre>String</code> 对象的 <code v-pre>equals</code> 方法来进行判断。</p>
</blockquote>
<p><code v-pre>equals</code> 方法是 <code v-pre>Object</code> 类提供的一个实例方法，因此所有引用变量都可调用该方法来判断是否与其他引用变量相等。但使用这个方法判断两个对象相等的标准与使用 <code v-pre>==</code> 运算符没有区别，同样要求两个引用变量指向同一个对象才会返回 <code v-pre>true</code>。</p>
<p>因此这个 <code v-pre>Object</code> 类提供的 <code v-pre>equals</code> 方法没有太大的实际意义，如果希望采用自定义的相等标准，则可采用重写 <code v-pre>equals</code> 方法来实现。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p><code v-pre>String</code> 已经重写了 <code v-pre>Object</code> 的 <code v-pre>equals()</code> 方法，<code v-pre>String</code> 的 <code v-pre>equals()</code> 方法判断两个字符串相等的标准是：只要两个字符串所包含的字符序列相同，通过 <code v-pre>equals()</code> 比较将返回 <code v-pre>true</code>，否则将返回 <code v-pre>false</code>。</p>
</div>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>重写 <code v-pre>equals</code> 方法就是提供自定义的相等标准，你认为怎样是相等，那就怎样是相等，一切都是你做主！在极端的情况下，你可以让 <code v-pre>Person</code> 对象和 <code v-pre>Dog</code> 对象相等。</p>
</div>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">OverrideEqualsError</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当然大部分时候，我们还是希望两个类型相同的对象才可能相等。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token class-name">String</span> name<span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">OverrideEqualsRight</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通常而言，正确地重写 equals 方法应该满足下列条件。</p>
<blockquote>
<ol>
<li>自反性：对任意 x，<code v-pre>x.equals(x)</code> 一定返回 <code v-pre>true</code>。</li>
<li>对称性：对任意 x 和 y，如果 <code v-pre>y.equals(x)</code> 返回 <code v-pre>true</code>，则 <code v-pre>x.equals(y)</code> 也返回 <code v-pre>true</code>。</li>
<li>传递性：对任意 x, y, z，如果 <code v-pre>x.equals(y)</code> 返回 <code v-pre>true</code>，<code v-pre>y.equals(z)</code> 返回 <code v-pre>true</code>，则 <code v-pre>x.equals(z)</code> 一定返回 <code v-pre>true</code>。</li>
<li>一致性：对任意 x 和 y，如果对象中用于等价比较的信息没有改变，那么无论调用 <code v-pre>x.equals(y)</code> 多少次，返回的结果应该保持一致，要么一直是 <code v-pre>true</code>，要么一直是 <code v-pre>false</code>。</li>
<li>对任何不是 <code v-pre>null</code> 的 x，<code v-pre>x.equals(null)</code> 一定返回 <code v-pre>false</code>。</li>
</ol>
</blockquote>
<p><code v-pre>Object</code> 默认提供的 <code v-pre>equals()</code> 只是比较对象的地址，即 <code v-pre>Object</code> 类的 <code v-pre>equals</code> 方法比较的结果与 <code v-pre>==</code> 运算符比较的结果完全相同。</p>
<p>因此，在实际应用中常常需要重写 <code v-pre>equals</code> 方法，重写 <code v-pre>equals</code> 方法时，相等条件是由系统要求决定的，因此 <code v-pre>equals</code> 方法的实现也是由系统要求决定的。</p>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>判断 <code v-pre>obj</code> 是否为 <code v-pre>Person</code> 类的实例时，为何不用 <code v-pre>obj instanceof Person</code> 来判断呢？</p>
<p>对于 <code v-pre>instanceof</code> 运算符而言，当前面对象是后面类的实例或其子类的实例时都将返回 <code v-pre>true</code>，所以实际上重写 <code v-pre>equals()</code> 方法判断两个对象是否为同一个类的实例时使用 <code v-pre>instanceof</code> 是有问题的。</p>
<p>比如有一个 <code v-pre>Teacher</code> 类型的变量 <code v-pre>t</code>，如果判断 <code v-pre>t instanceof Person</code>，这也将返回 <code v-pre>true</code>。但对于重写 <code v-pre>equals()</code> 方法的要求而言，通常要求两个对象是同一个类的实例，因此使用 <code v-pre>instanceof</code> 运算符不太合适。改为使用 <code v-pre>t.getClass()==Person.class</code> 比较合适。这行代码用到了反射基础。</p>
<h2 id="类成员" tabindex="-1"><a class="header-anchor" href="#类成员" aria-hidden="true">#</a> 类成员</h2>
<p><code v-pre>static</code> 关键字修饰的成员就是类成员，类成员有类 Field、类方法、静态初始化块等三个成分，<code v-pre>static</code> 关键字不能修饰构造器。<code v-pre>static</code> 修饰的类成员属于整个类，不属于单个实例。</p>
<h3 id="理解类成员" tabindex="-1"><a class="header-anchor" href="#理解类成员" aria-hidden="true">#</a> 理解类成员</h3>
<p>在 Java 类里只能包含 Field、方法、构造器、初始化块、内部类（包括接口、枚举）5 种成员，其中 <code v-pre>static</code> 可以修饰 Field、方法、初始化块、内部类（包括接口、枚举），以 <code v-pre>static</code> 修饰的成员就是类成员。</p>
<p>类 Field 属于整个类，当系统第一次准备使用该类时，系统会为该类 Field 分配内存空间，类 Field 开始生效，直到该类被卸载，该类的类 Field 所占有的内存才被系统的垃圾回收机制回收。系统不会再为类 Field 分配内存，也不会再次对类 Field 进行初始化，类 Field 生存范围几乎等同于该类的生存范围。当类初始化完成后，类 Field 也被初始化完成。</p>
<p>类 Field 既可通过类来访问，也可通过类的对象来访问。但通过对象访问类 Field 只是一种假象，当通过对象来访问类 Field 时，系统会在底层转换为通过该类来访问类 Field，对象根本不拥有对应类的类 Field。</p>
<p>类方法也是类成员的一种，类方法也是属于类的，通常直接使用类作为调用者来调用类方法，但也可以使用对象来调用类方法。与类 Field 类似，即使使用对象来调用类方法，其效果也与采用类来调用类方法完全一样。</p>
<p>当使用实例来访问类成员时，实际上依然是委托给该类来访问类成员，因此即使某个实例为 null，它也可以访问它所属类的类成员。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">NullAccessStatic</span> <span class="token punctuation">{</span>
...
<p class="custom-container-title">提示</p>
<p>如果一个 null 对象访问实例成员（包括 Field 和方法），将会引发 <code v-pre>NullPointerException</code> 异常，因为 null 表明该实例根本不存在，既然实例不存在，理所当然的，它的 Field 和方法也不存在。</p>
</div>
</div>
<p>静态初始化块也是类成员的一种，静态初始化块用于执行类初始化动作，在类的初始化阶段，系统会调用该类的静态初始化块来对类进行初始化。一旦该类初始化结束后，静态初始化块将永远不会获得执行的机会。</p>
<p>对 <code v-pre>static</code> 关键字而言，有一条非常重要的规则：</p>
<blockquote>
<p>类成员（包括方法、初始化块、内部类和枚举类）不能访问实例成员（包括 Field、方法、初始化块、内部类和枚举类）。</p>
<p>因为类成员是属于类的，类成员的作用域比实例成员的作用域更大，完全可能出现类成员已经初始化完成，但实例成员还不曾初始化的情况，如果允许类成员访问实例成员将会引起大量错误。</p>
</blockquote>
<h3 id="单例" tabindex="-1"><a class="header-anchor" href="#单例" aria-hidden="true">#</a> 单例</h3>
<p>在某些时候，允许其他类自由创建该类的对象没有任何意义，还可能造成系统性能下降（因为频繁地创建对象、回收对象带来的系统开销问题）。例如，系统可能只有一个窗口管理器、一个假脱机打印设备或一个数据库引擎访问点，此时如果在系统中为这些类创建多个对象就没有太大的实际意义。</p>
<p>如果一个类始终只能创建一个实例，则这个类被称为单例类。</p>
<p>在一些特殊场景下，要求不允许自由创建该类的对象，而只允许为该类创建一个对象。为了避免其他类自由创建该类的实例，我们把该类的构造器使用 <code v-pre>private</code> 修饰，从而把该类的所有构造器隐藏起来。</p>
<p>一旦把该类的构造器隐藏起来，就需要提供一个 <code v-pre>public</code> 方法作为该类的访问点，用于创建该类的对象，且该方法必须使用 <code v-pre>static</code> 修饰（因为调用该方法之前还不存在对象，因此调用该方法的不可能是对象，只能是类）。</p>
<p>除此之外，该类还必须缓存已经创建的对象，否则该类无法知道是否曾经创建过对象，也就无法保证只创建一个对象。为此该类需要使用一个成员变量来保存曾经创建的对象，因为该成员变量需要被上面的静态方法访问，故该成员变量必须使用 <code v-pre>static</code> 修饰。</p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SingletonTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>正是通过上面 <code v-pre>getInstance</code> 方法提供的自定义控制（这也是封装的优势：不允许自由访问类的 Field 和实现细节，而是通过方法来控制合适暴露），保证 <code v-pre>Singleton</code> 类只能产生一个实例。所以，在 <code v-pre>SingletonTest</code> 类的 <code v-pre>main</code> 方法中，看到两次产生的 <code v-pre>Singleton</code> 对象实际上是同一个对象。</p>
<h2 id="final" tabindex="-1"><a class="header-anchor" href="#final" aria-hidden="true">#</a> <code v-pre>final</code></h2>
<p><code v-pre>final</code> 关键字可用于修饰类、变量和方法，<code v-pre>final</code> 关键字有点类似 C# 里的 <code v-pre>sealed</code> 关键字，用于表示它修饰的类、方法和变量不可改变。</p>
<p><code v-pre>final</code> 修饰变量时，表示该变量一旦获得了初始值就不可被改变，<code v-pre>final</code> 既可以修饰成员变量（包括类变量和实例 Z 变量），也可以修饰局部变量、形参。</p>
<p><code v-pre>final</code> 修饰的变量不可被改变，一旦获得了初始值，该 <code v-pre>final</code> 变量的值就不能被重新赋值。</p>
<p>因为 <code v-pre>final</code> 变量获得初始值之后不能被重新赋值，因此 <code v-pre>final</code> 修饰成员变量和修饰局部变量时有一定的不同。</p>
<h3 id="final-成员变量" tabindex="-1"><a class="header-anchor" href="#final-成员变量" aria-hidden="true">#</a> <code v-pre>final</code> 成员变量</h3>
<p>对于 <code v-pre>final</code> 修饰的成员变量而言，一旦有了初始值，就不能被重新赋值，如果既没有在定义成员变量时指定初始值，也没有在初始化块、构造器中为成员变量指定初始值，那么这些成员变量的值将一直是系统默认分配的 <code v-pre>0</code>、<code v-pre>'\u0000'</code>、<code v-pre>false</code> 或 <code v-pre>null</code>，这些成员变量也就完全失去了存在的意义。</p>
<p>因此 Java 语法规定： <mark>final 修饰的成员变量必须由程序员显式地指定初始值</mark>。</p>
<p><code v-pre>final</code> 修饰的类 Field、实例 Field 能指定初始值的地方如下。</p>
<blockquote>
<ol>
<li>类 Field：必须在静态初始化块中或声明该 Field 时指定初始值。</li>
<li>实例 Field：必须在非静态初始化块、声明该 Field 或构造器中指定初始值。</li>
</ol>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FinalVariableTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果打算在构造器、初始化块中对 final 成员变量进行初始化，则不要在初始化之前就访问成员变量的值。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FinalErrorTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="final-局部变量" tabindex="-1"><a class="header-anchor" href="#final-局部变量" aria-hidden="true">#</a> <code v-pre>final</code> 局部变量</h3>
<p>==系统不会对局部变量进行初始化，局部变量必须由程序员显式初始化。==因此使用 <code v-pre>final</code> 修饰局部变量时，既可以在定义时指定默认值，也可以不指定默认值。</p>
<p>如果 <code v-pre>final</code> 修饰的局部变量在定义时没有指定默认值，则可以在后面代码中对该 <code v-pre>final</code> 变量赋初始值，但只能一次，不能重复赋值；如果 <code v-pre>final</code> 修饰的局部变量在定义时已经指定默认值，则后面代码中不能再对该变量赋值。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FinalLocalVariableTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="final-对象" tabindex="-1"><a class="header-anchor" href="#final-对象" aria-hidden="true">#</a> <code v-pre>final</code> 对象</h3>
<p>当使用 <code v-pre>final</code> 修饰基本类型变量时，不能对基本类型变量重新赋值，因此基本类型变量不能被改变。但对于引用类型变量而言，它保存的仅仅是一个引用，<code v-pre>final</code> 只保证这个引用类型变量所引用的地址不会改变，即一直引用同一个对象，但这个对象完全可以发生改变。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FinalReferenceTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="宏变量" tabindex="-1"><a class="header-anchor" href="#宏变量" aria-hidden="true">#</a> 宏变量</h3>
<p>对一个 <code v-pre>final</code> 变量来说，不管它是类 Field、实例 Field，还是局部变量，只要该变量满足 3 个条件，这个 final 变量就不再是一个变量，而是相当于一个直接量。</p>
<blockquote>
<ol>
<li>使用 <code v-pre>final</code> 修饰符修饰；</li>
<li>在定义该 <code v-pre>final</code> 变量时指定了初始值；</li>
<li>该初始值可以在编译时就被确定下来。</li>
</ol>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FinalLocalTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于这个程序来说，变量 <code v-pre>a</code> 其实根本不存在，当程序执行 <code v-pre>System.out.println(a);</code> 代码时，实际转换为执行 <code v-pre>System.out.println(5)</code>。</p>
<p>除了上面那种为 <code v-pre>final</code> 变量赋值时赋直接量的情况外，如果被赋的表达式只是基本的算术表达式或字符串连接运算，没有访问普通变量，调用方法，Java 编译器同样会将这种 <code v-pre>final</code> 变量当成“宏变量”处理。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FinalReplaceTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从表面上看，① 行代码定义的 <code v-pre>book2</code> 与 <code v-pre>book</code> 没有太大的区别，只是定义 <code v-pre>book2</code> 变量时显式将数值 99.0 转换为字符串，但由于该变量的值需要调用 <code v-pre>String</code> 类的方法，因此编译器无法在编译时确定 <code v-pre>book2</code> 的值，<code v-pre>book2</code> 不会被当成“宏变量”处理。</p>
<p>程序最后两行代码分别判断 <code v-pre>book</code>、<code v-pre>book2</code> 和<code v-pre>&quot;疯狂 Java 讲义：99.0&quot;</code>是否相等。由于 <code v-pre>book</code> 是一个“宏变量”，它将被直接替换成 <code v-pre>&quot;疯狂 Java 讲义：99.0&quot;</code>，因此 <code v-pre>book</code> 和 <code v-pre>&quot;疯狂 Java 讲义：99.0&quot;</code> 相等，但 <code v-pre>book2</code> 和该字符串不相等。</p>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>回顾：</p>
<p>Java 会使用常量池来管理曾经用过的字符串直接量，例如执行 <code v-pre>String a=&quot;java&quot;;</code> 语句之后，系统的字符串池中就会缓存一个字符串 <code v-pre>&quot;java&quot;</code>；如果程序再次执行 <code v-pre>String b=&quot;java&quot;;</code>，系统将会让 <code v-pre>b</code> 直接指向字符串池中的 <code v-pre>&quot;java&quot;</code> 字符串，因此 <code v-pre>a==b</code> 将会返回 <code v-pre>true</code>。</p>
</div>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StringJoinTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">String</span> s1 <span class="token operator">=</span> <span class="token string">"疯狂Java"</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>s1</code> 是一个普通的字符串直接量 <code v-pre>&quot;疯狂Java&quot;</code>，<code v-pre>s2</code> 的值是两个字符串直接量进行连接运算，由于编译器可以在编译阶段就确定 <code v-pre>s2</code> 的值为 <code v-pre>&quot;疯狂Java&quot;</code>，所以系统会让 <code v-pre>s2</code> 直接指向字符串池中缓存的 <code v-pre>&quot;疯狂Java&quot;</code> 字符串。由此可见，<code v-pre>s1==s2</code> 将输出 <code v-pre>true</code>。</p>
<p>对于 <code v-pre>s3</code> 而言，它的值由 <code v-pre>str1</code> 和 <code v-pre>str2</code> 进行连接运算后得到。由于 <code v-pre>str1</code>、<code v-pre>str2</code> 是两个普通变量，编译器不会执行“宏替换”，因此编译器无法在编译时确定 <code v-pre>s3</code> 的值，也就无法让 <code v-pre>s3</code> 指向字符串池中缓存的 <code v-pre>&quot;疯狂 Java</code>&quot;。由此可见，<code v-pre>s1==s3</code> 将输出 <code v-pre>false</code>。</p>
<p>让 <code v-pre>s1==s3</code> 输出 <code v-pre>true</code> 也很简单，只要让编译器可以对 <code v-pre>str1</code>、<code v-pre>str2</code> 两个变量执行“宏替换”，这样编译器即可在编译阶段就确定 <code v-pre>s3</code> 的值，就会让 <code v-pre>s3</code> 指向字符串池中缓存的 <code v-pre>&quot;疯狂Java&quot;</code>。只要将 ①、② 两行代码所定义的 <code v-pre>str1</code>、<code v-pre>str2</code> 使用 <code v-pre>final</code> 修饰即可。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>对于实例变量而言，既可以在定义该变量时赋初始值，也可以在非静态初始化块、构造器中对它赋初始值，在这 3 个地方指定初始值的效果基本一样。但对于 <code v-pre>final</code> 实例变量而言，只有在定义该变量时指定初始值才会有“宏变量”的效果。</p>
</div>
<h3 id="final-方法" tabindex="-1"><a class="header-anchor" href="#final-方法" aria-hidden="true">#</a> <code v-pre>final</code> 方法</h3>
<p><code v-pre>final</code> 修饰的方法不可被重写，如果出于某些原因，不希望子类重写父类的某个方法，则可以使用 <code v-pre>final</code> 修饰该方法。</p>
<p>java 提供的 <code v-pre>Object</code> 类里就有一个 <code v-pre>final</code> 方法：<code v-pre>getClass()</code>，因为 <code v-pre>Java</code> 不希望任何类重写这个方法，所以使用 <code v-pre>final</code> 把这个方法密封起来。但对于该类提供的 <code v-pre>toString()</code> 和 <code v-pre>equals()</code> 方法，都允许子类重写，因此没有使用 <code v-pre>final</code> 修饰它们。</p>
<p>试图重写 <code v-pre>final</code> 方法，将会引发编译错误。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FinalMethodTest</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于一个 <code v-pre>private</code> 方法，因为它仅在当前类中可见，其子类无法访问该方法，所以子类无法重写该方法——如果子类中定义一个与父类 <code v-pre>private</code> 方法有相同方法名、相同形参列表、相同返回值类型的方法，也不是方法重写，只是重新定义了一个新方法。</p>
<p>因此，即使使用 <code v-pre>final</code> 修饰一个 <code v-pre>private</code> 访问权限的方法，依然可以在其子类中定义与该方法具有相同方法名、相同形参列表、相同返回值类型的方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PrivateFinalMethodTest</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>final</code> 修饰的方法仅仅是不能被重写，并不是不能被重载。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Final0verload</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="final-类" tabindex="-1"><a class="header-anchor" href="#final-类" aria-hidden="true">#</a> <code v-pre>final</code> 类</h3>
<p><code v-pre>final</code> 修饰的类不可以有子类，例如 <code v-pre>java.lang.Math</code> 类就是一个 <code v-pre>final</code> 类，它不可以有子类。</p>
<p>为了保证某个类不可被继承，则可以使用 <code v-pre>final</code> 修饰这个类。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="不可变类" tabindex="-1"><a class="header-anchor" href="#不可变类" aria-hidden="true">#</a> 不可变类</h3>
<p>不可变（<code v-pre>immutable</code>）类的意思是创建该类的实例后，该实例的 Field 是不可改变的。Java 提供的 8 个包装类和 <code v-pre>java.lang.String</code> 类都是不可变类，当创建它们的实例后，其实例的 Field 不可改变。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Double</code> 类和 <code v-pre>String</code> 类需要提供实例 Field 来保存这两个参数，但程序无法修改这两个实例 Field 值，因此 <code v-pre>Double</code> 类和 <code v-pre>String</code> 类没有提供修改它们的方法。</p>
<p>如果需要创建自定义的不可变类，可遵守如下规则。</p>
<blockquote>
<ol>
<li>使用 <code v-pre>private</code> 和 <code v-pre>final</code> 修饰符来修饰该类的 Field。</li>
<li>提供带参数构造器，用于根据传入参数来初始化类里的 Field。</li>
<li>仅为该类的 Field 提供 <code v-pre>getter</code> 方法，不要为该类的 Field 提供 <code v-pre>setter</code> 方法，因为普通方法无法修改 <code v-pre>final</code> 修饰的 Field。</li>
<li>如果有必要，重写 <code v-pre>Object</code> 类的 <code v-pre>hashCode</code> 和 <code v-pre>equals</code> 方法。<code v-pre>equals</code> 方法以关键 Field 来作为判断两个对象是否相等的标准，除此之外，还应该保证两个用 <code v-pre>equals</code> 方法判断为相等的对象的 <code v-pre>hashCode</code> 也相等。</li>
</ol>
</blockquote>
<p><code v-pre>java.lang.String</code> 这个类就做得很好，它就是根据 <code v-pre>String</code> 对象里的字符序列来作为相等的标准，其 <code v-pre>hashCode</code> 方法也是根据字符序列计算得到的。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ImmutableStringTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">String</span> str1 <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">String</span><span class="token punctuation">(</span><span class="token string">"Hello"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token class-name">String</span> str2 <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">String</span><span class="token punctuation">(</span><span class="token string">"Hello"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token comment">// 输出false</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义一个不可变的 <code v-pre>Address</code> 类，程序把 <code v-pre>Address</code> 类的 <code v-pre>detail</code> 和 <code v-pre>postCode</code> 成员变量都使用 <code v-pre>private</code> 隐藏起来，并使用 <code v-pre>final</code> 修饰这两个成员变量，不允许其他方法修改这两个 Field 值。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Address</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当使用 <code v-pre>final</code> 修饰引用类型变量时，仅表示这个引用类型变量不可被重新赋值，但引用类型变量所指向的对象依然可改变。</p>
<p>当创建不可变类时，如果它包含 Field 的类型是可变的，那么其对象的 Field 值依然是可改变的——这个不可变类其实是失败的。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Name</span> <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>为了保持 <code v-pre>Person</code> 对象的不可变性，必须保护好 <code v-pre>Person</code> 对象的引用类型 Field：<code v-pre>name</code>，让程序无法访问到 <code v-pre>Person</code> 对象的 <code v-pre>name</code> Field，也就无法利用 <code v-pre>name</code> Field 的可变性来改变 <code v-pre>Person</code> 对象了。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当程序向 <code v-pre>Person</code> 构造器里传入一个 <code v-pre>Name</code> 对象时，该构造器创建 <code v-pre>Person</code> 对象时并不是直接利用已有的 <code v-pre>Name</code> 对象，而是重新创建了一个 <code v-pre>Name</code> 对象来赋给 <code v-pre>Person</code> 对象的 <code v-pre>name</code> Field。</p>
<p>当 <code v-pre>Person</code> 对象返回 <code v-pre>name</code> Field 时，它并没有直接把 <code v-pre>name</code> Field 返回，直接返回 <code v-pre>name</code> Field 的值也可能导致它所引用的 <code v-pre>Name</code> 对象被修改。</p>
<p>如果需要设计一个不可变类，尤其要注意其引用类型 Field，如果引用类型 Field 的类是可变的，就必须采取必要的措施来保护该 Field 所引用的对象不会被修改，这样才能创建真正的不可变类。</p>
<h3 id="缓存不可变类的实例" tabindex="-1"><a class="header-anchor" href="#缓存不可变类的实例" aria-hidden="true">#</a> 缓存不可变类的实例</h3>
<p>不可变类的实例状态不可改变，可以很方便地被多个对象所共享。如果程序经常需要使用相同的不可变类实例，则应该考虑缓存这种不可变类的实例。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">CacheImmutale</span> <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CacheImmutaleTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当使用 <code v-pre>CacheImmutale</code> 类的 <code v-pre>valueOf</code> 方法来生成对象时，系统是否重新生成新的对象，取决于数组内是否已经存在该对象。如果该数组中已经缓存了该类的对象，系统将不会重新生成对象。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207122115868.jpeg" alt="img"></p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>是否需要隐藏 <code v-pre>CacheImmutale</code> 类的构造器完全取决于系统需求。盲目乱用缓存也可能导致系统性能下降，缓存的对象会占用系统内存，如果某个对象只使用一次，重复使用的概率不大，缓存该实例就弊大于利；反之，如果某个对象需要频繁地重复使用，缓存该实例就利大于弊。</p>
</div>
<p>例如 Java 提供的 <code v-pre>java.lang.Integer</code> 类，它就采用了与 <code v-pre>CacheImmutale</code> 类相同的处理策略，如果采用 <code v-pre>new</code> 构造器来创建 <code v-pre>Integer</code> 对象，则每次返回全新的 <code v-pre>Integer</code> 对象；如果采用 <code v-pre>valueOf</code> 方法来创建 <code v-pre>Integer</code> 对象，则会缓存该方法创建的对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">IntegerCacheTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>在某些情况下，某个父类只是知道其子类应该包含怎样的方法，但无法准确地知道这些子类如何实现这些方法。例如定义了一个 <code v-pre>Shape</code> 类，这个类应该提供一个计算周长的方法 <code v-pre>calPerimeter()</code>，但不同 <code v-pre>Shape</code> 子类对周长的计算方法是不一样的，即 <code v-pre>Shape</code> 类无法准确地知道其子类计算周长的方法。</p>
<p>如何既能让 <code v-pre>Shape</code> 类里包含 <code v-pre>calPerimeter()</code> 方法，又无须提供其方法实现呢？</p>
<p>使用抽象方法即可满足该要求：抽象方法是只有方法签名，没有方法实现的方法。</p>
<h3 id="抽象方法和抽象类" tabindex="-1"><a class="header-anchor" href="#抽象方法和抽象类" aria-hidden="true">#</a> 抽象方法和抽象类</h3>
<p>抽象方法和抽象类必须使用 <code v-pre>abstract</code> 修饰符来定义，有抽象方法的类只能被定义成抽象类，抽象类里可以没有抽象方法。</p>
<p>抽象方法和抽象类的规则如下。</p>
<blockquote>
<ol>
<li>抽象类必须使用 <code v-pre>abstract</code> 修饰符来修饰，抽象方法也必须使用 <code v-pre>abstract</code> 修饰符来修饰，抽象方法不能有方法体。</li>
<li>抽象类不能被实例化，无法使用 <code v-pre>new</code> 关键字来调用抽象类的构造器创建抽象类的实例。即使抽象类里不包含抽象方法，这个抽象类也不能创建实例。</li>
<li>抽象类可以包含 Field、方法（普通方法和抽象方法都可以）、构造器、初始化块、内部类、枚举类 6 种成分。抽象类的构造器不能用于创建实例，主要是用于被其子类调用。</li>
<li>含有抽象方法的类（包括直接定义了一个抽象方法；继承了一个抽象父类，但没有完全实现父类包含的抽象方法，以及实现了一个接口，但没有完全实现接口包含的抽象方法 3 种情况）只能被定义成抽象类。</li>
</ol>
</blockquote>
<p>定义抽象方法只需在普通方法上增加 <code v-pre>abstract</code> 修饰符，并把普通方法的方法体（也就是方法后花括号括起来的部分）全部去掉，并在方法后增加分号即可。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>抽象方法和空方法体的方法不是同一个概念。例如，<code v-pre>public abstract void test();</code> 是一个抽象方法，它根本没有方法体，即方法定义后面没有一对花括号；但 <code v-pre>public void test(){}</code> 方法是一个普通方法，它已经定义了方法体，只是方法体为空，即它的方法体什么也不做，因此这个方法不可使用 <code v-pre>abstract</code> 来修饰。</p>
</div>
<p>一个普通类（没有包含抽象方法的类）增加 <code v-pre>abstract</code> 修饰符后也将变成抽象类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Shape</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token class-name">String</span> color<span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的 <code v-pre>Shape</code> 类里包含了两个抽象方法：<code v-pre>calPerimeter()</code> 和 <code v-pre>getType()</code>，所以这个 <code v-pre>Shape</code> 类只能被定义成抽象类。<code v-pre>Shape</code> 类里既包含了初始化块，也包含了构造器，<mark>这些都不是在创建 <code v-pre>Shape</code> 对象时被调用的，而是在创建其子类的实例时被调用</mark>。</p>
<blockquote>
<ol>
<li>抽象类必须使用 <code v-pre>abstract</code> 修饰符来修饰，抽象方法也必须使用 <code v-pre>abstract</code> 修饰符来修饰，抽象方法不能有方法体。</li>
<li>抽象类不能被实例化，无法使用 <code v-pre>new</code> 关键字来调用抽象类的构造器创建抽象类的实例。即使抽象类里不包含抽象方法，这个抽象类也不能创建实例。</li>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Triangle</span> <span class="token keyword">extends</span> <span class="token class-name">Shape</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再定义一个 <code v-pre>Circle</code> 普通类，<code v-pre>Circle</code> 类也是 <code v-pre>Shape</code> 类的一个子类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Circle</span> <span class="token keyword">extends</span> <span class="token class-name">Shape</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>主方法中定义了两个 <code v-pre>Shape</code> 类型的引用变量，它们分别指向 <code v-pre>Triangle</code> 对象和 <code v-pre>Circle</code> 对象。由于在 <code v-pre>Shape</code> 类中定义了 <code v-pre>calPerimeter()</code> 方法和 <code v-pre>getType()</code> 方法，所以程序可以直接调用 <code v-pre>s1</code> 变量和 <code v-pre>s2</code> 变量的<code v-pre>calPerimeter()</code>方法和<code v-pre>getType()</code>方法，无须强制类型转换为其子类类型。</p>
<p>当使用 <code v-pre>abstract</code> 修饰类时，表明这个类只能被继承；当使用 <code v-pre>abstract</code> 修饰方法时，表明这个方法必须由子类提供实现（即重写）。而 <code v-pre>final</code> 修饰的类不能被继承，<code v-pre>final</code> 修饰的方法不能被重写。因此 <code v-pre>final</code> 和 <code v-pre>abstract</code> 永远不能同时使用。</p>
<p>除此之外，当使用 <code v-pre>static</code> 修饰一个方法时，表明这个方法属于该类本身，即通过类就可调用该方法，但如果该方法被定义成抽象方法，则将导致通过该类来调用该方法时出现错误（调用了一个没有方法体的方法肯定会引起错误）。因此 <code v-pre>static</code> 和 <code v-pre>abstract</code> 不能同时修饰某个方法，即没有所谓的类抽象方法。</p>
<p><code v-pre>abstract</code> 关键字修饰的方法必须被其子类重写才有意义，否则这个方法将永远不会有方法体，因此 <code v-pre>abstract</code> 方法不能定义为 <code v-pre>private</code> 访问权限，即 <code v-pre>private</code> 和 <code v-pre>abstract</code> 不能同时使用。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p><code v-pre>abstract</code> 不能用于修饰 Field，不能用于修饰局部变量，即没有抽象变量、没有抽象 Field 等说法；<code v-pre>abstract</code> 也不能用于修饰构造器，没有抽象构造器，抽象类里定义的构造器只能是普通构造器。</p>
</div>
<h3 id="抽象类的作用" tabindex="-1"><a class="header-anchor" href="#抽象类的作用" aria-hidden="true">#</a> 抽象类的作用</h3>
<p>抽象类是从多个具体类中抽象出来的父类，它具有更高层次的抽象。从多个具有相同特征的类中抽象出一个抽象类，以这个抽象类作为其子类的模板，从而避免了子类设计的随意性。</p>
<p>抽象类体现的就是一种模板模式的设计，抽象类作为多个子类的通用模板，子类在抽象类的基础上进行扩展、改造，但子类总体上会大致保留抽象类的行为方式。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">SpeedMeter</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>程序定义了一个抽象的 <code v-pre>SpeedMeter</code> 类（车速表），该表里定义了一个 <code v-pre>getSpeed</code> 方法，该方法用于返回当前车速，<code v-pre>getSpeed</code> 方法依赖于<code v-pre>getRadius</code> 方法的返回值。</p>
<p>对于一个抽象的 <code v-pre>SpeedMeter</code> 类而言，它无法确定车轮的半径，因此 <code v-pre>getRadius</code> 方法必须推迟到其子类中实现。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CarSpeedMeter</span> <span class="token keyword">extends</span> <span class="token class-name">SpeedMeter</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>模板模式在面向对象的软件中很常用，其原理简单，实现也很简单。</p>
<p>下面是使用模板模式的一些简单规则。</p>
<ol>
<li>抽象父类可以只定义需要使用的某些方法，把不能实现的部分抽象成抽象方法，留给其子类去实现。</li>
<li>父类中可能包含需要调用的其他系列方法的方法，这些被调方法既可以由父类实现，也可以由其子类实现。父类里提供的方法只是定义了一个通用算法，其实现也许并不完全由自身实现，而必须依赖于其子类的辅助。</li>
</ol>
<h2 id="接口" tabindex="-1"><a class="header-anchor" href="#接口" aria-hidden="true">#</a> 接口</h2>
<p>接口里不能包含普通方法，接口里的所有方法都是抽象方法。</p>
<h3 id="接口的概念" tabindex="-1"><a class="header-anchor" href="#接口的概念" aria-hidden="true">#</a> 接口的概念</h3>
<p>接口是从多个相似类中抽象出来的规范，接口不提供任何实现。接口体现的是规范和实现分离的设计哲学。</p>
<p>经常听说接口，比如 PCI 接口、AGP 接口等，不是指主机板上的插槽。当我们说 PCI 接口时，指的是主机板上那个插槽遵守了 PCI 规范，而具体的 PCI 插槽只是 PCI 接口的实例。</p>
<p>对于不同型号的主机板而言，它们各自的 PCI 插槽都需要遵守一个规范，遵守这个规范就可以保证插入该插槽里的板卡能与主机板正常通信。对于同一个型号的主机板而言，它们的 PCI 插槽需要有相同的数据交换方式、相同的实现细节，它们都是同一个类的不同实例。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207131503020.jpeg" alt="img"></p>
<p>接口定义的是多个类共同的公共行为规范，这些行为是与外部交流的通道，这就意味着接口里通常是定义一组公用方法。</p>
<h3 id="接口的定义" tabindex="-1"><a class="header-anchor" href="#接口的定义" aria-hidden="true">#</a> 接口的定义</h3>
<p>定义接口不再使用 <code v-pre>class</code> 关键字，而是使用 <code v-pre>interface</code> 关键字。</p>
...
<ol>
<li>修饰符可以是 <code v-pre>public</code> 或者省略，如果省略了 <code v-pre>public</code> 访问控制符，则默认采用包权限访问控制符，即只有在相同包结构下才可以访问该接口。</li>
<li>接口名应与类名采用相同的命名规则，即如果仅从语法角度来看，接口名只要是合法的标识符即可；如果要遵守 Java 可读性规范，则接口名应由多个有意义的单词连缀而成，每个单词首字母大写，单词与单词之间无须任何分隔符。</li>
<li>一个接口可以有多个直接父接口，但接口只能继承接口，不能继承类。</li>
</ol>
</blockquote>
<p>由于接口定义的是一种规范，因此接口里不能包含构造器和初始化块定义。接口里可以包含 Field （只能是常量）、方法（只能是抽象实例方法）、内部类（包括内部接口、枚举）定义。而且接口里的 Field 只能是常量，接口里的方法只能是抽象方法。</p>
<p>口里定义的是多个类共同的公共行为规范，因此接口里的所有成员，包括常量、方法、内部类和枚举类都是 <code v-pre>public</code> 访问权限。</p>
<p>定义接口成员时，可以省略访问控制修饰符，如果指定访问控制修饰符，则只能使用 <code v-pre>public</code> 访问控制修饰符。</p>
<p>在接口中定义 Field 时，不管是否使用 <code v-pre>public static final</code> 修饰符，接口里的 Field 总将使用这三个修饰符来修饰。而且，接口里没有构造器和初始化块，因此接口里定义的 Field 只能在定义时指定默认值。</p>
<p>接口里定义 Field 采用如下两行代码的结果完全一样。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//系统自动为接口里定义的Field增加public static final修饰符</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于接口里定义的方法而言，它们只能抽象方法，因此系统会自动为其增加 <code v-pre>abstract</code> 修饰符；</p>
<p>由于接口里的方法全部是抽象方法，因此接口里不允许定义静态方法，即不可使用 <code v-pre>static</code> 修饰接口里定义的方法。</p>
<p>不管定义接口里方法时是否使用 <code v-pre>public abstract</code> 修饰符，接口里的方法总是使用 <code v-pre>public abstract</code> 来修饰。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>接口里定义的内部类、接口、枚举类默认都采用 <code v-pre>public static</code> 两个修饰符，不管定义时是否指定这两个修饰符，系统都会自动使用 <code v-pre>public static</code> 对它们进行修饰。</p>
</div>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">lee</span><span class="token punctuation">;</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这个接口里包含了一个常量 Field：<code v-pre>MAX_CACHE_LINE</code>，还定义了两个方法：表示取得数据的 <code v-pre>getData()</code> 方法和表示输出的 <code v-pre>out()</code> 方法。</p>
<p>这就定义了 <code v-pre>Output</code> 接口的规范：只要某个类能取得数据，并可以将数据输出，那它就是一个输出设备，至于这个设备的实现细节，这里暂时不关心。</p>
<p>接口里的 Field 默认是使用 <code v-pre>public static final</code> 修饰的，因此即使另一个类处于不同包下，也可以通过接口来访问接口里的常量 Field。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">yeeku</span><span class="token punctuation">;</span>
...
<p class="custom-container-title">提示</p>
<p>从某个角度来看，接口可被当成一个特殊的类，因此一个 Java 源文件里最多只能有一个 <code v-pre>public</code> 接口，如果一个 Java 源文件里定义了一个 <code v-pre>public</code> 接口，则该源文件的主文件名必须与该接口名相同。</p>
</div>
<h3 id="接口的继承" tabindex="-1"><a class="header-anchor" href="#接口的继承" aria-hidden="true">#</a> 接口的继承</h3>
<p>接口的继承和类继承不一样，接口完全支持多继承，即一个接口可以有多个直接父接口。和类继承相似，子接口扩展某个父接口，将会获得父接口里定义的所有抽象方法、常量 Field、内部类和枚举类定义。</p>
<p>一个接口继承多个父接口时，多个父接口排在 <code v-pre>extends</code> 关键字之后，多个父接口之间以英文逗号 <code v-pre>,</code> 隔开。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">interface</span> interfaceA <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">InterfaceExtendsTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>interfaceC</code> 接口继承了 <code v-pre>interfaceA</code> 和 <code v-pre>interfaceB</code>，所以 <code v-pre>interfaceC</code> 中获得了它们的常量 Field，因此在 <code v-pre>main</code> 方法中看到通过 <code v-pre>interfaceC</code> 来访问 <code v-pre>PROP_A</code>、<code v-pre>PROP_B</code> 和 <code v-pre>PROP_C</code> 常量。</p>
<h3 id="使用接口" tabindex="-1"><a class="header-anchor" href="#使用接口" aria-hidden="true">#</a> 使用接口</h3>
<p>接口不能用于创建实例，但接口可以用于声明引用类型变量。当使用接口来声明引用类型变量时，这个引用类型变量必须引用到其实现类的对象。除此之外，接口的主要用途就是被实现类实现。</p>
<p>一个类可以实现一个或多个接口，继承使用 <code v-pre>extends</code> 关键字，实现则使用 <code v-pre>implements</code> 关键字。因为一个类可以实现多个接口，这也是 Java 为单继承灵活性不足所做的补充。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token punctuation">[</span>修饰符<span class="token punctuation">]</span> <span class="token keyword">class</span> 类名 <span class="token keyword">extends</span> 父类 <span class="token keyword">implements</span> 接口<span class="token number">1</span><span class="token punctuation">,</span>接口<span class="token number">2.</span><span class="token punctuation">.</span><span class="token punctuation">.</span> <span class="token punctuation">{</span>
 类体部分
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>实现接口与继承父类相似，一样可以获得所实现接口里定义的常量 Field、抽象方法、内部类和枚举类定义。</p>
<p>一个类可以继承一个父类，并同时实现多个接口，<code v-pre>implements</code> 部分必须放在 <code v-pre>extends</code> 部分之后。</p>
<p>一个类实现了一个或多个接口之后，这个类必须完全实现这些接口里所定义的全部抽象方法（也就是重写这些抽象方法）；否则该类将保留从父接口那里继承到的抽象方法，该类也必须定义成抽象类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 定义一个Product接口</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Printer</span> <span class="token keyword">implements</span> <span class="token class-name">Output</span><span class="token punctuation">,</span> <span class="token class-name">Product</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Printer</code> 类实现了 <code v-pre>Output</code> 接口和 <code v-pre>Product</code> 接口，因此 <code v-pre>Printer</code> 对象既可直接赋给 <code v-pre>Output</code> 变量，也可直接赋给 <code v-pre>Product</code> 变量。仿佛 <code v-pre>Printer</code> 类既是 <code v-pre>Output</code> 类的子类，也是 <code v-pre>Product</code> 类的子类，这就是 Java 提供的模拟多继承。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>实现接口方法时，必须使用 <code v-pre>public</code> 访问控制修饰符，因为接口里的方法都是 <code v-pre>public</code> 的，而子类（相当于实现类）重写父类方法时访问权限只能更大或者相等，所以实现类实现接口里的方法时只能使用 <code v-pre>public</code> 访问权限。</p>
</div>
<p>接口不能显式继承任何类，但所有接口类型的引用变量都可以直接赋给 <code v-pre>Object</code> 类型的引用变量。所以在上面程序中可以把 <code v-pre>Product</code> 类型变量直接赋给 <code v-pre>Object</code> 类型变量，这是利用向上转型来实现的，因为编译器知道任何 Java 对象都必须是 <code v-pre>Object</code> 或其子类的实例，<code v-pre>Product</code> 类型的对象也不例外（它必须是 <code v-pre>Product</code> 接口实现类的对象，该实现类肯定是 <code v-pre>Product</code> 的显式或隐式子类）。</p>
<h3 id="接口和抽象类" tabindex="-1"><a class="header-anchor" href="#接口和抽象类" aria-hidden="true">#</a> 接口和抽象类</h3>
...
<blockquote>
<p>接口作为系统与外界交互的窗口，接口体现的是一种规范。</p>
<p>对于接口的实现者而言，接口规定了实现者必须向外提供哪些服务（以方法的形式来提供）；对于接口的调用者而言，接口规定了调用者可以调用哪些服务，以及如何调用这些服务（就是如何来调用方法）。</p>
<p>当在一个程序中使用接口时，接口是多个模块间的耦合标准；当在多个应用程序之间使用接口时，接口是多个程序之间的通信标准。</p>
<p>接口类似于整个系统的“总纲”，它制定了系统各模块应该遵循的标准，因此一个系统中的接口不应该经常改变。</p>
<p>一旦接口被改变，对整个系统甚至其他系统的影响将是辐射式的，导致系统中大部分类都需要改写。</p>
<p>抽象类则不一样，抽象类作为系统中多个子类的共同父类，它所体现的是一种模板式设计。</p>
<p>抽象类作为多个子类的抽象父类，可以被当成系统实现过程中的中间产品，这个中间产品已经实现了系统的部分功能（那些已经提供实现的方法），但这个产品依然不能当成最终产品，必须有更进一步的完善，这种完善可能有几种不同方式。</p>
</blockquote>
<p>接口和抽象类在用法上也存在如下差别。</p>
<blockquote>
<ol>
<li>接口里不能定义静态方法；抽象类里可以定义静态方法。</li>
<li>接口里只能定义静态常量 Field，不能定义普通 Field；抽象类里则既可以定义普通 Field，也可以定义静态常量 Field。</li>
...
<h3 id="面向接口编程" tabindex="-1"><a class="header-anchor" href="#面向接口编程" aria-hidden="true">#</a> 面向接口编程</h3>
<h4 id="简单工厂模式" tabindex="-1"><a class="header-anchor" href="#简单工厂模式" aria-hidden="true">#</a> 简单工厂模式</h4>
<p>假设程序中有个 <code v-pre>Computer</code> 类需要组合一个输出设备，现在有两个选择：直接让 <code v-pre>Computer</code> 类组合一个 <code v-pre>Printer</code>，或者让 <code v-pre>Computer</code> 类组合一个 <code v-pre>Output</code>，那么到底采用哪种方式更好呢？</p>
<p>假设让 <code v-pre>Computer</code> 类组合一个 <code v-pre>Printer</code> 对象，如果有一天系统需要重构，需要使用 <code v-pre>BetterPrinter</code> 来代替 <code v-pre>Printer</code>，于是我们需要打开 <code v-pre>Computer</code> 类源代码进行修改。如果系统中只有一个 <code v-pre>Computer</code> 类组合了 <code v-pre>Printer</code> 还好，但如果系统中有 100 个类组合了 <code v-pre>Printer</code>，甚至 1000 个、10000 个……将意味着我们要打开 100 个、1000 个、10000 个类进行修改。</p>
<p>为了避免这个问题，我们让 <code v-pre>Computer</code> 类组合一个 <code v-pre>Output</code> 类型的对象，将 <code v-pre>Computer</code> 类与 <code v-pre>Printer</code> 类完全分离。<code v-pre>Computer</code> 对象实际组合的是 <code v-pre>Printer</code> 对象还是 <code v-pre>BetterPrinter</code> 对象，对 <code v-pre>Computer</code> 而言完全透明。当 <code v-pre>Printer</code> 对象切换到 <code v-pre>BetterPrinter</code> 对象时，系统完全不受影响。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Computer</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Computer</code> 类已经完全与 <code v-pre>Printer</code> 类分离，只是与 <code v-pre>Output</code> 接口耦合。</p>
<p><code v-pre>Computer</code> 不再负责创建 <code v-pre>Output</code> 对象，系统提供一个 <code v-pre>Output</code> 工厂来负责生成 <code v-pre>Output</code> 对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">OutputFactory</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>OutputFactory</code> 类中包含了一个 <code v-pre>getOutput</code> 方法，该方法返回一个 <code v-pre>Output</code> 实现类的实例，该方法负责创建 <code v-pre>Output</code> 实例，具体创建哪一个实现类的对象由该方法决定。</p>
<p>如果系统需要将 <code v-pre>Printer</code> 改为 <code v-pre>BetterPrinter</code> 实现类，只需让 <code v-pre>BetterPrinter</code> 实现 <code v-pre>Output</code> 接口，并改变 <code v-pre>OutputFactory</code> 类中的 <code v-pre>getOutput</code> 方法即可。</p>
<p><code v-pre>BetterPrinter</code> 只是对原有的 <code v-pre>Printer</code> 进行简单修改，以模拟系统重构后的改进。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">BetterPrinter</span> <span class="token keyword">implements</span> <span class="token class-name">Output</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>把 <code v-pre>OutputFactory</code> 工厂类的 <code v-pre>getOutput</code> 方法改为如下代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token class-name">Output</span> <span class="token function">getOutput</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>再次运行前面的 <code v-pre>OutputFactory.java</code> 程序，发现系统运行时已经改为 <code v-pre>BetterPrinter</code> 对象，而不再是原来的 <code v-pre>Printer</code> 对象。</p>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>设计模式</p>
<p>所谓设计模式，就是对经常出现的软件设计问题的成熟解决方案。</p>
<p>很多人把设计模式想象成非常高深的概念，实际上设计模式仅仅是对特定问题的一种惯性思维。</p>
<p>设计模式的理解必须以足够的代码积累量作为基础。</p>
<p>最好是经历过某种苦痛，或者正在经历一种苦痛，就会对设计模式有较深的感受。</p>
</div>
<h4 id="命令模式" tabindex="-1"><a class="header-anchor" href="#命令模式" aria-hidden="true">#</a> 命令模式</h4>
<p>假设有个方法需要遍历某个数组的数组元素，但无法确定在遍历数组元素时如何处理这些元素，需要在调用该方法时指定具体的处理行为。</p>
<p>这个方法不仅需要普通数据可以变化，甚至还有方法执行体也需要变化，难道我们能把“处理行为”作为一个参数传入该方法？</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>在某些编程语言（如 Ruby 等）里，确实允许传入一个代码块作为参数。但 Java 暂时还不支持代码块作为参数。</p>
</div>
<p>对于这样一个需求，我们必须把“处理行为”作为参数传入该方法，这个“处理行为”用编程来实现就是一段代码。那如何把这段代码传入该方法呢？</p>
<p>我们使用一个 <code v-pre>Command</code> 接口来定义一个方法，用这个方法来封装“处理行为”。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">Command</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面是需要处理数组的处理类，在这个处理类中包含一个 <code v-pre>process</code> 方法，这个方法无法确定处理数组的处理行为，所以定义该方法时使用了一个 <code v-pre>Command</code> 参数，这个 <code v-pre>Command</code> 参数负责对数组的处理行为。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ProcessArray</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>PrintCommand</code> 类和 <code v-pre>AddCommand</code> 类：</p>
...
<span class="token punctuation">}</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过一个 <code v-pre>Command</code> 接口，就实现了让 <code v-pre>ProcessArray</code> 类和具体“处理行为”的分离，程序使用 <code v-pre>Command</code> 接口代表了对数组的处理行为。<code v-pre>Command</code> 接口也没有提供真正的处理，只有等到需要调用 <code v-pre>ProcessArray</code> 对象的 <code v-pre>process</code> 方法时，才真正传入一个 <code v-pre>Command</code> 对象，才确定对数组的处理行为。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CommandTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="内部类" tabindex="-1"><a class="header-anchor" href="#内部类" aria-hidden="true">#</a> 内部类</h2>
<p>在某些情况下，我们把一个类放在另一个类的内部定义，这个定义在其他类内部的类就被称为内部类（有的地方也叫嵌套类），包含内部类的类也被称为外部类（有的地方也叫宿主类）。</p>
<p>内部类主要有如下作用。</p>
<blockquote>
<ol>
<li>内部类提供了更好的封装，可以把内部类隐藏在外部类之内，不允许同一个包中的其他类访问该类。假设需要创建 <code v-pre>Cow</code> 类，<code v-pre>Cow</code> 类需要组合一个 <code v-pre>CowLeg</code> 对象，<code v-pre>CowLeg</code>类只有在 <code v-pre>Cow</code> 类里才有效，离开了 <code v-pre>Cow</code> 类之后没有任何意义。在这种情况下，就可把 <code v-pre>CowLeg</code> 定义成 <code v-pre>Cow</code> 的内部类，不允许其他类访问 <code v-pre>CowLeg</code>。</li>
<li>内部类成员可以直接访问外部类的私有数据，因为内部类被当成其外部类成员，同一个类的成员之间可以互相访问。但外部类不能访问内部类的实现细节，例如内部类的成员变量。</li>
<li>匿名内部类适合用于创建那些仅需要一次使用的类。对于前面的命令模式，当需要传入一个 <code v-pre>Command</code> 对象时，重新专门定义 <code v-pre>PrintCommand</code> 和 <code v-pre>AddCommand</code> 两个实现类可能没有太大的意义，因为这两个实现类可能仅需要使用一次。在这种情况下，使用匿名内部类将更方便。</li>
</ol>
</blockquote>
<h3 id="非静态内部类" tabindex="-1"><a class="header-anchor" href="#非静态内部类" aria-hidden="true">#</a> 非静态内部类</h3>
<p>定义内部类非常简单，只要把一个类放在另一个类内部定义即可。此处的“类内部”包括类中的任何位置，甚至在方法中也可以定义内部类（方法里定义的内部类被称为局部内部类）。</p>
<p>内部类定义语法格式如下：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>大部分时候，内部类都被作为成员内部类定义，而不是作为局部内部类。成员内部类是一种与 Field、方法、构造器和初始化块相似的类成员；局部内部类和匿名内部类则不是类成员。</p>
<p>成员内部类分为两种：静态内部类和非静态内部类，使用 <code v-pre>static</code> 修饰的成员内部类是静态内部类，没有使用 <code v-pre>static</code> 修饰的成员内部类是非静态内部类。</p>
<p>因为内部类作为其外部类的成员，所以可以使用任意访问控制符如 <code v-pre>private</code>、<code v-pre>protected</code> 和 <code v-pre>public</code> 等修饰。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>外部类的上一级程序单元是包，所以它只有 2 个作用域：同一个包内和任何位置。</p>
<p>因此只需 2 种访问权限：包访问权限和公开访问权限，正好对应省略访问控制符和 <code v-pre>public</code> 访问控制符。</p>
<p>省略访问控制符是包访问权限，即同一包中的其他类可以访问省略访问控制符的成员。</p>
<p>因此，如果一个外部类不使用任何访问控制符修饰，则只能被同一个包中其他类访问。</p>
<p>而内部类的上一级程序单元是外部类，它就具有 4 个作用域：同一个类、同一个包、父子类和任何位置，因此可以使用 4 种访问控制权限。</p>
</div>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Cow</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token keyword">double</span> weight<span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面程序中把一个类定义放在了另一个类的内部，所以它就成了一个内部类，可以使用 <code v-pre>private</code> 修饰符来修饰这个类。</p>
<p>外部类 <code v-pre>Cow</code> 里包含了一个 <code v-pre>test</code> 方法，该方法里创建了一个 <code v-pre>CowLeg</code> 对象，并调用该对象的 <code v-pre>info</code> 方法。在外部类里使用非静态内部类时，与平时使用普通类并没有太大的区别。</p>
<p>编译上面程序，看到在文件所在路径生成了两个 <code v-pre>class</code> 文件，一个是 <code v-pre>Cow.class</code>，另一个是 <code v-pre>Cow$CowLeg.class</code>，前者是外部类 <code v-pre>Cow</code> 的 <code v-pre>class</code> 文件，后者是内部类 <code v-pre>CowLeg</code> 的 <code v-pre>class</code> 文件，即成员内部类（包括静态内部类、非静态内部类）的 <code v-pre>class</code> 文件总是这种形式： <code v-pre>OuterClass$InnerClass.class</code>。</p>
<p>在非静态内部类对象里，保存了一个它寄存的外部类对象的引用（当调用非静态内部类的实例方法时，必须有一个非静态内部类实例，而非静态内部类实例必须寄存在外部类实例里）。</p>
<blockquote>
<p>当在非静态内部类的方法内访问某个变量时，系统优先在该方法内查找是否存在该名字的局部变量，如果存在就使用该变量；</p>
<p>如果不存在，则到该方法所在的内部类中查找是否存在该名字的成员变量，如果存在则使用该成员变量；</p>
<p>如果不存在，则到该内部类所在的外部类中查找是否存在该名字的成员变量，如果存在则使用该成员变量；</p>
<p>如果依然不存在，系统将出现编译错误：提示找不到该变量。</p>
<p>如果外部类成员变量、内部类成员变量与内部类里方法的局部变量同名，则可通过使用 <code v-pre>this</code>、<code v-pre>外部类类名.this</code> 作为限定来区分。</p>
</blockquote>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207151154529.jpeg" alt="img"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">DiscernVariable</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过 <code v-pre>OutterClass.this.propName</code> 的形式访问外部类的实例 Field，通过 <code v-pre>this.propName</code> 的形式访问非静态内部类的实例 Field。</p>
<p>非静态内部类的成员可以访问外部类的 <code v-pre>private</code> 成员，但反过来就不成立了。</p>
<p>如果外部类需要访问非静态内部类的成员，则必须显式创建非静态内部类对象来调用访问其实例成员。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Outer</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>main</code> 方法的 ① 号代码创建了一个外部类对象，并调用外部类对象的 <code v-pre>accessInnerProp</code> 方法。此时非静态内部类对象根本不存在，如果允许 <code v-pre>accessInnerProp</code> 方法访问非静态内部类对象，将肯定引起错误。</p>
<p>根据静态成员不能访问非静态成员的规则，外部类的静态方法、静态代码块不能访问非静态内部类，包括不能使用非静态内部类定义变量、创建实例等。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StaticTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>Java 不允许在非静态内部类里定义静态成员。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">InnerNoStatic</span> <span class="token punctuation">{</span>
...
<p>如果使用 <code v-pre>static</code> 来修饰一个内部类，则这个内部类就属于外部类本身，而不属于外部类的某个对象。因此使用 <code v-pre>static</code> 修饰的内部类被称为类内部类，有的地方也称为静态内部类。</p>
<p>静态内部类可以包含静态成员，也可以包含非静态成员。根据静态成员不能访问非静态成员的规则，静态内部类不能访问外部类的实例成员，只能访问外部类的类成员。即使是静态内部类的实例方法也不能访问外部类的实例成员，只能访问外部类的静态成员。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StaticInnerClassTest</span> <span class="token punctuation">{</span>
...
<p class="custom-container-title">提示</p>
<p>为什么静态内部类的实例方法也不能访问外部类的实例属性呢？</p>
<p>因为静态内部类是外部类的<mark>类相关</mark>，而不是外部类的对象相关的。</p>
<p>也就是说，静态内部类对象不是寄存在外部类对象里的，而是寄存在外部类的类本身中。</p>
<p>当静态内部类对象存在时，并不存在一个被它寄存的外部类对象，静态内部类对象里只有外部类的<mark>类引用</mark>，没有持有外部类对象的引用。</p>
<p>如果允许静态内部类的实例方法访问外部类的实例成员，但找不到被寄存的外部类对象，这将引起错误。</p>
</div>
<p>静态内部类是外部类的一个静态成员，因此外部类的静态方法、静态初始化块中可以使用静态内部类来定义变量、创建对象等。</p>
<p>外部类依然不能直接访问静态内部类的成员，但可以使用静态内部类的类名作为调用者来访问静态内部类的类成员，也可以使用静态内部类对象作为调用者来访问静态内部类的实例成员。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AccessStaticInnerClass</span> <span class="token punctuation">{</span>
    <span class="token keyword">static</span> <span class="token keyword">class</span> <span class="token class-name">StaticInnerClass</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>除此之外，Java 还允许在接口里定义内部类，接口里定义的内部类默认使用 <code v-pre>public static</code> 修饰，也就是说，接口内部类只能是静态内部类。</p>
<p>如果为接口内部类指定访问控制符，则只能指定 <code v-pre>public</code> 访问控制符；如果定义接口内部类时省略访问控制符，则该内部类默认是 <code v-pre>public</code> 访问控制权限。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>接口里是否能定义内部接口？</p>
<p>可以。接口里的内部接口是接口的成员，因此系统默认添加 <code v-pre>public static</code> 两个修饰符。</p>
<p>如果定义接口里的内部接口时指定访问控制符，则只能使用 <code v-pre>public</code> 修饰符。</p>
<p>当然，定义接口里的内部接口的意义不大，因为接口的作用是定义一个公共规范（暴露出来供大家使用），如果把这个接口定义成一个内部接口，那么意义何在呢？</p>
</div>
<h3 id="使用内部类" tabindex="-1"><a class="header-anchor" href="#使用内部类" aria-hidden="true">#</a> 使用内部类</h3>
<p>使用内部类定义变量和创建实例与外部类存在的一些小小的差异。</p>
<ul>
<li><strong>在外部类内部使用内部类</strong></li>
</ul>
<blockquote>
<p>在外部类内部使用内部类时，与平常使用普通类没有太大的区别。一样可以直接通过内部类类名来定义变量，通过 <code v-pre>new</code> 调用内部类构造器来创建实例。</p>
<p>唯一存在的一个区别是：不要在外部类的静态成员（包括静态方法和静态初始化块）中使用非静态内部类，因为静态成员不能访问非静态成员。</p>
<p>在外部类内部定义内部类的子类与平常定义子类也没有太大的区别。</p>
</blockquote>
<ul>
<li><strong>在外部类以外使用非静态内部类</strong></li>
</ul>
<blockquote>
<p>如果希望在外部类以外的地方访问内部类（包括静态和非静态两种），则内部类不能使用 <code v-pre>private</code> 访问控制权限，<code v-pre>private</code> 修饰的内部类只能在外部类内部使用。</p>
<p>对于使用其他访问控制符修饰的内部类，则能在访问控制符对应的访问权限内使用。</p>
<ol>
<li>省略访问控制符的内部类，只能被与外部类处于同一个包中的其他类所访问。</li>
<li>使用 <code v-pre>protected</code> 修饰的内部类，可被与外部类处于同一个包中的其他类和外部类的子类所访问。</li>
<li>使用 <code v-pre>public</code> 修饰的内部类，可以在任何地方被访问。</li>
</ol>
</blockquote>
<p>在外部类以外的地方定义内部类（包括静态和非静态两种）变量的语法格式如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">OuterClass<span class="token punctuation">.</span>InnerClass</span> varName
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在外部类以外的地方使用内部类时，内部类完整的类名应该是 <code v-pre>OuterClass.InnerClass</code>。如果外部类有包名，则还应该增加包名前缀。</p>
<p>因为非静态内部类的对象必须寄存在外部类的对象里，因此创建非静态内部类对象之前，必须先创建其外部类对象。在外部类以外的地方创建非静态内部类实例的语法如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在外部类以外的地方创建非静态内部类实例必须使用外部类实例和 <code v-pre>new</code> 来调用非静态内部类的构造器。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">Out</span> <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CreateInnerInstance</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当创建一个子类时，子类构造器总会调用父类的构造器，因此在创建非静态内部类的子类时，必须保证让子类构造器可以调用非静态内部类的构造器，调用非静态内部类的构造器时，必须存在一个外部类对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">SubClass</span> <span class="token keyword">extends</span> <span class="token class-name">Out</span><span class="token punctuation">.</span>ln <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从上面代码中可以看出，如果需要创建 <code v-pre>SubClass</code> 对象时，必须先创建一个 <code v-pre>Out</code> 对象。</p>
<p>因为 <code v-pre>SubClass</code> 是非静态内部类 <code v-pre>In</code> 类的子类，非静态内部类 <code v-pre>In</code> 对象里必须有一个对 <code v-pre>Out</code> 对象的引用，其子类 <code v-pre>SubClass</code> 对象里也应该存在一个 <code v-pre>Out</code> 对象的引用。</p>
<p>当创建 <code v-pre>SubClass</code> 对象时传给该构造器的 <code v-pre>Out</code> 对象，就是 <code v-pre>SubClass</code> 对象里 <code v-pre>Out</code> 对象引用所指向的对象。</p>
<p>非静态内部类 <code v-pre>In</code> 对象和 <code v-pre>SubClass</code> 对象都必须保留有指向 <code v-pre>Outer</code> 对象的引用，区别是创建两种对象时传入 <code v-pre>Out</code> 对象的方式不同：当创建非静态内部类 <code v-pre>In</code> 类的对象时，必须通过 <code v-pre>Outer</code> 对象来调用 <code v-pre>new</code> 关键字；当创建 <code v-pre>SubClass</code> 类的对象时，必须使用 <code v-pre>Outer</code> 对象作为调用者来调用 <code v-pre>In</code> 类的构造器。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>非静态内部类的子类不一定是内部类，它可以是一个外部类。但非静态内部类的子类实例一样需要保留一个引用，该引用指向其父类所在外部类的对象。</p>
<p>如果有一个内部类子类的对象存在，则一定存在与之对应的外部类对象。</p>
</div>
<ul>
<li><strong>在外部类以外使用静态内部类</strong></li>
</ul>
<blockquote>
<p>因为静态内部类是外部类<mark>类相关的</mark>，因此创建内部类对象时无须创建外部类对象。</p>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">new</span> <span class="token class-name">OuterClass<span class="token punctuation">.</span>InnerConstructor</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在外部类以外的地方创建静态内部类的实例。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">StaticOut</span> <span class="token punctuation">{</span>
...
<p>因为调用静态内部类的构造器时无须使用外部类对象，所以创建静态内部类的子类也比较简单，下面代码就为静态内部类 <code v-pre>StaticIn</code> 类定义了一个空的子类。</p>
...
<p>使用静态内部类比使用非静态内部类要简单很多，只要把外部类当成静态内部类的包空间即可。因此当程序需要使用内部类时，应该优先考虑使用静态内部类。</p>
</blockquote>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>既然内部类是外部类的成员，那么是否可以为外部类定义子类，在子类中再定义一个内部类来重写其父类中的内部类？</p>
<p>不可以！内部类的类名不再是简单地由内部类的类名组成，它实际上还把外部类的类名作为一个命名空间，作为内部类类名的限制。</p>
<p>因此子类中的内部类和父类中的内部类不可能完全同名，即使二者所包含的内部类的类名相同，但因为它们所处的外部类空间不同，所以它们不可能完全同名，也就不可能重写。</p>
</div>
<h3 id="局部内部类" tabindex="-1"><a class="header-anchor" href="#局部内部类" aria-hidden="true">#</a> 局部内部类</h3>
<p>如果把一个内部类放在方法里定义，则这个内部类就是一个局部内部类，局部内部类仅在该方法里有效。由于局部内部类不能在外部类的方法以外的地方使用，因此局部内部类也不能使用访问控制符和 <code v-pre>static</code> 修饰符修饰。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>对于局部成员而言，不管是局部变量还是局部内部类，它们的上一级程序单元都是方法，而不是类，使用 <code v-pre>static</code> 修饰它们没有任何意义。</p>
<p>因此，所有的局部成员都不能使用 <code v-pre>static</code> 修饰。</p>
<p>不仅如此，因为局部成员的作用域是所在方法，其他程序单元永远也不可能访问另一个方法中的局部成员，所以所有的局部成员都不能使用访问控制符修饰。</p>
</div>
<p>如果需要用局部内部类定义变量、创建实例或派生子类，那么都只能在局部内部类所在的方法内进行。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">LocalInnerClass</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编译上面程序，看到生成了三个 <code v-pre>class</code> 文件：<code v-pre>LocalInnerClass.class</code>、<code v-pre>LocalInnerClass$1InnerBase.class</code> 和 <code v-pre>LocalInnerClass$1InnerSub.class</code>，这表明局部内部类的 <code v-pre>class</code> 文件总是遵循如下命名格式：<code v-pre>OuterClass$NInnerClass.class</code>。</p>
<p>注意到局部内部类的 <code v-pre>class</code> 文件的文件名比成员内部类的 <code v-pre>class</code> 文件的文件名多了一个数字，这是因为同一个类里不可能有两个同名的成员内部类，而同一个类里则可能有两个以上同名的局部内部类（处于不同方法中），所以 Java 为局部内部类的 <code v-pre>class</code> 文件名中增加了一个数字，用于区分。</p>
<h3 id="匿名内部类" tabindex="-1"><a class="header-anchor" href="#匿名内部类" aria-hidden="true">#</a> 匿名内部类</h3>
<p>匿名内部类适合创建那种只需要一次使用的类，例如前面介绍命令模式时所需要的 <code v-pre>Command</code> 对象。匿名内部类的语法有点奇怪，创建匿名内部类时会立即创建一个该类的实例，这个类定义立即消失，匿名内部类不能重复使用。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>匿名内部类必须继承一个父类，或实现一个接口，但最多只能继承一个父类，或实现一个接口。</p>
<ol>
<li>匿名内部类不能是抽象类，因为系统在创建匿名内部类时，会立即创建匿名内部类的对象。因此不允许将匿名内部类定义成抽象类。</li>
<li>匿名内部类不能定义构造器，因为匿名内部类没有类名，所以无法定义构造器，但匿名内部类可以定义实例初始化块，通过实例初始化块来完成构造器需要完成的事情。</li>
</ol>
<p>最常用的创建匿名内部类的方式是需要创建某个接口类型的对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">interface</span> <span class="token class-name">Product</span> <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AnonymousTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>AnonymousTest</code> 类定义了一个 <code v-pre>test</code> 方法，该方法需要一个 <code v-pre>Product</code> 对象作为参数，但 <code v-pre>Product</code> 只是一个接口，无法直接创建对象，因此此处考虑创建一个 <code v-pre>Product</code> 接口实现类的对象传入该方法——如果这个 <code v-pre>Product</code> 接口实现类需要重复使用，则应该将该实现类定义成一个独立类；如果这个 <code v-pre>Product</code> 接口实现类只需一次使用，则可采用上面程序中的方式，定义一个匿名内部类。</p>
<p>由于匿名内部类不能是抽象类，所以匿名内部类必须实现它的抽象父类或者接口里包含的所有抽象方法。</p>
<p>上面创建 <code v-pre>Product</code> 实现类对象的代码，可以拆分成如下代码。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">AnonymousProduct</span> <span class="token keyword">implements</span> <span class="token class-name">Product</span><span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">double</span> <span class="token function">getPrice</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
        <span class="token keyword">return</span> <span class="token number">567.8</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
    <span class="token keyword">public</span> <span class="token class-name">String</span> <span class="token function">getName</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当通过实现接口来创建匿名内部类时，匿名内部类也不能显式创建构造器，因此匿名内部类只有一个隐式的无参数构造器，故 <code v-pre>new</code> 接口名后的括号里不能传入参数值。</p>
<p>但如果通过继承父类来创建匿名内部类时，匿名内部类将拥有和父类相似的构造器，此处的相似指的是拥有相同的形参列表。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">abstract</span> <span class="token keyword">class</span> <span class="token class-name">Device</span> <span class="token punctuation">{</span>
    <span class="token keyword">private</span> <span class="token class-name">String</span> name<span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AnonymousInner</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>程序创建了一个抽象父类 <code v-pre>Device</code> 类，这个抽象父类里包含两个构造器：一个无参数的，一个有参数的。当创建以 <code v-pre>Device</code> 为父类的匿名内部类时，既可以传入参数，也可以不传入参数。</p>
<p>当创建匿名内部类时，必须实现接口或抽象父类里的所有抽象方法。如果有需要，也可以重写父类中的普通方法。</p>
<p>如果匿名内部类需要访问外部类的局部变量，则必须使用 <code v-pre>final</code> 修饰符来修饰外部类的局部变量，否则系统将报错。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">interface</span> <span class="token class-name">A</span> <span class="token punctuation">{</span>
...
<p class="custom-container-title">相关信息</p>
<p>为什么需要用 <code v-pre>final</code> 修饰局部变量呢?</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">InnerClass</span> <span class="token punctuation">{</span>
...
<blockquote>
<p>因为局部变量直接存储在栈中，当方法执行结束，非 <code v-pre>final</code> 的局部变量就被销毁，而局部内部类对局部变量的引用依然存在，当局部内部类要调用局部变量时，就会出错，出现非法引用 。</p>
<p><strong>简单来说，就是非 <code v-pre>final</code> 的局部变量的生命周期比局部内部类的生命周期短</strong>。</p>
<p>是不是直接可以拷贝变量到局部内部类？</p>
<p>这样内部类中就可以使用而且不担心生命周期问题呢？</p>
<p>也是不可以的，因为直接拷贝又会出现第二个问题，就是数据不同步。</p>
</blockquote>
<p>数据不同步：</p>
<blockquote>
<p>内部类并不是直接使用传递进来的参数，而是将传递进来的参数通过自己的构造器备份到自己内部，表面看是同一个变量，实际调用的是自己的属性而不是外部类方法的参数，如果在内部类中，修改了这些参数，并不会对外部变量产生影响，仅仅改变局部内部类中备份的参数。</p>
<p>如果外部类调用外部变量时发现值并没有被修改，这种问题就会很尴尬，造成数据不同步。</p>
<p><strong>所以使用 <code v-pre>final</code> 避免数据不同步的问题</strong>。</p>
</blockquote>
<p>那为什么添加 <code v-pre>final</code> 修饰的局部变量，就可以被局部内部类引用呢？</p>
<blockquote>
<p>若定义为 <code v-pre>final</code>，则 java 编译器则会在内部类 <code v-pre>NewAge</code> 内生成一个外部变量的拷贝，而且可以既可以保证内部类可以引用外部属性，又能保证值的唯一性。</p>
<p><strong>也就是拷贝了一个变量的副本，提供给局部内部类,这个副本的生命周期和局部内部类一样长，并且这个副本不可以修改，保证了数据的同步</strong>。</p>
</blockquote>
<p>在 Java8 中，被局部内部类引用的局部变量，默认添加 <code v-pre>final</code>，所以不需要添加 <code v-pre>final</code> 关键词。</p>
<p>idea 查看编译后的 <code v-pre>class</code>：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">ATest</span>$<span class="token number">1</span>NewAge <span class="token punctuation">{</span>
...
<h3 id="闭包和回调" tabindex="-1"><a class="header-anchor" href="#闭包和回调" aria-hidden="true">#</a> 闭包和回调</h3>
<p>闭包（Closure）是一种能被调用的对象，它保存了创建它的作用域信息。</p>
<p>对于非静态内部类而言，它不仅记录了其外部类的详细信息，还保留了一个创建非静态内部类对象的引用，并且可以直接调用外部类的 <code v-pre>private</code> 成员，因此可以把非静态内部类当成面向对象领域的闭包。</p>
<p>回调就是某个方法一旦获得了内部类对象的引用后，就可以在合适的时候反过来去调用外部类实例的方法。</p>
<p>所谓回调，就是允许客户类通过内部类引用来调用其外部类的方法，这是一种非常灵活的功能。</p>
<p>假设现在有一个人，既是一个程序员，也是一个教师。也就是说，需要定义一个特殊的类，既需要实现 <code v-pre>Teachable</code> 接口，也需要继承 <code v-pre>Programmer</code> 父类。</p>
<p>表面上看起来这没有任何问题，问题是 <code v-pre>Teachable</code> 接口和 <code v-pre>Programmer</code> 父类里包含了相同的 <code v-pre>work</code> 方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">TeachableProgrammer</span> <span class="token keyword">extends</span> <span class="token class-name">Programmer</span> <span class="token keyword">implements</span> <span class="token class-name">Teachable</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的 <code v-pre>TeachableProgrammer</code> 类只有一个 <code v-pre>work</code> 方法，这个 <code v-pre>work</code> 方法只能进行“教学”，不可以进行“编程”。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">TeachableProgrammer</span> <span class="token keyword">extends</span> <span class="token class-name">Programmer</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面的 <code v-pre>TeachableProgrammer</code> 类只是 <code v-pre>Programmer</code> 类的子类，它可以直接调用 <code v-pre>Programmer</code> 基类的 <code v-pre>work</code> 方法，该类也包含教学的 <code v-pre>teach</code> 方法，但这个方法与 <code v-pre>Teachable</code> 接口没有任何关系，<code v-pre>TeachableProgrammer</code> 也不能当成 <code v-pre>Teachable</code> 使用。</p>
<p>此时创建了一个 <code v-pre>Closure</code> 内部类，它实现了 <code v-pre>Teachable</code> 接口，并实现了教学的 <code v-pre>work</code> 方法，但这种实现是通过回调 <code v-pre>TeachableProgrammer</code> 类的 <code v-pre>teach</code> 方法实现的。</p>
<p>如果需要让 <code v-pre>TeachableProgrammer</code> 对象进行教学，只需调用 <code v-pre>Closure</code> 内部类（它是 <code v-pre>Teachable</code> 接口的实现类）对象的 <code v-pre>work</code> 方法即可。</p>
<p><code v-pre>TeachableProgrammer</code> 类提供了一个获取内部类对象的方法，该方法无须返回 <code v-pre>Closure</code> 类型，只需返回所实现接口：<code v-pre>Teachable</code> 类型即可，接下来它就可当成一个 <code v-pre>Teachable</code> 对象使用了。</p>
<p>从图中清楚地看出 <code v-pre>Closure</code> 内部类的作用，它可以实现 <code v-pre>Teachable</code> 接口，也可以当成 <code v-pre>Teachable</code> 使用，而且它是 <code v-pre>TeachableProgrammer</code> 的内部类，是回调<code v-pre>TeachableProgrammer</code> 对象方法的入口，它的 <code v-pre>work</code> 方法实际上回调了 <code v-pre>TeachableProgrammer</code> 类的 <code v-pre>teach</code> 方法。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207161657988.jpeg" alt="img"></p>
<p>如何让 <code v-pre>TeachableProgrammer</code> 对象既执行“教学”的 <code v-pre>work</code> 方法，也执行“编程”的 <code v-pre>work</code> 方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">TeachableProgrammerTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="枚举类" tabindex="-1"><a class="header-anchor" href="#枚举类" aria-hidden="true">#</a> 枚举类</h2>
<p>在某些情况下，一个类的对象是有限而且固定的，比如季节类，它只有 4 个对象；再比如行星类，目前只有 9 个对象。这种实例有限而且固定的类，在 Java 里被称为枚举类。</p>
<h3 id="手动实现枚举类" tabindex="-1"><a class="header-anchor" href="#手动实现枚举类" aria-hidden="true">#</a> 手动实现枚举类</h3>
<ol>
<li>通过 <code v-pre>private</code> 将构造器隐藏起来。</li>
<li>把这个类的所有可能实例都使用 <code v-pre>public static final</code> 修饰的类变量来保存。</li>
<li>如果有必要，可以提供一些静态方法，允许其他程序根据特定参数来获取与之匹配的实例。</li>
</ol>
<p>下面程序将定义一个 <code v-pre>Season</code> 类，这个类只能产生 4 个对象，该 <code v-pre>Season</code> 类被定义成一个枚举类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Season</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Season</code> 类是一个不可变类，<code v-pre>Season</code> 类中包含了 4 个 <code v-pre>static final</code> 常量 Field，这 4 个常量 Field 就代表了该类所能创建的对象。其他程序需要使用 <code v-pre>Season</code> 对象时，既可通过如 <code v-pre>Season.SPRING</code> 的方式来取得 <code v-pre>Season</code> 对象，也可通过 <code v-pre>getSeason()</code> 静态工厂方法来获得 <code v-pre>Season</code> 对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">SeasonTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>枚举类可以使程序更加健壮，避免创建对象的随意性。</p>
<h3 id="枚举类入门" tabindex="-1"><a class="header-anchor" href="#枚举类入门" aria-hidden="true">#</a> 枚举类入门</h3>
<p>Java 5 新增了一个 <code v-pre>enum</code> 关键字（它与 <code v-pre>class</code>、<code v-pre>interface</code> 关键字的地位相同），用以定义枚举类。</p>
<p>枚举类是一种特殊的类，它一样可以有自己的 Field、方法，可以实现一个或者多个接口，也可以定义自己的构造器。一个 Java 源文件中最多只能定义一个 <code v-pre>public</code> 访问权限的枚举类，且该 Java 源文件也必须和该枚举类的类名相同。</p>
<p>它与普通类有如下简单区别。</p>
<blockquote>
<ol>
<li>枚举类可以实现一个或多个接口，使用 <code v-pre>enum</code> 定义的枚举类默认继承了 <code v-pre>java.lang.Enum</code> 类，而不是继承 <code v-pre>Object</code> 类。其中 <code v-pre>java.lang.Enum</code> 类实现了 <code v-pre>java.lang.Serializable</code> 和 <code v-pre>java.lang. Comparable</code> 两个接口。</li>
<li>使用 <code v-pre>enum</code> 定义、非抽象的枚举类默认会使用 <code v-pre>final</code> 修饰，因此枚举类不能派生子类。</li>
<li>枚举类的构造器只能使用 <code v-pre>private</code> 访问控制符，如果省略了构造器的访问控制符，则默认使用 <code v-pre>private</code> 修饰；如果强制指定访问控制符，则只能指定 <code v-pre>private</code> 修饰符。</li>
<li><mark>枚举类的所有实例必须在枚举类的第一行显式列出</mark>，否则这个枚举类永远都不能产生实例。列出这些实例时，系统会自动添加 <code v-pre>public static final</code> 修饰，无须程序员显式添加。</li>
</ol>
</blockquote>
<p>所有的枚举类都提供了一个 <code v-pre>values</code> 方法，该方法可以很方便地遍历所有的枚举值。</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编译上面 Java 程序，将生成一个 <code v-pre>SeasonEnum.class</code> 文件，这表明枚举类是一个特殊的 Java 类。<code v-pre>enum</code> 关键字和 <code v-pre>class</code>、<code v-pre>interface</code> 关键字的作用大致相似。</p>
<p>如果需要使用该枚举类的某个实例，则可使用 <code v-pre>EnumClass.variable</code> 的形式，如 <code v-pre>SeasonEnum.SPRING</code>。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">EnumTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面程序的 <code v-pre>switch</code> 表达式中还使用了 <code v-pre>SeasonEnum</code> 对象作为表达式，这是 JDK 1.5 增加枚举后对 <code v-pre>switch</code> 的扩展：<code v-pre>switch</code> 的控制表达式可以是任何枚举类型。不仅如此，当 <code v-pre>switch</code> 控制表达式使用枚举类型时，后面 <code v-pre>case</code> 表达式中的值直接使用枚举值的名字，无须添加枚举类作为限定。</p>
<p>所以枚举类可以直接使用 <code v-pre>java.lang.Enum</code> 类中所包含的方法。</p>
<p><code v-pre>java.lang.Enum</code>类中提供了如下几个方法。</p>
<blockquote>
<ol>
<li><code v-pre>int compareTo(E o)</code>：该方法用于与指定枚举对象比较顺序，同一个枚举实例只能与相同类型的枚举实例进行比较。如果该枚举对象位于指定枚举对象之后，则返回正整数；如果该枚举对象位于指定枚举对象之前，则返回负整数，否则返回零。</li>
<li><code v-pre>String name()</code>：返回此枚举实例的名称，这个名称就是定义枚举类时列出的所有枚举值之一。与此方法相比，大多数程序员应该优先考虑使用 <code v-pre>toString()</code> 方法，因为 <code v-pre>toString()</code> 方法返回更加用户友好的名称。</li>
<li><code v-pre>int ordinal()</code>：返回枚举值在枚举类中的索引值（就是枚举值在枚举声明中的位置，第一个枚举值的索引值为零）。</li>
<li><code v-pre>String toString()</code>：返回枚举常量的名称，与 <code v-pre>name</code> 方法相似，但 <code v-pre>toString()</code> 方法更常用。</li>
<li><code v-pre>public static &lt;T extends Enum&lt;T&gt;&gt; T valueOf(Class&lt;T&gt; enumType,String name)</code>：这是一个静态方法，用于返回指定枚举类中指定名称的枚举值。名称必须与在该枚举类中声明枚举值时所用的标识符完全匹配，不允许使用额外的空白字符。</li>
</ol>
</blockquote>
<p>当我们使用 <code v-pre>System.out.println(s)</code> 语句来打印枚举值时，实际上输出的是该枚举值的 <code v-pre>toString()</code> 方法，也就是输出该枚举值的名字。</p>
<h3 id="枚举类的-field、方法和构造器" tabindex="-1"><a class="header-anchor" href="#枚举类的-field、方法和构造器" aria-hidden="true">#</a> 枚举类的 Field、方法和构造器</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>使用该枚举类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">GenderTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>把类设计成良好封装的类，不允许直接访问 <code v-pre>Gender</code> 类的 <code v-pre>name</code> 成员变量，而是通过方法来控制对 <code v-pre>name</code> 的访问。</p>
<p>改进 <code v-pre>Gender</code> 类的设计。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">enum</span> <span class="token class-name">Gender</span> <span class="token punctuation">{</span>
    <span class="token constant">MALE</span><span class="token punctuation">,</span> <span class="token constant">FEMALE</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token class-name">String</span> name<span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>把 <code v-pre>name</code> 设置成 <code v-pre>private</code>，从而避免其他程序直接访问该 <code v-pre>name</code> 成员变量，必须通过 <code v-pre>setName()</code> 方法来修改 <code v-pre>Gender</code> 实例的 <code v-pre>name</code> 变量，而 <code v-pre>setName()</code> 方法就可以保证不会产生混乱。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">GenderTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">// 通过Enum的valueOf方法来获取指定枚举类的枚举值</span>
        <span class="token class-name">Gender</span> g <span class="token operator">=</span> <span class="token class-name">Enum</span><span class="token punctuation">.</span><span class="token function">valueOf</span><span class="token punctuation">(</span><span class="token class-name">Gender</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">,</span> <span class="token string">"FEMALE"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>实际上这种做法依然不够好，枚举类通常应该设计成不可变类，也就是说，它的 Field 值不应该允许改变，这样会更安全，而且代码更加简洁。</p>
<p>我们应该将枚举类的 Field 都使用 <code v-pre>private final</code> 修饰。因为我们将所有的 Field 都使用了 <code v-pre>final</code> 修饰符来修饰，所以必须在构造器里为这些 Field 指定初始值（或者在定义 Field 时指定默认值，或者在初始化块中指定初始值，但这两种情况并不常见），因此应该为枚举类显式定义带参数的构造器。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">enum</span> <span class="token class-name">Gender</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面程序中的枚举值实际上等同于如下两行代码：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="实现接口的枚举类" tabindex="-1"><a class="header-anchor" href="#实现接口的枚举类" aria-hidden="true">#</a> 实现接口的枚举类</h3>
<p>枚举类也可以实现一个或多个接口。与普通类实现一个或多个接口完全一样，枚举类实现一个或多个接口时，也需要实现该接口所包含的方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">GenderDesc</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Gender</code> 枚举类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">enum</span> <span class="token class-name">Gender</span> <span class="token keyword">implements</span> <span class="token class-name">GenderDesc</span> <span class="token punctuation">{</span>
    <span class="token function">MALE</span><span class="token punctuation">(</span><span class="token string">"男"</span><span class="token punctuation">)</span><span class="token punctuation">,</span> <span class="token function">FEMALE</span><span class="token punctuation">(</span><span class="token string">"女"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token keyword">private</span> <span class="token keyword">final</span> <span class="token class-name">String</span> name<span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果由枚举类来实现接口里的方法，则每个枚举值在调用该方法时都有相同的行为方式（因为方法体完全一样）。</p>
<p>如果需要每个枚举值在调用该方法时呈现出不同的行为方式，则可以让每个枚举值分别来实现该方法，每个枚举值提供不同的实现方式，从而让不同的枚举值调用该方法时具有不同的行为方式。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">enum</span> <span class="token class-name">Gender</span> <span class="token keyword">implements</span> <span class="token class-name">GenderDesc</span> <span class="token punctuation">{</span>
    <span class="token comment">//此处的枚举值必须调用对应的构造器来创建</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当我们创建 <code v-pre>MALE</code> 和 <code v-pre>FEMALE</code> 两个枚举值时，后面又紧跟了一对花括号，这对花括号里包含了一个 <code v-pre>info</code> 方法定义。</p>
<p>花括号部分实际上就是一个类体部分，在这种情况下，当创建 <code v-pre>MALE</code>、<code v-pre>FEMALE</code> 枚举值时，并不是直接创建 <code v-pre>Gender</code> 枚举类的实例，而是相当于创建 <code v-pre>Gender</code> 的匿名子类的实例。</p>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>枚举类不是用 <code v-pre>final</code> 修饰了吗？怎么还能派生子类呢？</p>
<p>并不是所有的枚举类都使用了 <code v-pre>final</code> 修饰！非抽象的枚举类才默认使用 <code v-pre>final</code> 修饰。对于一个抽象的枚举类而言——只要它包含了抽象方法，它就是抽象枚举类，系统会默认使用 <code v-pre>abstract</code> 修饰，而不是使用 <code v-pre>final</code> 修饰。</p>
</div>
<p>编译上面的程序，可以看到生成了 <code v-pre>Gender.class</code>、<code v-pre>Gender$1.class</code> 和 <code v-pre>Gender$2.class</code>三个文件，这样的三个 <code v-pre>class</code> 文件正好证明了上面的结论：<code v-pre>MALE</code> 和 <code v-pre>FEMALE</code> 实际上是 <code v-pre>Gender</code> 匿名子类的实例，而不是 <code v-pre>Gender</code> 类的实例。</p>
<h3 id="包含抽象方法的枚举类" tabindex="-1"><a class="header-anchor" href="#包含抽象方法的枚举类" aria-hidden="true">#</a> 包含抽象方法的枚举类</h3>
<p>假设有一个 <code v-pre>Operation</code> 枚举类，它的 4 个枚举值 <code v-pre>PLUS</code>, <code v-pre>MINUS</code>, <code v-pre>TIMES</code>, <code v-pre>DIVIDE</code> 分别代表加、减、乘、除 4 种运算。为此，我们定义下面的 <code v-pre>Operation</code> 枚举类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">enum</span> <span class="token class-name">Operation</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>仔细观察上面的 <code v-pre>Operation</code> 类不难发现，实际上 <code v-pre>PLUS</code>，<code v-pre>MINUS</code>，<code v-pre>TIMES</code>，<code v-pre>DIVIDE</code> 4 个值对 <code v-pre>eval</code> 方法各有不同的实现。</p>
<p>为此，我们可以采用前面介绍的方法，让它们分别为 4 个枚举值提供 <code v-pre>eval</code> 的实现，然后在 <code v-pre>Operation</code> 类中定义一个 <code v-pre>eval</code> 的抽象方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">enum</span> <span class="token class-name">Operation</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编译上面程序会生成 5 个 <code v-pre>class</code> 文件，其实 <code v-pre>Operation</code> 对应一个 <code v-pre>class</code> 文件，它的 4 个匿名内部子类分别各对应一个 <code v-pre>class</code> 文件。</p>
<p>枚举类里定义抽象方法时不能使用 <code v-pre>abstract</code> 关键字将枚举类定义成抽象类（因为系统自动会为它添加 <code v-pre>abstract</code> 关键字），但因为枚举类需要显式创建枚举值，而不是作为父类，所以定义每个枚举值时必须为抽象方法提供实现，否则将出现编译错误。</p>
<h2 id="对象与垃圾回收" tabindex="-1"><a class="header-anchor" href="#对象与垃圾回收" aria-hidden="true">#</a> 对象与垃圾回收</h2>
<p>Java 的垃圾回收是 Java 语言的重要功能之一。当程序创建对象、数组等引用类型实体时，系统都会在堆内存中为之分配一块内存区，对象就保存在这块内存区中，当这块内存不再被任何引用变量引用时，这块内存就变成垃圾，等待垃圾回收机制进行回收。垃圾回收机制具有如下特征。</p>
<blockquote>
<ol>
<li>垃圾回收机制只负责回收堆内存中的对象，不会回收任何物理资源（例如数据库连接、网络 IO 等资源）。</li>
<li>程序无法精确控制垃圾回收的运行，垃圾回收会在合适的时候进行。当对象永久性地失去引用后，系统就会在合适的时候回收它所占的内存。</li>
<li>在垃圾回收机制回收任何对象之前，总会先调用它的 <code v-pre>finalize()</code> 方法，该方法可能使该对象重新复活（让一个引用变量重新引用该对象），从而导致垃圾回收机制取消回收。</li>
</ol>
</blockquote>
<h3 id="对象在内存中的状态" tabindex="-1"><a class="header-anchor" href="#对象在内存中的状态" aria-hidden="true">#</a> 对象在内存中的状态</h3>
<p>当一个对象在堆内存中运行时，根据它被引用变量所引用的状态，可以把它所处的状态分成如下三种。</p>
<p>可达状态：</p>
<blockquote>
<p>当一个对象被创建后，若有一个以上的引用变量引用它，则这个对象在程序中处于可达状态，程序可通过引用变量来调用该对象的 Field 和方法。</p>
</blockquote>
<p>可恢复状态：</p>
<blockquote>
<p>如果程序中某个对象不再有任何引用变量引用它，它就进入了可恢复状态。在这种状态下，系统的垃圾回收机制准备回收该对象所占用的内存，在回收该对象之前，系统会调用所有可恢复状态对象的 <code v-pre>finalize()</code> 方法进行资源清理。如果系统在调用 <code v-pre>finalize()</code> 方法时重新让一个引用变量引用该对象，则这个对象会再次变为可达状态；否则该对象将进入不可达状态。</p>
</blockquote>
<p>不可达状态：</p>
<blockquote>
<p>当对象与所有引用变量的关联都被切断，且系统已经调用所有对象的 <code v-pre>finalize()</code> 方法后依然没有使该对象变成可达状态，那么这个对象将永久性地失去引用，最后变成不可达状态。只有当一个对象处于不可达状态时，系统才会真正回收该对象所占有的资源。</p>
</blockquote>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207262141244.jpeg" alt="img"></p>
<p>下面程序简单地创建了两个字符串对象，并创建了一个引用变量依次指向两个对象。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">StatusTranfer</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token comment">// ③</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>程序执行 <code v-pre>test</code> 方法的 ① 代码时，代码定义了一个 <code v-pre>a</code> 变量，并让该变量指向 <code v-pre>&quot;轻量级 Java EE 企业应用实战&quot;</code> 字符串，该代码执行结束后，<code v-pre>&quot;轻量级 Java EE 企业应用实战&quot;</code> 字符串对象处于可达状态。</p>
<p>当程序执行了 <code v-pre>test</code> 方法的 ② 代码后，代码再次定义了 <code v-pre>&quot;疯狂 Java 讲义&quot;</code> 字符串对象，并让 <code v-pre>a</code> 变量指向该对象。此时，<code v-pre>&quot;轻量级 Java EE 企业应用实战&quot;</code> 字符串对象处于可恢复状态，而 <code v-pre>&quot;疯狂 Java 讲义&quot;</code> 字符串对象处于可达状态。</p>
...
<h3 id="强制垃圾回收" tabindex="-1"><a class="header-anchor" href="#强制垃圾回收" aria-hidden="true">#</a> 强制垃圾回收</h3>
<p>当一个对象失去引用后，系统何时调用它的 <code v-pre>finalize()</code> 方法对它进行资源清理，何时它会变成不可达状态，系统何时回收它所占有的内存，对于程序完全透明。程序只能控制一个对象何时不再被任何引用变量引用，绝不能控制它何时被回收。</p>
<p>程序无法精确控制 Java 垃圾回收的时机，但我们依然可以强制系统进行垃圾回收——这种强制只是通知系统进行垃圾回收，但系统是否进行垃圾回收依然不确定。大部分时候，程序强制系统垃圾回收后总会有一些效果。强制系统垃圾回收有如下两个方法。</p>
<ol>
<li>调用 <code v-pre>System</code> 类的 <code v-pre>gc()</code> 静态方法：<code v-pre>System.gc()</code></li>
<li>调用 <code v-pre>Runtime</code> 对象的 <code v-pre>gc()</code> 实例方法：<code v-pre>Runtime.getRuntime().gc()</code></li>
</ol>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GCTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编译、运行上面程序，看不到任何输出，可见直到系统退出，系统都不曾调用 <code v-pre>GCTest</code> 对象的 <code v-pre>finalize()</code> 方法。</p>
<p>但如果将程序修改成如下形式：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">GCTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">int</span> i <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">4</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编译上面程序，使用如下命令来运行此程序：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">java</span> <span class="token parameter variable">-verbose:gc</span> GCTest
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>运行 java 命令时指定 <code v-pre>-verbose:gc</code> 选项，可以看到每次垃圾回收后的提示信息。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207271422987.png" alt="image-20220727142157771"></p>
<p>每次调用了 <code v-pre>Runtime.getRuntime().gc()</code> 代码后，系统垃圾回收机制还是“有所动作”的，可以看出垃圾回收之前、回收之后的内存占用对比。</p>
<p>虽然图中显示了程序强制垃圾回收的效果，但这种强制只是建议系统立即进行垃圾回收，系统完全有可能并不立即进行垃圾回收，垃圾回收机制也不会对程序的建议完全置之不理：垃圾回收机制会在收到通知后，尽快进行垃圾回收。</p>
<h3 id="finalize-方法" tabindex="-1"><a class="header-anchor" href="#finalize-方法" aria-hidden="true">#</a> finalize 方法</h3>
<p>在垃圾回收机制回收某个对象所占用的内存之前，通常要求程序调用适当的方法来清理资源，在没有明确指定清理资源的情况下，Java 提供了默认机制来清理该对象的资源，这个机制就是 <code v-pre>finalize()</code> 方法。</p>
<p>该方法是定义在 <code v-pre>Object</code> 类里的实例方法，方法原型为：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>当 <code v-pre>finalize()</code> 方法返回后，对象消失，垃圾回收机制开始执行。方法原型中的 <code v-pre>throws Throwable</code> 表示它可以抛出任何类型的异常。</p>
<p>任何 Java 类都可以重写 <code v-pre>Object</code> 类的 <code v-pre>finalize()</code> 方法，在该方法中清理该对象占用的资源。如果程序终止之前始终没有进行垃圾回收，则不会调用失去引用对象的 <code v-pre>finalize()</code> 方法来清理资源。</p>
<p>垃圾回收机制何时调用对象的 <code v-pre>finalize()</code> 方法是完全透明的，只有当程序认为需要更多的额外内存时，垃圾回收机制才会进行垃圾回收。</p>
<p>因此，完全有可能出现这样一种情形：某个失去引用的对象只占用了少量内存，而且系统没有产生严重的内存需求，因此垃圾回收机制并没有试图回收该对象所占用的资源，所以该对象的 <code v-pre>finalize()</code> 方法也不会得到调用。</p>
<p><code v-pre>finalize()</code> 方法具有如下 4 个特点。</p>
<ol>
<li>永远不要主动调用某个对象的 <code v-pre>finalize()</code> 方法，该方法应交给垃圾回收机制调用。</li>
<li><code v-pre>finalize()</code> 方法何时被调用，是否被调用具有不确定性，不要把 <code v-pre>finalize()</code> 方法当成一定会被执行的方法。</li>
<li>当 JVM 执行可恢复对象的 <code v-pre>finalize()</code> 方法时，可能使该对象或系统中其他对象重新变成可达状态。</li>
<li>当 JVM 执行 <code v-pre>finalize()</code> 方法时出现异常时，垃圾回收机制不会报告异常，程序继续执行。</li>
</ol>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>由于 <code v-pre>finalize()</code> 方法并不一定会被执行，因此如果想清理某个类里打开的资源，则不要放在 <code v-pre>finalize()</code> 方法中进行清理。</p>
</div>
<p>在 <code v-pre>finalize</code> 方法里复活自身。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">FinalizeTest</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面程序中定义了一个 <code v-pre>FinalizeTest</code> 类，重写了该类的 <code v-pre>finalize()</code> 方法，在该方法中把需要清理的可恢复对象重新赋给 <code v-pre>ft</code> 引用变量，从而让该可恢复对象重新变成可达状态。</p>
<p>上面程序中的 <code v-pre>main</code> 方法创建了一个 <code v-pre>FinalizeTest</code> 类的匿名对象，因为创建后没有把这个对象赋给任何引用变量，所以该对象立即进入可恢复状态。</p>
<p>进入可恢复状态后，系统调用 ① 行代码通知系统进行垃圾回收，② 行代码强制系统暂停 2 秒，再次调用 <code v-pre>ft</code> 对象的 <code v-pre>info</code> 方法。</p>
<p>编译、运行上面程序，看到 <code v-pre>ft</code> 的 <code v-pre>info</code> 方法被正常执行。</p>
<p>如果删除 ② 行代码，取消让系统暂停 2 秒。再次编译、运行上面程序，将会看到如下结果。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207311704463.png" alt="image-20220731170407253"></p>
<p>当程序执行了 <code v-pre>System.gc();</code> 后，系统并未立即进行垃圾回收，否则将会先调用可恢复对象的 <code v-pre>finalize()</code> 方法，也就会让 <code v-pre>ft</code> 引用到堆内存中的 <code v-pre>FinalizeTest</code> 对象，就不会引发空指针异常了。</p>
<p>当增加 ② 行代码让系统暂停 2 秒后，程序暂停了，垃圾回收机制也收到了程序的通知，因此开始进行垃圾回收，也就调用了可恢复对象的 <code v-pre>finalize()</code> 方法，从而让 <code v-pre>ft</code> 引用到堆内存中的 <code v-pre>FinalizeTest</code> 对象。</p>
<p><code v-pre>System</code> 和 <code v-pre>Runtime</code> 类里都提供了一个 <code v-pre>runFinalization</code> 方法，可以强制垃圾回收机制调用系统中可恢复对象的 <code v-pre>finalize</code> 方法。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">FinalizeTest2</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面程序不再让系统暂停，而是增加了 ① 行代码，这行代码强制垃圾回收机制调用可恢复对象的 <code v-pre>finalize()</code> 方法。该方法执行结束后，<code v-pre>ft</code> 将引用到系统试图回收的 <code v-pre>FinalizeTest2</code> 对象，所以上面程序可以正常执行 <code v-pre>ft</code> 的 <code v-pre>info</code> 方法。上面程序中被注释的 ② 行代码与 ① 行代码有相同的功能。</p>
<h3 id="对象的软、弱和虚引用" tabindex="-1"><a class="header-anchor" href="#对象的软、弱和虚引用" aria-hidden="true">#</a> 对象的软、弱和虚引用</h3>
<p>对大部分对象而言，程序里会有一个引用变量引用该对象，这是最常见的引用方式。除此之外，<code v-pre>java.lang.ref</code> 包下提供了 3 个类：<code v-pre>SoftReference</code>、<code v-pre>PhantomReference</code> 和 <code v-pre>WeakReference</code>，它们分别代表了系统对对象的 3 种引用方式：软引用、虚引用和弱引用。因此，Java 语言对对象的引用有如下 4 种方式。</p>
<p>强引用（<code v-pre>StrongReference</code>）</p>
<blockquote>
<p>这是 Java 程序中最常见的引用方式。程序创建一个对象，并把这个对象赋给一个引用变量，程序通过该引用变量来操作实际的对象，前面介绍的对象和数组都采用了这种强引用的方式。当一个对象被一个或一个以上的引用变量所引用时，它处于可达状态，不可能被系统垃圾回收机制回收。</p>
</blockquote>
<p>软引用（<code v-pre>SoftReference</code>）</p>
<blockquote>
<p>软引用需要通过 <code v-pre>SoftReference</code> 类来实现，当一个对象只有软引用时，它有可能被垃圾回收机制回收。对于只有软引用的对象而言，当系统内存空间足够时，它不会被系统回收，程序也可使用该对象；当系统内存空间不足时，系统可能会回收它。软引用通常用于对内存敏感的程序中。</p>
</blockquote>
<p>弱引用（<code v-pre>WeakReference</code>）</p>
<blockquote>
<p>弱引用通过<code v-pre>WeakReference</code>类实现，弱引用和软引用很像，但弱引用的引用级别更低。对于只有弱引用的对象而言，当系统垃圾回收机制运行时，不管系统内存是否足够，总会回收该对象所占用的内存。当然，并不是说当一个对象只有弱引用时，它就会立即被回收——正如那些失去引用的对象一样，必须等到系统垃圾回收机制运行时才会被回收。</p>
</blockquote>
<p>虚引用（<code v-pre>PhantomReference</code>）</p>
<blockquote>
<p>虚引用通过 <code v-pre>PhantomReference</code> 类实现，虚引用完全类似于没有引用。虚引用对对象本身没有太大影响，对象甚至感觉不到虚引用的存在。如果一个对象只有一个虚引用时，那么它和没有引用的效果大致相同。虚引用主要用于跟踪对象被垃圾回收的状态，虚引用不能单独使用，虚引用必须和引用队列（<code v-pre>ReferenceQueue</code>）联合使用。</p>
</blockquote>
<p>上面三个引用类都包含了一个 <code v-pre>get</code> 方法，用于获取被它们所引用的对象。</p>
<div class="custom-container info">
<p class="custom-container-title">相关信息</p>
<p>如果需要掌握 JDK 系统类的详细用法，例如，包含哪些可用的 Field 和方法（<code v-pre>protected</code> 和 <code v-pre>public</code> 权限的 Field 和方法），以及包含哪些构造器都应该查阅 Java 提供的 API 文档。</p>
</div>
<p>引用队列由 <code v-pre>java.lang.ref.ReferenceQueue</code> 类表示，它用于保存被回收后对象的引用。当联合使用软引用、弱引用和引用队列时，系统在回收被引用的对象之后，将把被回收对象对应的引用添加到关联的引用队列中。</p>
<p>与软引用和弱引用不同的是，虚引用在对象被释放之前，将把它对应的虚引用添加到它关联的引用队列中，这使得可以在对象被回收之前采取行动。</p>
<p>软引用和弱引用可以单独使用，但虚引用不能单独使用，单独使用虚引用没有太大的意义。虚引用的主要作用就是跟踪对象被垃圾回收的状态，程序可以通过检查与虚引用关联的引用队列中是否已经包含了该虚引用，从而了解虚引用所引用的对象是否即将被回收。</p>
<p>弱引用所引用的对象被系统垃圾回收过程。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ReferenceTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207311728736.jpeg" alt="img"></p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>编译上面程序时会出现一个警告提示，这个警告提示是一个泛型提示。此处先不要理它。</p>
<p>不仅如此，上面程序创建 <code v-pre>&quot;疯狂 Java 讲义&quot;</code> 字符串对象时，不要使用 <code v-pre>String str=&quot;疯狂Java讲义&quot;;</code>，否则将看不到运行效果。</p>
<p>因为采用 <code v-pre>String str=&quot;疯狂Java讲义&quot;;</code> 代码定义字符串时，系统会使用常量池来管理这个字符串直接量（会使用强引用来引用它），系统不会回收这个字符串直接量。</p>
</div>
<p>下面程序与上面程序基本相似，只是使用了虚引用来引用字符串对象，虚引用无法获取它引用的对象。</p>
<p>下面程序还将虚引用和引用队列结合使用，可以看到被虚引用所引用的对象被垃圾回收后，虚引用将被添加到引用队列中。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">PhantomReferenceTest</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
        <span class="token comment">// 创建一个字符串对象</span>
        <span class="token class-name">String</span> str <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">String</span><span class="token punctuation">(</span><span class="token string">"疯狂Java讲义"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为系统无法通过虚引用来获得被引用的对象，所以执行 ① 处的输出语句时，程序将输出 <code v-pre>null</code>（即使此时并未强制进行垃圾回收）。当程序强制垃圾回收后，只有虚引用引用的字符串对象会被垃圾回收，当被引用的对象被回收后，对应的虚引用将被添加到关联的引用队列中，因而将在 ② 代码处看到输出 <code v-pre>true</code>。</p>
<p>使用这些引用类可以避免在程序执行期间将对象留在内存中。如果以软引用、弱引用或虚引用的方式引用对象，垃圾收集器就能够随意地释放对象。如果希望尽可能减小程序在其生命周期中所占用的内存大小时，这些引用类就很有用处。</p>
<p><mark>必须指出：要使用这些特殊的引用类，就不能保留对对象的强引用；如果保留了对对象的强引用，就会浪费这些引用类所提供的任何好处。</mark></p>
<p>由于垃圾回收的不确定性，当程序希望从软、弱引用中取出被引用对象时，可能这个被引用对象已经被释放了。如果程序需要使用那个被引用的对象，则必须重新创建该对象。这个过程可以采用两种风格的代码完成。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 取出弱引用所引用的对象</span>
...
<span class="token comment">// 再次切断obj和对象之间的关联</span>
obj <span class="token operator">=</span> <span class="token keyword">null</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面两段代码采用的都是伪码，其中 <code v-pre>recreateIt</code> 方法用于生成一个 <code v-pre>obj</code> 对象。这两段代码都是先判断 <code v-pre>obj</code> 对象是否已经被回收，如果已经被回收，则重新创建该对象。如果弱引用引用的对象已经被垃圾回收释放了，则重新创建该对象。</p>
<p>但第一段代码存在一定的问题：当 <code v-pre>if</code> 块执行完成后，<code v-pre>obj</code> 还是有可能为 <code v-pre>null</code>。因为垃圾回收的不确定性，假设系统在 ① 和 ② 行代码之间进行垃圾回收，则系统会再次将 <code v-pre>wr</code> 所引用的对象回收，从而导致 <code v-pre>obj</code> 依然为 <code v-pre>null</code>。第二段代码则不会存在这个问题，当 <code v-pre>if</code> 块执行结束后， <code v-pre>obj</code> 一定不为 <code v-pre>null</code>。</p>
<h2 id="修饰符的适用范围" tabindex="-1"><a class="header-anchor" href="#修饰符的适用范围" aria-hidden="true">#</a> 修饰符的适用范围</h2>
<p>Java 修饰符适用范围总表。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202207311805749.jpeg" alt="img"></p>
<p>包访问控制符是一个特殊的修饰符，不用任何访问控制符的就是包访问控制。对于初始化块和局部成员而言，它们不能使用任何访问控制符，所以看起来像使用了包访问控制符。</p>
<p><code v-pre>strictfp</code> 关键字的含义是 <code v-pre>FP-strict</code>，也就是精确浮点的意思。在 Java 虚拟机进行浮点运算时，如果没有指定 <code v-pre>strictfp</code> 关键字，Java 的编译器和运行时环境在浮点运算上不一定令人满意。一旦使用了 <code v-pre>strictfp</code> 来修饰类、接口或者方法时，那么在所修饰的范围内 Java 的编译器和运行时环境会完全依照浮点规范 <code v-pre>IEEE-754</code> 来执行。因此，如果想让浮点运算更加精确，就可以使用 <code v-pre>strictfp</code> 关键字来修饰类、接口和方法。</p>
<p><code v-pre>native</code> 关键字主要用于修饰一个方法，使用 <code v-pre>native</code> 修饰的方法类似于一个抽象方法。与抽象方法不同的是，<code v-pre>native</code> 方法通常采用 C 语言来实现。如果某个方法需要利用平台相关特性，或者访问系统硬件等，则可以使用 <code v-pre>native</code> 修饰该方法，再把该方法交给 C 去实现。一旦 Java 程序中包含了 <code v-pre>native</code> 方法，这个程序将失去跨平台的功能。</p>
<p>在表列出的所有修饰符中，4 个访问控制符是互斥的，最多只能出现其中之一。不仅如此，还有 <code v-pre>abstract</code> 和 <code v-pre>final</code> 不能同时使用，<code v-pre>abstract</code> 和 <code v-pre>static</code> 不能同时使用，<code v-pre>abstract</code> 和 <code v-pre>private</code> 不能同时使用。</p>
</div></template>
