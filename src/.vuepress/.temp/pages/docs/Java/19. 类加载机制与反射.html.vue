<template><div><h1 id="_19-类加载机制与反射" tabindex="-1"><a class="header-anchor" href="#_19-类加载机制与反射" aria-hidden="true">#</a> 19. 类加载机制与反射</h1>
<h2 id="类的加载、连接和初始化" tabindex="-1"><a class="header-anchor" href="#类的加载、连接和初始化" aria-hidden="true">#</a> 类的加载、连接和初始化</h2>
<p>系统可能在第一次使用某个类时加载该类，也可能采用预加载机制来加载某个类。</p>
<h3 id="jvm-和类" tabindex="-1"><a class="header-anchor" href="#jvm-和类" aria-hidden="true">#</a> JVM 和类</h3>
<p>当我们调用 Java 命令运行某个 Java 程序时，该命令将会启动一个 Java 虚拟机进程，不管该 Java 程序有多么复杂，该程序启动了多少个线程，它们都处于该 Java 虚拟机进程里。</p>
<p>同一个 JVM 的所有线程、所有变量都处于同一个进程里，它们都使用该 JVM 进程的内存区。</p>
<p>当系统出现以下几种情况时，JVM 进程将被终止。</p>
<ul>
<li>程序运行到最后正常结束。</li>
<li>程序运行到使用<code v-pre>System.exit()</code>或<code v-pre>Runtime.getRuntime().exit()</code>代码处结束程序。</li>
<li>程序执行过程中遇到未捕获的异常或错误而结束。</li>
<li>程序所在平台强制结束了 JVM 进程。</li>
</ul>
<p>JVM 进程结束，该进程在内存中的状态将会丢失。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">A</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// 定义该类的静态Field</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>定义一个类创建<code v-pre>A</code>类的实例，并访问<code v-pre>A</code>对象的<code v-pre>a Field</code>。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ATest1</span> <span class="token punctuation">{</span>

  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 创建A类的实例</span>
    <span class="token class-name">A</span> a <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">A</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token comment">// 让a实例的a Field值自加</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>下面程序也创建<code v-pre>A</code>对象，并访问其<code v-pre>a Field</code>值。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ATest2</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">// 输出b实例的a Field值</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token class-name">A</span><span class="token punctuation">.</span>a<span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>ATest1</code>结果输出 7，但<code v-pre>ATest2</code>结果输出 6。运行<code v-pre>ATest1</code>和<code v-pre>ATest2</code>是两次运行 JVM 进程，第一次运行 JVM 结束后，它对<code v-pre>A</code>类所做的修改将全部丢失——第二次运行 JVM 时将再次初始化<code v-pre>A</code>类。</p>
<p>两个 JVM 之间并不会共享数据。</p>
<h3 id="类的加载" tabindex="-1"><a class="header-anchor" href="#类的加载" aria-hidden="true">#</a> 类的加载</h3>
<p>当程序主动使用某个类时，如果该类还未被加载到内存中，则系统会通过加载、连接、初始化 3 个步骤来对该类进行初始化。</p>
<p>如果没有意外，JVM 将会连续完成这 3 个步骤，所以有时也把这 3 个步骤统称为类加载或类初始化。</p>
<p>类加载指的是将类的 class 文件读入内存，并为之创建一个<code v-pre>java.lang.Class</code>对象，当程序中使用任何类时，系统都会为之建立一个<code v-pre>java.lang.Class</code>对象。</p>
<p>类的加载由类加载器完成，类加载器通常由 JVM 提供，这些类加载器也是前面所有程序运行的基础，JVM 提供的这些类加载器通常被称为系统类加载器。</p>
<p>除此之外，还可以通过继承<code v-pre>ClassLoader</code>基类来创建自己的类加载器。</p>
<p>通过使用不同的类加载器，可以从不同来源加载类的二进制数据，通常有如下几种来源。</p>
<ul>
<li>从本地文件系统加载 class 文件。</li>
<li>从 JAR 包加载 class 文件。</li>
<li>通过网络加载 class 文件。</li>
<li>把一个 Java 源文件动态编译，并执行加载。</li>
</ul>
<p>类加载器通常无须等到“首次使用”该类时才加载该类，Java 虚拟机规范允许系统预先加载某些类。</p>
<h3 id="类的连接" tabindex="-1"><a class="header-anchor" href="#类的连接" aria-hidden="true">#</a> 类的连接</h3>
<p>当类被加载之后，系统为之生成一个对应的 Class 对象，接着将会进入连接阶段，连接阶段负责把类的二进制数据合并到 JRE 中。</p>
<p>类连接又可分为如下 3 个阶段。</p>
<ol>
<li>验证：验证阶段用于检验被加载的类是否有正确的内部结构，并和其他类协调一致。</li>
<li>准备：类准备阶段则负责为类的静态<code v-pre>Field</code>分配内存，并设置默认初始值。</li>
<li>解析：将类的二进制数据中的符号引用替换成直接引用。</li>
</ol>
<h3 id="类的初始化" tabindex="-1"><a class="header-anchor" href="#类的初始化" aria-hidden="true">#</a> 类的初始化</h3>
<p>在类的初始化阶段，虚拟机负责对类进行初始化，主要就是对静态<code v-pre>Field</code>进行初始化。</p>
<p>在 Java 类中对静态<code v-pre>Field</code>指定初始值有两种方式：</p>
<ol>
<li>声明静态<code v-pre>Field</code>时指定初始值；</li>
<li>使用静态初始化块为静态<code v-pre>Field</code>指定初始值。</li>
</ol>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// 声明a变量时指定初始值</span>
  ...
  <span class="token keyword">static</span> <span class="token punctuation">{</span>
    <span class="token comment">// 使用静态初始化块为b变量指定初始值</span>
    b <span class="token operator">=</span> <span class="token number">6</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>静态<code v-pre>Field c</code>则没有指定初始值，它将采用默认初始值 0。</p>
<p>声明变量时指定初始值，静态初始化块都将被当成类的初始化语句，JVM 会按这些语句在程序中的排列顺序依次执行它们。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Test</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// 声明a变量时指定初始值</span>
  <span class="token keyword">static</span> <span class="token keyword">int</span> a <span class="token operator">=</span> <span class="token number">5</span><span class="token punctuation">;</span>
  <span class="token keyword">static</span> <span class="token keyword">int</span> b <span class="token operator">=</span> <span class="token number">9</span><span class="token punctuation">;</span>        <span class="token comment">// ①</span>
  <span class="token keyword">static</span> <span class="token keyword">int</span> c<span class="token punctuation">;</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当<code v-pre>Test</code>类初始化结束后，该类的静态<code v-pre>Field b</code>的值为 9。</p>
...
<p>JVM 最先初始化的总是<code v-pre>java.lang.Object</code>类。当程序主动使用任何一个类时，系统会保证该类以及所有父类（包括直接父类和间接父类）都会被初始化。</p>
<h3 id="类初始化的时机" tabindex="-1"><a class="header-anchor" href="#类初始化的时机" aria-hidden="true">#</a> 类初始化的时机</h3>
<p>当 Java 程序首次通过下面 6 种方式来使用某个类或接口时，系统就会初始化该类或接口。</p>
<ul>
<li>
<p>创建类的实例。为某个类创建实例的方式包括：使用<code v-pre>new</code>操作符来创建实例，通过反射来创建实例，通过反序列化的方式来创建实例。</p>
</li>
<li>
<p>调用某个类的静态方法。</p>
</li>
<li>
<p>访问某个类或接口的静态<code v-pre>Field</code>，或为该静态<code v-pre>Field</code>赋值。</p>
</li>
<li>
<p>使用反射方式来强制创建某个类或接口对应的<code v-pre>java.lang.Class</code>对象。</p>
<p>例如代码：<code v-pre>Class.forName(&quot;Person&quot;)</code>，如果系统还未初始化<code v-pre>Person</code>类，则这行代码将会导致该<code v-pre>Person</code>类被初始化，并返回<code v-pre>Person</code>类对应的<code v-pre>java.lang.Class</code>对象。</p>
</li>
<li>
<p>初始化某个类的子类。当初始化某个类的子类时，该子类的所有父类都会被初始化。</p>
</li>
<li>
<p>直接使用<code v-pre>java.exe</code>命令来运行某个主类。当运行某个主类时，程序会先初始化该主类。</p>
</li>
</ul>
<p>除此之外，下面的几种情形需要特别指出。</p>
<p>对于一个<code v-pre>final</code>型的静态<code v-pre>Field</code>，如果该<code v-pre>Field</code>的值在编译时就可以确定下来，那么这个<code v-pre>Field</code>相当于“宏变量”。Java 编译器会在编译时直接把这个<code v-pre>Field</code>出现的地方替换成它的值，因此即使程序使用该静态<code v-pre>Field</code>，也不会导致该类的初始化。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">MyTest</span> <span class="token punctuation">{</span>

  <span class="token comment">// 使用一个字符串直接量为static final Field赋值</span>
  <span class="token keyword">static</span> <span class="token keyword">final</span> <span class="token class-name">String</span> compileConstant <span class="token operator">=</span> <span class="token string">"疯狂Java讲义"</span><span class="token punctuation">;</span>

  <span class="token keyword">static</span> <span class="token punctuation">{</span>
    <span class="token comment">// 只在第一次初始化的时候运行</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CompileConstantTest</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 访问、输出MyTest中的compileConstant Field</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当某个静态<code v-pre>Field</code>使用了<code v-pre>final</code>修饰，而且它的值可以在编译时就确定下来，那么程序其他地方使用该静态<code v-pre>Field</code>时，实际上并没有使用该静态<code v-pre>Field</code>，而是相当于使用常量。</p>
<p>反之，如果<code v-pre>final</code>类型的静态<code v-pre>Field</code>的值不能在编译时确定下来，则必须等到运行时才可以确定该<code v-pre>Field</code>的值，如果通过该类来访问它的静态<code v-pre>Field</code>，则会导致该类被初始化。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">class</span> <span class="token class-name">MyTest</span> <span class="token punctuation">{</span>

  <span class="token comment">// 采用系统当前时间为static final Field赋值</span>
  ...
  <span class="token keyword">static</span> <span class="token punctuation">{</span>
    <span class="token comment">// 每次都会运行</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"静态初始化块..."</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CompileConstantTest</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当使用<code v-pre>ClassLoader</code>类的<code v-pre>loadClass()</code>方法来加载某个类时，该方法只是加载该类，并不会执行该类的初始化。使用<code v-pre>Class</code>的<code v-pre>forName()</code>静态方法才会导致强制初始化该类。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">classLoading</span><span class="token punctuation">;</span>

<span class="token doc-comment comment">/**
 * <span class="token keyword">@author</span> 空~ 2022/8/22 周一 16:21
 **/</span>
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Tester</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">static</span> <span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"Tester类的静态初始化块..."</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>强制初始化。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">classLoading</span><span class="token punctuation">;</span>
...
<span class="token doc-comment comment">/**
 * <span class="token keyword">@author</span> 空~ 2022/8/22 周一 16:18
 **/</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ClassLoaderTest</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ClassNotFoundException</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">// 下面语句仅仅是加载Tester类</span>
    ...
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"系统加载Tester类"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token comment">// 下面语句才会初始化Tester类</span>
...
<p>从上面运行结果可以看出，必须等到执行<code v-pre>Class.forName(&quot;Tester&quot;)</code>时才完成对<code v-pre>Tester</code>类的初始化。</p>
<h2 id="类加载器" tabindex="-1"><a class="header-anchor" href="#类加载器" aria-hidden="true">#</a> 类加载器</h2>
<p>类加载器负责将.class 文件（可能在磁盘上，也可能在网络上）加载到内存中，并为之生成对应的<code v-pre>java.lang.Class</code>对象。</p>
<h3 id="类加载器简介" tabindex="-1"><a class="header-anchor" href="#类加载器简介" aria-hidden="true">#</a> 类加载器简介</h3>
<p>类加载器负责加载所有的类，系统为所有被载入内存中的类生成一个<code v-pre>java.lang.Class</code>实例。一旦一个类被载入 JVM 中，同一个类就不会被再次载入了。</p>
<p>在 Java 中，一个类用其全限定类名（包括包名和类名）作为标识；但在 JVM 中，一个类用其全限定类名和其类加载器作为其唯一标识。例如，如果在<code v-pre>pg</code>的包中有一个名为<code v-pre>Person</code>的类，被类加载器<code v-pre>ClassLoader</code>的实例<code v-pre>kl</code>负责加载，则该<code v-pre>Person</code>类对应的<code v-pre>Class</code>对象在 JVM 中表示为（<code v-pre>Person</code>、<code v-pre>pg</code>、<code v-pre>kl</code>）。</p>
<p>这意味着两个类加载器加载的同名类：（<code v-pre>Person</code>、<code v-pre>pg</code>、<code v-pre>kl</code>）和（<code v-pre>Person</code>、<code v-pre>pg</code>、<code v-pre>kl2</code>）是不同的、它们所加载的类也是完全不同、互不兼容的。</p>
<p>当 JVM 启动时，会形成由 3 个类加载器组成的初始类加载器层次结构。</p>
<ul>
<li><code v-pre>Bootstrap ClassLoader</code>：根类加载器。</li>
<li><code v-pre>Extension ClassLoader</code>：扩展类加载器。</li>
<li><code v-pre>System ClassLoader</code>：系统类加载器。</li>
</ul>
<p><code v-pre>Bootstrap ClassLoader</code>被称为引导（也称为原始或根）类加载器，它负责加载 Java 的核心类。在 Sun 的 JVM 中，当执行<code v-pre>java.exe</code>命令时，使用<code v-pre>-Xbootclasspath</code>选项或使用<code v-pre>-D</code>选项指定<code v-pre>sun.boot.class.path</code>系统属性值可以指定加载附加的类。</p>
<p>根类加载器非常特殊，它并不是<code v-pre>java.lang.ClassLoader</code>的子类，而是由 JVM 自身实现的。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">BootstrapTest</span> <span class="token punctuation">{</span>

  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 获取根类加载器所加载的全部URL数组</span>
    ...
    <span class="token comment">// 遍历、输出根类加载器加载的全部URL</span>
...
<p><code v-pre>Extension Classloader</code>被称为扩展类加载器，它负责加载 JRE 的扩展目录（<code v-pre>%JAVA_HOME%/jre/lib/ext</code>或者由<code v-pre>java.ext.dirs</code>系统属性指定的目录）中 JAR 包的类。</p>
<p>通过这种方式，就可以为 Java 扩展核心类以外的新功能，只要我们把自己开发的类打包成 JAR 文件，然后放入<code v-pre>JAVA_HOME/jre/lib/ext</code>路径即可。</p>
<p><code v-pre>System Classloader</code>被称为系统（也称为应用）类加载器，它负责在 JVM 启动时加载来自 java 命令的<code v-pre>-classpath</code>选项、<code v-pre>java.class.path</code>系统属性，或 CLASSPATH 环境变量所指定的 JAR 包和类路径。程序可以通过<code v-pre>ClassLoader</code>的静态方法<code v-pre>getSystemClassLoader()</code>来获取系统类加载器。如果没有特别指定，则用户自定义的类加载器都以类加载器作为父加载器。</p>
<h3 id="类加载机制" tabindex="-1"><a class="header-anchor" href="#类加载机制" aria-hidden="true">#</a> 类加载机制</h3>
<p>JVM 的类加载机制主要有如下 3 种。</p>
<ul>
<li>全盘负责。所谓全盘负责，就是当一个类加载器负责加载某个 Class 时，该 Class 所依赖的和引用的其他 Class 也将由该类加载器负责载入，除非显式使用另外一个类加载器来载入。</li>
<li>父类委托。所谓父类委托，则是先让 parent（父）类加载器试图加载该 Class，只有在父类加载器无法加载该类时才尝试从自己的类路径中加载该类。</li>
<li>缓存机制。缓存机制将会保证所有加载过的 Class 都会被缓存，当程序中需要使用某个 Class 时，类加载器先从缓存区中搜寻该 Class，只有当缓存区中不存在该 Class 对象时，系统才会读取该类对应的二进制数据，并将其转换成 Class 对象，存入缓存区中。这就是为什么修改了 Class 后，必须重新启动 JVM，程序所做的修改才会生效的原因。</li>
</ul>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>类加载器之间的父子关系并不是类继承上的父子关系，这里的父子关系是类加载器实例之间的关系。</p>
</div>
<p>除了可以使用 Java 提供的类加载器之外，也可以实现自己的类加载器，自定义的类加载器通过继承<code v-pre>ClassLoader</code>来实现。JVM 中这 4 种类加载器的层次结构如图所示。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208221641557.jpeg" alt="epub_681336_2424"></p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ClassLoaderPropTest</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span>
    ...
    <span class="token punctuation">}</span>
    <span class="token comment">// 获取系统类加载器的父类加载器，得到扩展类加载器</span>
    ...
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"扩展类加载器："</span> <span class="token operator">+</span> extensionLoader<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"扩展类加载器的加载路径："</span>
    ...
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"扩展类加载器的parent: "</span>
...
<p>系统类加载器：<code v-pre>sun.misc.Launcher$AppClassLoader@18b4aac2</code> &gt; <code v-pre>file:/E:/Project/demo/out/production/test/</code>
扩展类加载器：<code v-pre>sun.misc.Launcher$ExtClassLoader@74a14482</code>
扩展类加载器的加载路径：<code v-pre>D:\jdk\jre\lib\ext;C:\WINDOWS\Sun\Java\lib\ext</code>
扩展类加载器的 parent: <code v-pre>null</code></p>
</blockquote>
<p>表面上看扩展类加载器的父加载器是<code v-pre>null</code>，并不是根类加载器。这是因为根类加载器并没有继承<code v-pre>ClassLoader</code>抽象类，所以扩展类加载器的<code v-pre>getParent()</code>方法返回<code v-pre>null</code>。但实际上，扩展类加载器的父类加载器是根类加载器，只是根类加载器并不是 Java 实现的。</p>
<p>系统类加载器是<code v-pre>AppClassLoader</code>的实例，扩展类加载器是<code v-pre>ExtClassLoader</code>的实例。</p>
<p>类加载器加载 Class 大致要经过如下 8 个步骤。</p>
<ol>
<li>检测此 Class 是否载入过（即在缓存区中是否有此 Class），如果有则直接进入第 8 步，否则接着执行第 2 步。</li>
<li>如果父类加载器不存在（如果没有父类加载器，则要么 parent 一定是根类加载器，要么本身就是根类加载器），则跳到第 4 步执行；如果父类加载器存在，则接着执行第 3 步。</li>
<li>请求使用父类加载器去载入目标类，如果成功载入则跳到第 8 步，否则接着执行第 5 步。</li>
<li>请求使用根类加载器来载入目标类，如果成功载入则跳到第 8 步，否则跳到第 7 步。</li>
<li>当前类加载器尝试寻找 Class 文件（从与此<code v-pre>ClassLoader</code>相关的类路径中寻找），如果找到则执行第 6 步，如果找不到则跳到第 7 步。</li>
<li>从文件中载入 Class，成功载入后跳到第 8 步。</li>
<li>抛出<code v-pre>ClassNotFoundException</code>异常。</li>
<li>返回对应的<code v-pre>java.lang.Class</code>对象。</li>
</ol>
<p>其中，第 5、6 步允许重写<code v-pre>ClassLoader</code>的<code v-pre>findClass()</code>方法来实现自己的载入策略，甚至重写<code v-pre>loadClass()</code>方法来实现自己的载入过程。</p>
<h3 id="创建并使用自定义的类加载器" tabindex="-1"><a class="header-anchor" href="#创建并使用自定义的类加载器" aria-hidden="true">#</a> 创建并使用自定义的类加载器</h3>
<p>JVM 中除根类加载器之外的所有类加载器都是<code v-pre>ClassLoader</code>子类的实例，可以通过扩展<code v-pre>ClassLoader</code>的子类，并重写该<code v-pre>ClassLoader</code>所包含的方法来实现自定义的类加载器。</p>
<p><code v-pre>ClassLoader</code>类有如下两个关键方法。</p>
<ul>
<li><code v-pre>oadClass(String name, boolean resolve)</code>：该方法为<code v-pre>ClassLoader</code>的入口点，根据指定的二进制名称来加载类，系统就是调用<code v-pre>ClassLoader</code>的该方法来获取指定类对应的<code v-pre>Class</code>对象。</li>
<li><code v-pre>findClass(String name)</code>：根据二进制名称来查找类。</li>
</ul>
<p><code v-pre>loadClass()</code>方法的执行步骤如下：</p>
<ol>
<li>用<code v-pre>findLoadedClass(String)</code> 来检查是否已经加载类，如果已经加载则直接返回。</li>
<li>在父类加载器上调用<code v-pre>loadClass()</code>方法。如果父类加载器为<code v-pre>null</code>，则使用根类加载器来加载。</li>
<li>调用<code v-pre>findClass(String)</code>方法查找类。</li>
</ol>
<p>重写<code v-pre>findClass()</code>方法可以避免覆盖默认类加载器的父类委托、缓冲机制两种策略；如果重写<code v-pre>loadClass()</code>方法，则实现逻辑更为复杂。</p>
<p>在<code v-pre>ClassLoader</code>里还有一个核心方法：<code v-pre>Class defineClass(String name, byte[] b,int off, int len)</code>，该方法负责将指定类的字节码文件（即 Class 文件，如<code v-pre>Hello.class</code>）读入字节数组<code v-pre>byte[] b</code>内，并把它转换为<code v-pre>Class</code>对象，该字节码文件可以来源于文件、网络等。</p>
<p><code v-pre>defineClass()</code>方法管理 JVM 的许多复杂的实现，它负责将字节码分析成运行时数据结构，并校验有效性等。</p>
<p><code v-pre>ClassLoader</code>里还包含如下一些普通方法。</p>
<ul>
<li><code v-pre>findSystemClass(String name)</code>：从本地文件系统装入文件。它在本地文件系统中寻找类文件，如果存在，就使用<code v-pre>defineClass()</code>方法将原始字节转换成<code v-pre>Class</code>对象，以将该文件转换成类。</li>
<li><code v-pre>static getSystemClassLoader()</code>：这是一个静态方法，用于返回系统类加载器。</li>
<li><code v-pre>getParent()</code>：获取该类加载器的父类加载器。</li>
<li><code v-pre>resolveClass(Class&lt;?&gt; c)</code>：链接指定的类。类加载器可以使用此方法来链接类 c。</li>
<li><code v-pre>findLoadedClass(String name)</code>：如果此 Java 虚拟机已加载了名为<code v-pre>name</code>的类，则直接返回该类对应的<code v-pre>Class</code>实例，否则返回<code v-pre>null</code>。该方法是 Java 类加载缓存机制的体现。</li>
</ul>
<p>下面程序开发了一个自定义的<code v-pre>ClassLoader</code>，该<code v-pre>ClassLoader</code>通过重写<code v-pre>findClass()</code>方法来实现自定义的类加载机制。这个<code v-pre>ClassLoader</code>可以在加载类之前先编译该类的源文件，从而实现运行 Java 之前先编译该程序的目标，这样即可通过该<code v-pre>ClassLoader</code>直接运行 Java 源文件。</p>
...
<span class="token doc-comment comment">/**
 * <span class="token keyword">@author</span> 空~ 2022/8/22 周一 17:05
 **/</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">CompileClassLoader</span> <span class="token keyword">extends</span> <span class="token class-name">ClassLoader</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">if</span> <span class="token punctuation">(</span>args<span class="token punctuation">.</span>length <span class="token operator">&lt;</span> <span class="token number">1</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"缺少目标类，请按如下格式运行Java源文件："</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
    <span class="token comment">// 第一个参数是需要运行的类</span>
    ...
    <span class="token comment">// 剩下的参数将作为运行目标类时的参数</span>
    <span class="token comment">// 将这些参数复制到一个新数组中</span>
    ...
    <span class="token comment">// 加载需要运行的类</span>
    ...
    <span class="token comment">// 获取需要运行的类的主方法</span>
  ...
  <span class="token comment">// 读取一个文件的内容</span>
  <span class="token keyword">private</span> <span class="token keyword">byte</span><span class="token punctuation">[</span><span class="token punctuation">]</span> <span class="token function">getBytes</span><span class="token punctuation">(</span><span class="token class-name">String</span> filename<span class="token punctuation">)</span>
    ...
    <span class="token keyword">try</span> <span class="token punctuation">(</span>
      ...
      <span class="token comment">// 一次读取Class文件的全部二进制数据</span>
      ...
      <span class="token keyword">if</span> <span class="token punctuation">(</span>r <span class="token operator">!=</span> len<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">throw</span> <span class="token keyword">new</span> <span class="token class-name">IOException</span><span class="token punctuation">(</span><span class="token string">"无法读取全部文件："</span> <span class="token operator">+</span> r <span class="token operator">+</span> <span class="token string">" !="</span> <span class="token operator">+</span> len<span class="token punctuation">)</span><span class="token punctuation">;</span>
      <span class="token punctuation">}</span>
      <span class="token keyword">return</span> raw<span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>

  <span class="token comment">// 定义编译指定Java文件的方法</span>
  <span class="token keyword">private</span> <span class="token keyword">boolean</span> <span class="token function">compile</span><span class="token punctuation">(</span><span class="token class-name">String</span> javaFile<span class="token punctuation">)</span>
      <span class="token keyword">throws</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"CompileClassLoader:正在编译 "</span> <span class="token operator">+</span> javaFile <span class="token operator">+</span> <span class="token string">"..."</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token comment">// 调用系统的javac命令</span>
    ...
    <span class="token keyword">try</span> <span class="token punctuation">{</span>
      <span class="token comment">// 其他线程都等待这个线程完成</span>
    ...
    <span class="token punctuation">}</span>
    <span class="token comment">// 获取javac线程的退出值</span>
    ...
    <span class="token comment">// 返回编译是否成功</span>
  ...
  <span class="token comment">// 重写ClassLoader的findClass方法</span>
  <span class="token keyword">protected</span> <span class="token class-name">Class</span><span class="token generics"><span class="token punctuation">&lt;</span><span class="token operator">?</span><span class="token punctuation">></span></span> <span class="token function">findClass</span><span class="token punctuation">(</span><span class="token class-name">String</span> name<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">ClassNotFoundException</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">// 将包路径中的点（.）替换成斜线（/）</span>
    ...
    <span class="token comment">// 当指定Java源文件存在，且Class文件不存在，或者Java源文件</span>
    <span class="token comment">// 的修改时间比Class文件的修改时间更晚时，重新编译</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span>javaFile<span class="token punctuation">.</span><span class="token function">exists</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">&amp;&amp;</span> <span class="token punctuation">(</span><span class="token operator">!</span>classFile<span class="token punctuation">.</span><span class="token function">exists</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
      ...
      <span class="token keyword">try</span> <span class="token punctuation">{</span>
        <span class="token comment">// 如果编译失败，或者该Class文件不存在</span>
      ...
      <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
    <span class="token comment">// 如果Class文件存在，系统负责将该文件转换成Class对象</span>
    <span class="token keyword">if</span> <span class="token punctuation">(</span>classFile<span class="token punctuation">.</span><span class="token function">exists</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token keyword">try</span> <span class="token punctuation">{</span>
        <span class="token comment">// 将Class文件的二进制数据读入数组</span>
        ...
        <span class="token comment">// 调用ClassLoader的defineClass方法将二进制数据转换成Class对象</span>
      ...
      <span class="token punctuation">}</span>
    <span class="token punctuation">}</span>
    <span class="token comment">// 如果clazz为null，表明加载失败，则抛出异常</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>提供一个简单的主类，该主类无须编译就可以使用上面的<code v-pre>CompileClassLoader</code>来运行它。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Hello</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token class-name">String</span> arg <span class="token operator">:</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"运行Hello的参数："</span> <span class="token operator">+</span> arg<span class="token punctuation">)</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>因为<code v-pre>cmd</code>默认编码为<code v-pre>GBK</code>，直接编译会导致乱码，先将需要的 Java 文件编码格式改为相应类型。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208221803871.png" alt="image-20220822180333754"></p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208221803788.png" alt="image-20220822180300669"></p>
<p>保证<code v-pre>CompileClassLoader</code>类和<code v-pre>Hello</code>在同一个包下（不带包最好），先将<code v-pre>CompileClassLoader</code>类编译成 class 文件。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>javac CompileClassLoader.java
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>然后就可以直接使用 java 命令编译 Hello 类了。</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">java</span> CompileClassLoader Hello 疯狂Java讲义
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208221800656.png" alt="image-20220822180042871"></p>
<p>使用自定义的类加载器，可以实现如下常见功能。</p>
<ul>
<li>执行代码前自动验证数字签名。</li>
<li>根据用户提供的密码解密代码，从而可以实现代码混淆器来避免反编译 Class 文件。</li>
<li>根据用户需求来动态地加载类。</li>
<li>根据应用需求把其他数据以字节码的形式加载到应用中。</li>
</ul>
<h3 id="urlclassloader-类" tabindex="-1"><a class="header-anchor" href="#urlclassloader-类" aria-hidden="true">#</a> URLClassLoader 类</h3>
<p>Java 为<code v-pre>ClassLoader</code>提供了一个<code v-pre>URLClassLoader</code>实现类，该类也是系统类加载器和扩展类加载器的父类（此处是父类，就是指类与类之间的继承关系）。<code v-pre>URLClassLoader</code>功能比较强大，它既可以从本地文件系统获取二进制文件来加载类，也可以从远程主机获取二进制文件来加载类。</p>
<p>实际上，在应用程序中可以直接使用<code v-pre>URLClassLoader</code>来加载类，<code v-pre>URLClassLoader</code>类提供了如下两个构造器。</p>
<ul>
<li><code v-pre>URLClassLoader(URL[] urls)</code>：使用默认的父类加载器创建一个<code v-pre>ClassLoader</code>对象，该对象将从<code v-pre>urls</code>所指定的系列路径来查询并加载类。</li>
<li><code v-pre>URLClassLoader(URL[] urls, ClassLoader parent)</code>：使用指定的父类加载器创建一个<code v-pre>ClassLoader</code>对象，其他功能与前一个构造器相同。</li>
</ul>
<p>一旦得到了<code v-pre>URLClassLoader</code>对象之后，就可以调用该对象的<code v-pre>loadClass()</code>方法来加载指定类。下面程序示范了如何直接从文件系统中加载<code v-pre>MySQL</code>驱动，并使用该驱动来获取数据库连接。通过这种方式来获取数据库连接，可以无须将<code v-pre>MySQL</code>驱动添加到<code v-pre>CLASSPATH</code>环境变量中。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">URLClassLoaderTest</span> <span class="token punctuation">{</span>
  ...
  <span class="token comment">// 定义一个获取数据库连接的方法</span>
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token class-name">Connection</span> <span class="token function">getConn</span><span class="token punctuation">(</span><span class="token class-name">String</span> url<span class="token punctuation">,</span>
    ...
    <span class="token keyword">if</span> <span class="token punctuation">(</span>conn <span class="token operator">==</span> <span class="token keyword">null</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
      <span class="token comment">// 创建一个URL数组</span>
      ...
      <span class="token comment">// 以默认的ClassLoader作为父ClassLoader，创建URLClassLoader</span>
      ...
      <span class="token comment">// 加载MySQL的JDBC驱动，并创建默认实例</span>
      ...
      <span class="token comment">// 创建一个设置JDBC连接属性的Properties对象</span>
      <span class="token class-name">Properties</span> props <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Properties</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
      <span class="token comment">// 至少需要为该对象传入user和password两个属性</span>
      ...
      <span class="token comment">// 调用Driver对象的connect方法来取得数据库连接</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当我们创建<code v-pre>URLClassLoader</code>时传入了一个 URL 数组参数，该<code v-pre>ClassLoader</code>就可以从这系列 URL 指定的资源中加载指定类，这里的<code v-pre>URL</code>可以以<code v-pre>file:</code>为前缀，表明从本地文件系统加载；可以以<code v-pre>http:</code>为前缀，表明从互联网通过<code v-pre>HTTP</code>访问来加载；也可以以<code v-pre>ftp:</code>为前缀，表明从互联网通过<code v-pre>FTP</code>访问来加载……功能非常强大。</p>
<h2 id="反射" tabindex="-1"><a class="header-anchor" href="#反射" aria-hidden="true">#</a> 反射</h2>
<p>什么是反射？</p>
<p>反射就是 Reflection，Java 的反射是指程序在运行期可以拿到一个对象的所有信息。</p>
<h3 id="class-类" tabindex="-1"><a class="header-anchor" href="#class-类" aria-hidden="true">#</a> Class 类</h3>
<p>除了<code v-pre>int</code>等基本类型外，Java 的其他类型全部都是<code v-pre>class</code>（包括<code v-pre>interface</code>）。例如：</p>
<ul>
...
<p><code v-pre>class</code>（包括<code v-pre>interface</code>）的本质是数据类型（<code v-pre>Type</code>）。无继承关系的数据类型无法赋值：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>而 <code v-pre>class</code> 是由 JVM 在执行过程中动态加载的。JVM 在第一次读取到一种 <code v-pre>class</code> 类型时，将其加载进内存。</p>
<p>每加载一种 <code v-pre>class</code>，JVM 就为其创建一个 <code v-pre>Class</code> 类型的实例，并关联起来。注意：这里的 <code v-pre>Class</code> 类型是一个名叫 <code v-pre>Class</code> 的 <code v-pre>class</code>。它长这样：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">final</span> <span class="token keyword">class</span> <span class="token class-name">Class</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>以 <code v-pre>String</code> 类为例，当 JVM 加载 <code v-pre>String</code> 类时，它首先读取 <code v-pre>String.class</code> 文件到内存，然后，为 <code v-pre>String</code> 类创建一个 <code v-pre>Class</code> 实例并关联起来：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这个 <code v-pre>Class</code> 实例是 JVM 内部创建的，查看 JDK 源码，可以发现 <code v-pre>Class</code> 类的构造方法是 <code v-pre>private</code>，只有 JVM 能创建 <code v-pre>Class</code> 实例，自己的 Java 程序是无法创建 <code v-pre>Class</code> 实例的。</p>
<p>所以，JVM 持有的每个 <code v-pre>Class</code> 实例都指向一个数据类型（<code v-pre>class</code> 或 <code v-pre>interface</code>）：</p>
...
└───────────────────────────┘
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>一个 <code v-pre>Class</code> 实例包含了该 <code v-pre>class</code> 的所有完整信息：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>┌───────────────────────────┐
│      Class Instance       │──────<span class="token operator">></span> String
├───────────────────────────┤
│name <span class="token operator">=</span> <span class="token string">"java.lang.String"</span>  │
├───────────────────────────┤
│package <span class="token operator">=</span> <span class="token string">"java.lang"</span>      │
├───────────────────────────┤
│super <span class="token operator">=</span> <span class="token string">"java.lang.Object"</span> │
├───────────────────────────┤
│interface <span class="token operator">=</span> CharSequence<span class="token punctuation">..</span>.│
├───────────────────────────┤
│field <span class="token operator">=</span> value<span class="token punctuation">[</span><span class="token punctuation">]</span>,hash,<span class="token punctuation">..</span>.   │
├───────────────────────────┤
│method <span class="token operator">=</span> indexOf<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">..</span>.      │
└───────────────────────────┘
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>由于 JVM 为每个加载的 <code v-pre>class</code> 创建了对应的 <code v-pre>Class</code> 实例，并在实例中保存了该 <code v-pre>class</code> 的所有信息，包括类名、包名、父类、实现的接口、所有方法、字段等，因此，如果获取了某个 <code v-pre>Class</code> 实例，就可以通过这个 <code v-pre>Class</code> 实例获取到该实例对应的 <code v-pre>class</code> 的所有信息。</p>
<p>这种通过 <code v-pre>Class</code> 实例获取 <code v-pre>class</code> 信息的方法称为反射（Reflection）。</p>
<p>有三个方法获可以取一个 <code v-pre>class</code> 的 <code v-pre>Class</code> 实例：</p>
<p>方法一：直接通过一个 <code v-pre>class</code> 的静态变量 <code v-pre>class</code> 获取：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>方法二：如果有一个实例变量，可以通过该实例变量提供的 <code v-pre>getClass()</code> 方法获取：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>方法三：如果知道一个 <code v-pre>class</code> 的完整类名，可以通过静态方法 <code v-pre>Class.forName()</code> 获取：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>因为 <code v-pre>Class</code> 实例在 JVM 中是唯一的，所以，上述方法获取的 <code v-pre>Class</code> 实例是同一个实例。可以用 <code v-pre>==</code> 比较两个 <code v-pre>Class</code> 实例：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Class</code> 实例比较和 <code v-pre>instanceof</code> 的差别：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>用 <code v-pre>instanceof</code> 不但匹配指定类型，还匹配指定类型的子类。而用 <code v-pre>==</code> 判断 <code v-pre>class</code> 实例可以精确地判断数据类型，但不能作子类型比较。</p>
<p>通常情况下，应该用 <code v-pre>instanceof</code> 判断数据类型，因为面向抽象编程的时候，不关心具体的子类型。只有在需要精确判断一个类型是不是某个 <code v-pre>class</code> 的时候，才使用 <code v-pre>==</code> 判断 <code v-pre>class</code> 实例。</p>
<p>因为反射的目的是为了获得某个实例的信息。因此，当拿到某个 <code v-pre>Object</code> 实例时，可以通过反射获取该 <code v-pre>Object</code> 的 <code v-pre>class</code> 信息：</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>从 <code v-pre>Class</code> 实例获取获取的基本信息：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>数组（例如 <code v-pre>String[]</code>）也是一种类，而且不同于 <code v-pre>String.class</code>，它的类名是 <code v-pre>[Ljava.lang.String;</code>。此外，JVM 为每一种基本类型如 <code v-pre>int</code> 也创建了 <code v-pre>Class</code> 实例，通过 <code v-pre>int.class</code> 访问。</p>
<p>如果获取到了一个 <code v-pre>Class</code> 实例，就可以通过该 <code v-pre>Class</code> 实例来创建对应类型的实例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 获取String的Class实例:</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述代码相当于 <code v-pre>new String()</code>。通过 <code v-pre>Class.newInstance()</code> 可以创建类实例，它的局限是：只能调用 <code v-pre>public</code> 的无参数构造方法。带参数的构造方法，或者非 <code v-pre>public</code> 的构造方法都无法通过 <code v-pre>Class.newInstance()</code> 被调用。</p>
<h4 id="动态加载" tabindex="-1"><a class="header-anchor" href="#动态加载" aria-hidden="true">#</a> 动态加载</h4>
<p>JVM 在执行 Java 程序的时候，并不是一次性把所有用到的 class 全部加载到内存，而是第一次需要用到 class 时才加载。例如：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当执行 <code v-pre>Main.java</code> 时，由于用到了 <code v-pre>Main</code>，因此，JVM 首先会把 <code v-pre>Main.class</code> 加载到内存。然而，并不会加载 <code v-pre>Person.class</code>，除非程序执行到 <code v-pre>create()</code> 方法，JVM 发现需要加载 <code v-pre>Person</code> 类时，才会首次加载 <code v-pre>Person.class</code>。如果没有执行 <code v-pre>create()</code> 方法，那么 <code v-pre>Person.class</code> 根本就不会被加载。</p>
<p>这就是 JVM 动态加载 <code v-pre>class</code> 的特性。</p>
<p>动态加载 <code v-pre>class</code> 的特性对于 Java 程序非常重要。利用 JVM 动态加载 <code v-pre>class</code> 的特性，才能在运行期根据条件加载不同的实现类。例如，Commons Logging 总是优先使用 Log4j，只有当 Log4j 不存在时，才使用 JDK 的 logging。利用 JVM 动态加载特性，大致的实现代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// Commons Logging优先使用Log4j:</span>
...
<span class="token keyword">boolean</span> <span class="token function">isClassPresent</span><span class="token punctuation">(</span><span class="token class-name">String</span> name<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>这就是为什么只需要把 Log4j 的 jar 包放到 <code v-pre>classpath</code> 中，Commons Logging 就会自动使用 Log4j 的原因。</p>
<h3 id="访问字段" tabindex="-1"><a class="header-anchor" href="#访问字段" aria-hidden="true">#</a> 访问字段</h3>
<p>对任意的一个 <code v-pre>Object</code> 实例，只要获取了它的 <code v-pre>Class</code>，就可以获取它的一切信息。</p>
<p>如何通过 <code v-pre>Class</code> 实例获取字段信息。<code v-pre>Class</code> 类提供了以下几个方法来获取字段：</p>
<ul>
<li><code v-pre>Field getField (name)</code>：根据字段名获取某个 <code v-pre>public</code> 的 <code v-pre>field</code>（包括父类）</li>
<li><code v-pre>Field getDeclaredField (name)</code>：根据字段名获取当前类的某个 <code v-pre>field</code>（不包括父类）</li>
<li><code v-pre>Field [] getFields ()</code>：获取所有 <code v-pre>public</code> 的 <code v-pre>field</code>（包括父类）</li>
<li><code v-pre>Field [] getDeclaredFields ()</code>：获取当前类的所有 <code v-pre>field</code>（不包括父类）</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述代码首先获取 <code v-pre>Student</code> 的 <code v-pre>Class</code> 实例，然后，分别获取 <code v-pre>public</code> 字段、继承的 <code v-pre>public</code> 字段以及 <code v-pre>private</code> 字段，打印出的 <code v-pre>Field</code> 类似：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">int</span> <span class="token class-name">Student</span><span class="token punctuation">.</span>score
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>一个 <code v-pre>Field</code> 对象包含了一个字段的所有信息：</p>
<ul>
<li><code v-pre>getName()</code>：返回字段名称，例如，<code v-pre>&quot;name&quot;</code>；</li>
<li><code v-pre>getType()</code>：返回字段类型，也是一个 <code v-pre>Class</code> 实例，例如，<code v-pre>String.class</code>；</li>
<li><code v-pre>getModifiers()</code>：返回字段的修饰符，它是一个 <code v-pre>int</code>，不同的 bit 表示不同的含义。</li>
</ul>
<p>以 <code v-pre>String</code> 类的 <code v-pre>value</code> 字段为例，它的定义是：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">final</span> <span class="token keyword">class</span> <span class="token class-name">String</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>用反射获取该字段的信息，代码如下：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="获取字段值" tabindex="-1"><a class="header-anchor" href="#获取字段值" aria-hidden="true">#</a> 获取字段值</h4>
<p>利用反射拿到字段的一个 <code v-pre>Field</code> 实例只是第一步，还可以拿到一个实例对应的该字段的值。</p>
<p>例如，对于一个 <code v-pre>Person</code> 实例，可以先拿到 <code v-pre>name</code> 字段对应的 <code v-pre>Field</code>，再获取这个实例的 <code v-pre>name</code> 字段的值：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述代码先获取 <code v-pre>Class</code> 实例，再获取 <code v-pre>Field</code> 实例，然后，用 <code v-pre>Field.get(Object)</code> 获取指定实例的指定字段的值。</p>
<p>运行代码，如果不出意外，会得到一个 <code v-pre>IllegalAccessException</code>，这是因为 <code v-pre>name</code> 被定义为一个 <code v-pre>private</code> 字段，正常情况下，<code v-pre>Main</code> 类无法访问 <code v-pre>Person</code> 类的 <code v-pre>private</code> 字段。要修复错误，可以将 <code v-pre>private</code> 改为 <code v-pre>public</code>，或者，在调用 <code v-pre>Object value = f.get(p);</code> 前，先写一句：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>f<span class="token punctuation">.</span><span class="token function">setAccessible</span><span class="token punctuation">(</span><span class="token boolean">true</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>调用 <code v-pre>Field.setAccessible(true)</code> 的意思是，别管这个字段是不是 <code v-pre>public</code>，一律允许访问。</p>
<p>加上上述语句，再运行代码，就可以打印出 <code v-pre>private</code> 字段的值。</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>如果使用反射可以获取 <code v-pre>private</code> 字段的值，那么类的封装还有什么意义？</p>
<p>答案是正常情况下，我们总是通过 <code v-pre>p.name</code> 来访问 <code v-pre>Person</code> 的 <code v-pre>name</code> 字段，编译器会根据 <code v-pre>public</code>、<code v-pre>protected</code> 和 <code v-pre>private</code> 决定是否允许访问字段，这样就达到了数据封装的目的。</p>
<p>而反射是一种非常规的用法，使用反射，首先代码非常繁琐，其次，它更多地是给工具或者底层框架来使用，目的是在不知道目标实例任何信息的情况下，获取特定字段的值。</p>
<p>此外，<code v-pre>setAccessible(true)</code> 可能会失败。如果 JVM 运行期存在 <code v-pre>SecurityManager</code>，那么它会根据规则进行检查，有可能阻止<code v-pre>setAccessible(true)</code>。例如，某个 <code v-pre>SecurityManager</code> 可能不允许对 <code v-pre>java</code> 和 <code v-pre>javax</code> 开头的 <code v-pre>package</code> 的类调用<code v-pre>setAccessible(true)</code>，这样可以保证 JVM 核心库的安全。</p>
</div>
<h4 id="设置字段值" tabindex="-1"><a class="header-anchor" href="#设置字段值" aria-hidden="true">#</a> 设置字段值</h4>
<p>通过 Field 实例既然可以获取到指定实例的字段值，自然也可以设置字段的值。</p>
<p>设置字段值是通过 <code v-pre>Field.set(Object, Object)</code> 实现的，其中第一个 <code v-pre>Object</code> 参数是指定的实例，第二个 <code v-pre>Object</code> 参数是待修改的值。示例代码如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
...
<span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>打印的 <code v-pre>name</code> 字段从 <code v-pre>Xiao Ming</code> 变成了 <code v-pre>Xiao Hong</code>，说明通过反射可以直接修改字段的值。</p>
<p>同样的，修改非 <code v-pre>public</code> 字段，需要首先调用 <code v-pre>setAccessible(true)</code>。</p>
<h3 id="调用方法" tabindex="-1"><a class="header-anchor" href="#调用方法" aria-hidden="true">#</a> 调用方法</h3>
<p>能通过 <code v-pre>Class</code> 实例获取所有 <code v-pre>Field</code> 对象，同样的，可以通过 <code v-pre>Class</code> 实例获取所有 <code v-pre>Method</code> 信息。</p>
<p><code v-pre>Class</code> 类提供了以下几个方法来获取 <code v-pre>Method</code>：</p>
<ul>
<li><code v-pre>Method getMethod(name, Class...)</code>：获取某个 <code v-pre>public</code> 的 <code v-pre>Method</code>（包括父类）</li>
<li><code v-pre>Method getDeclaredMethod(name, Class...)</code>：获取当前类的某个 <code v-pre>Method</code>（不包括父类）</li>
<li><code v-pre>Method[] getMethods()</code>：获取所有 <code v-pre>public</code> 的 <code v-pre>Method</code>（包括父类）</li>
<li><code v-pre>Method[] getDeclaredMethods()</code>：获取当前类的所有 <code v-pre>Method</code>（不包括父类）</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
        <span class="token class-name">Class</span> stdClass <span class="token operator">=</span> <span class="token class-name">Student</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上述代码首先获取 <code v-pre>Student</code> 的 <code v-pre>Class</code> 实例，然后，分别获取 <code v-pre>public</code> 方法、继承的 <code v-pre>public</code> 方法以及 <code v-pre>private</code> 方法，打印出的 <code v-pre>Method</code> 类似：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>一个 <code v-pre>Method</code> 对象包含一个方法的所有信息：</p>
<ul>
<li><code v-pre>getName()</code>：返回方法名称，例如：<code v-pre>&quot;getScore&quot;</code>；</li>
<li><code v-pre>getReturnType()</code>：返回方法返回值类型，也是一个 Class 实例，例如：<code v-pre>String.class</code>；</li>
<li><code v-pre>getParameterTypes()</code>：返回方法的参数类型，是一个 Class 数组，例如：<code v-pre>{String.class, int.class}</code>；</li>
<li><code v-pre>getModifiers()</code>：返回方法的修饰符，它是一个 <code v-pre>int</code>，不同的 bit 表示不同的含义。</li>
</ul>
<h4 id="调用普通方法" tabindex="-1"><a class="header-anchor" href="#调用普通方法" aria-hidden="true">#</a> 调用普通方法</h4>
<p>当我们获取到一个 <code v-pre>Method</code> 对象时，就可以对它进行调用。我们以下面的代码为例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s <span class="token operator">=</span> <span class="token string">"Hello world"</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>如果用反射来调用 <code v-pre>substring</code> 方法，需要以下代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意到 <code v-pre>substring()</code> 有两个重载方法，需要获取的是 <code v-pre>String substring(int)</code> 这个方法。</p>
<p>对 <code v-pre>Method</code> 实例调用 <code v-pre>invoke</code> 就相当于调用该方法，<code v-pre>invoke</code> 的第一个参数是对象实例，即在哪个实例上调用该方法，后面的可变参数要与方法参数一致，否则将报错。</p>
<h4 id="调用静态方法" tabindex="-1"><a class="header-anchor" href="#调用静态方法" aria-hidden="true">#</a> 调用静态方法</h4>
<p>如果获取到的 Method 表示一个静态方法，调用静态方法时，由于无需指定实例对象，所以 <code v-pre>invoke</code> 方法传入的第一个参数永远为 <code v-pre>null</code>。以 <code v-pre>Integer.parseInt(String)</code> 为例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="调用非-public-方法" tabindex="-1"><a class="header-anchor" href="#调用非-public-方法" aria-hidden="true">#</a> 调用非 public 方法</h4>
<p>和 <code v-pre>Field</code> 类似，对于非 <code v-pre>public</code> 方法，虽然可以通过 <code v-pre>Class.getDeclaredMethod()</code> 获取该方法实例，但直接对其调用将得到一个 <code v-pre>IllegalAccessException</code>。为了调用非 <code v-pre>public</code> 方法，通过 <code v-pre>Method.setAccessible(true)</code> 允许其调用：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>此外，<code v-pre>setAccessible(true)</code> 可能会失败。如果 JVM 运行期存在 <code v-pre>SecurityManager</code>，那么它会根据规则进行检查，有可能阻止 <code v-pre>setAccessible(true)</code>。例如，某个 <code v-pre>SecurityManager</code> 可能不允许对 <code v-pre>java</code> 和 <code v-pre>javax</code> 开头的 <code v-pre>package</code> 的类调用 <code v-pre>setAccessible(true)</code>，这样可以保证 JVM 核心库的安全。</p>
<h4 id="多态" tabindex="-1"><a class="header-anchor" href="#多态" aria-hidden="true">#</a> 多态</h4>
<p>考察这样一种情况：一个 <code v-pre>Person</code> 类定义了 <code v-pre>hello()</code> 方法，并且它的子类 <code v-pre>Student</code> 也覆写了 <code v-pre>hello()</code> 方法，那么，从 <code v-pre>Person.class</code> 获取的 <code v-pre>Method</code>，作用于 <code v-pre>Student</code> 实例时，调用的方法到底是哪个？</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>打印出的是 <code v-pre>Student:hello</code>，因此，使用反射调用方法时，仍然遵循多态原则：即总是调用实际类型的覆写方法（如果存在）。上述的反射代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Method</span> m <span class="token operator">=</span> <span class="token class-name">Person</span><span class="token punctuation">.</span><span class="token keyword">class</span><span class="token punctuation">.</span><span class="token function">getMethod</span><span class="token punctuation">(</span><span class="token string">"hello"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="调用构造方法" tabindex="-1"><a class="header-anchor" href="#调用构造方法" aria-hidden="true">#</a> 调用构造方法</h3>
<p>通常使用 <code v-pre>new</code> 操作符创建新的实例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Person</span> p <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Person</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>如果通过反射来创建新的实例，可以调用 Class 提供的 <code v-pre>newInstance()</code> 方法：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>调用 <code v-pre>Class.newInstance()</code> 的局限是，它只能调用该类的 <code v-pre>public</code> 无参数构造方法。如果构造方法带有参数，或者不是 <code v-pre>public</code>，就无法直接通过 <code v-pre>Class.newInstance()</code> 来调用。</p>
<p>为了调用任意的构造方法，Java 的反射 API 提供了 <code v-pre>Constructor</code> 对象，它包含一个构造方法的所有信息，可以创建一个实例。<code v-pre>Constructor</code> 对象和 <code v-pre>Method</code> 非常类似，不同之处仅在于它是一个构造方法，并且，调用结果总是返回实例：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过 Class 实例获取 Constructor 的方法如下：</p>
<ul>
<li><code v-pre>getConstructor(Class...)</code>：获取某个 <code v-pre>public</code> 的 <code v-pre>Constructor</code>；</li>
<li><code v-pre>getDeclaredConstructor(Class...)</code>：获取某个 <code v-pre>Constructor</code>；</li>
<li><code v-pre>getConstructors()</code>：获取所有 <code v-pre>public</code> 的 <code v-pre>Constructor</code>；</li>
<li><code v-pre>getDeclaredConstructors()</code>：获取所有 <code v-pre>Constructor</code>。</li>
</ul>
<p>注意 <code v-pre>Constructor</code> 总是当前类定义的构造方法，和父类无关，因此不存在多态的问题。</p>
<p>调用非 <code v-pre>public</code> 的 <code v-pre>Constructor</code> 时，必须首先通过 <code v-pre>setAccessible(true)</code> 设置允许访问。<code v-pre>setAccessible(true)</code> 可能会失败。</p>
<h3 id="获取继承关系" tabindex="-1"><a class="header-anchor" href="#获取继承关系" aria-hidden="true">#</a> 获取继承关系</h3>
<p>当获取到某个 <code v-pre>Class</code> 对象时，实际上就获取到了一个类的类型：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>还可以用实例的 <code v-pre>getClass()</code> 方法获取：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">String</span> s <span class="token operator">=</span> <span class="token string">""</span><span class="token punctuation">;</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>最后一种获取 <code v-pre>Class</code> 的方法是通过 <code v-pre>Class.forName(&quot;&quot;)</code>，传入 <code v-pre>Class</code> 的完整类名获取：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">Class</span> s <span class="token operator">=</span> <span class="token class-name">Class</span><span class="token punctuation">.</span><span class="token function">forName</span><span class="token punctuation">(</span><span class="token string">"java.lang.String"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>这三种方式获取的 <code v-pre>Class</code> 实例都是同一个实例，因为 JVM 对每个加载的 <code v-pre>Class</code> 只创建一个 <code v-pre>Class</code> 实例来表示它的类型。</p>
<h3 id="获取父类的-class" tabindex="-1"><a class="header-anchor" href="#获取父类的-class" aria-hidden="true">#</a> 获取父类的 Class</h3>
<p>有了 <code v-pre>Class</code> 实例，还可以获取它的父类的 <code v-pre>Class</code>：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行上述代码，可以看到，<code v-pre>Integer</code> 的父类类型是 <code v-pre>Number</code>，<code v-pre>Number</code> 的父类是 <code v-pre>Object</code>，<code v-pre>Object</code> 的父类是 <code v-pre>null</code>。除 <code v-pre>Object</code> 外，其他任何非 <code v-pre>interface</code> 的 <code v-pre>Class</code> 都必定存在一个父类类型。</p>
<h4 id="获取-interface" tabindex="-1"><a class="header-anchor" href="#获取-interface" aria-hidden="true">#</a> 获取 interface</h4>
<p>由于一个类可能实现一个或多个接口，通过 <code v-pre>Class</code> 就可以查询到实现的接口类型。例如，查询 <code v-pre>Integer</code> 实现的接口：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>运行上述代码可知，<code v-pre>Integer</code> 实现的接口有：</p>
<ul>
<li><code v-pre>java.lang.Comparable</code></li>
<li><code v-pre>java.lang.constant.Constable</code></li>
<li><code v-pre>java.lang.constant.ConstantDesc</code></li>
</ul>
<p>要特别注意：<code v-pre>getInterfaces()</code> 只返回当前类直接实现的接口类型，并不包括其父类实现的接口类型：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token keyword">throws</span> <span class="token class-name">Exception</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>Integer</code> 的父类是 <code v-pre>Number</code>，<code v-pre>Number</code> 实现的接口是 <code v-pre>java.io.Serializable</code>。</p>
<p>此外，对所有 <code v-pre>interface</code> 的 <code v-pre>Class</code> 调用 <code v-pre>getSuperclass()</code> 返回的是 <code v-pre>null</code>，获取接口的父接口要用 <code v-pre>getInterfaces()</code>：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code> <span class="token comment">// java.io.FilterInputStream，因为DataInputStream继承自FilterInputStream</span>
...
<span class="token comment">// null，对接口调用getSuperclass()总是返回null，获取接口的父接口要用getInterfaces()</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果一个类没有实现任何 <code v-pre>interface</code>，那么 <code v-pre>getInterfaces()</code> 返回空数组。</p>
<h4 id="继承关系" tabindex="-1"><a class="header-anchor" href="#继承关系" aria-hidden="true">#</a> 继承关系</h4>
<p>当我们判断一个实例是否是某个类型时，正常情况下，使用 <code v-pre>instanceof</code> 操作符：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>如果是两个 <code v-pre>Class</code> 实例，要判断一个向上转型是否成立，可以调用 <code v-pre>isAssignableFrom()</code>：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// Integer i = ?</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="动态代理" tabindex="-1"><a class="header-anchor" href="#动态代理" aria-hidden="true">#</a> 动态代理</h3>
<p>比较 Java 的 <code v-pre>class</code> 和 <code v-pre>interface</code> 的区别：</p>
<ul>
<li>可以实例化 <code v-pre>class</code>（非 <code v-pre>abstract</code>）；</li>
<li>不能实例化 <code v-pre>interface</code>。</li>
</ul>
<p>所有 <code v-pre>interface</code> 类型的变量总是通过某个实例向上转型并赋值给接口类型变量的：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token class-name">CharSequence</span> cs <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">StringBuilder</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>有没有可能不编写实现类，直接在运行期创建某个 <code v-pre>interface</code> 的实例呢？</p>
<p>这是可能的，因为 Java 标准库提供了一种动态代理（Dynamic Proxy）的机制：可以在运行期动态创建某个 <code v-pre>interface</code> 的实例。</p>
<p>什么叫运行期动态创建？听起来好像很复杂。所谓动态代理，是和静态相对应的。来看静态代码怎么写：</p>
<p>定义接口：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">Hello</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>编写实现类：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HelloWorld</span> <span class="token keyword">implements</span> <span class="token class-name">Hello</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>创建实例，转型为接口并调用：</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>这种方式就是通常编写代码的方式。</p>
<p>还有一种方式是动态代码，我们仍然先定义了接口 <code v-pre>Hello</code>，但是我们并不去编写实现类，而是直接通过 JDK 提供的一个 <code v-pre>Proxy.newProxyInstance()</code> 创建了一个 <code v-pre>Hello</code> 接口对象。这种没有实现类但是在运行期动态创建了一个接口对象的方式，称为动态代码。JDK 提供的动态创建接口对象的方式，就叫动态代理。</p>
<p>一个最简单的动态代理实现如下：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
    <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<span class="token keyword">interface</span> <span class="token class-name">Hello</span> <span class="token punctuation">{</span>
    <span class="token keyword">void</span> <span class="token function">morning</span><span class="token punctuation">(</span><span class="token class-name">String</span> name<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在运行期动态创建一个 <code v-pre>interface</code> 实例的方法如下：</p>
<ol>
<li>定义一个 <code v-pre>InvocationHandler</code> 实例，它负责实现接口的方法调用；</li>
<li>通过<code v-pre>Proxy.newProxyInstance()</code>创建<code v-pre>interface</code>实例，它需要 3 个参数：
<ul>
<li>使用的 <code v-pre>ClassLoader</code>，通常就是接口类的 <code v-pre>ClassLoader</code>；</li>
<li>需要实现的接口数组，至少需要传入一个接口进去；</li>
<li>用来处理接口方法调用的 <code v-pre>InvocationHandler</code> 实例。</li>
</ul>
</li>
<li>将返回的 <code v-pre>Object</code> 强制转型为接口。</li>
</ol>
<p>动态代理实际上是 JVM 在运行期动态创建 class 字节码并加载的过程，把上面的动态代理改写为静态实现类大概长这样：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">HelloDynamicProxy</span> <span class="token keyword">implements</span> <span class="token class-name">Hello</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其实就是 JVM 帮我们自动编写了一个上述类（不需要源码，可以直接生成字节码）。</p>
<p>好玩的。</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">interface</span> <span class="token class-name">Student</span> <span class="token punctuation">{</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">DynamicProxy</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">static</span> <span class="token keyword">void</span> <span class="token function">main</span><span class="token punctuation">(</span><span class="token class-name">String</span><span class="token punctuation">[</span><span class="token punctuation">]</span> args<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token comment">// 小韭菜学生类</span>
 ...
 */</span>
    ...
    <span class="token class-name">InvocationHandler</span> handler <span class="token operator">=</span> <span class="token punctuation">(</span>proxy<span class="token punctuation">,</span> method<span class="token punctuation">,</span> handlerArgs<span class="token punctuation">)</span> <span class="token operator">-></span> <span class="token punctuation">{</span>
      <span class="token comment">// 从定义eat方法。</span>
      <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token string">"eat"</span><span class="token punctuation">.</span><span class="token function">equals</span><span class="token punctuation">(</span>method<span class="token punctuation">.</span><span class="token function">getName</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"我可以吃香喝辣！"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token keyword">return</span> <span class="token keyword">null</span><span class="token punctuation">;</span>
      <span class="token punctuation">}</span>
      <span class="token comment">// 从定义write方法。</span>
      <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token string">"write"</span><span class="token punctuation">.</span><span class="token function">equals</span><span class="token punctuation">(</span>method<span class="token punctuation">.</span><span class="token function">getName</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"我的作文题目是《我的区长父亲》。"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token comment">// 调用普通学生类的write方法，流程还是要走的，还是要交一篇作文上去，不能太明目张胆。</span>
        ...
        <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"我的作文拿了区作文竞赛一等奖！so easy!"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
        <span class="token keyword">return</span> <span class="token keyword">null</span><span class="token punctuation">;</span>
      <span class="token punctuation">}</span>
      <span class="token keyword">return</span> <span class="token keyword">null</span><span class="token punctuation">;</span>
    <span class="token punctuation">}</span><span class="token punctuation">;</span>
...
<span class="token keyword">class</span> <span class="token class-name">OrdinaryStudents</span> <span class="token keyword">implements</span> <span class="token class-name">Student</span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">run</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"我在跑步！"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
  ...
  <span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">write</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"我在写作文!"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
