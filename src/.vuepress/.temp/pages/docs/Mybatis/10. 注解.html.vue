<template><div><h1 id="_10-注解" tabindex="-1"><a class="header-anchor" href="#_10-注解" aria-hidden="true">#</a> 10. 注解</h1>
<p>本质:反射机制实现</p>
<p>底层:动态代理</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271712417.png" alt="注解"></p>
<h2 id="mybatis-详细执行流程" tabindex="-1"><a class="header-anchor" href="#mybatis-详细执行流程" aria-hidden="true">#</a> Mybatis 详细执行流程</h2>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271712051.png" alt="注解2"></p>
<h2 id="注解-crud" tabindex="-1"><a class="header-anchor" href="#注解-crud" aria-hidden="true">#</a> 注解 CRUD</h2>
...
<ul>
<li>基本数据类型和 String 类型需要加上</li>
<li>引用数据类型不用加</li>
<li>如果只有一个基本类型, 可以忽略,建议加上</li>
<li>我们在 SQL 中引用的就是@param(&quot;id&quot;)中设定的属性名, 可以使用该注解为字段取别名</li>
</ul>
</div></template>
