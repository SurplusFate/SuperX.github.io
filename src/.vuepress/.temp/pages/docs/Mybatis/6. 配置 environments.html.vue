<template><div><h1 id="_6-配置-environments" tabindex="-1"><a class="header-anchor" href="#_6-配置-environments" aria-hidden="true">#</a> 6. 配置 environments</h1>
<p>Mybatis 可以配置成适应多种环境</p>
<p><strong>但是每个 SqlSessionFactory 实例只能选择一种环境:</strong></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_1-属性-properties" tabindex="-1"><a class="header-anchor" href="#_1-属性-properties" aria-hidden="true">#</a> 1. 属性（properties）</h2>
<p>这些属性可以在外部进行配置，并可以进行动态替换。你既可以在典型的 Java 属性文件中配置这些属性.
该属性必须在配置文件的第一行
<img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271710643.png" alt="属性">
也可以直接在 properties 元素的子元素中配置属性 <strong>外部文件优先级更高</strong></p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code>&lt;properties>
...
&lt;/properties>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_2-类型别名-typealiases" tabindex="-1"><a class="header-anchor" href="#_2-类型别名-typealiases" aria-hidden="true">#</a> 2. 类型别名（typeAliases）</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>当这样配置时，<code v-pre>Blog</code> 可以用在任何使用 <code v-pre>domain.blog.Blog</code> 的地方。</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>typeAliases</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>每一个在包 <code v-pre>domain.blog</code> 中的 Java Bean，<strong>在没有注解的情况下，会使用 Bean 的首字母小写的非限定类名来作为它的别名</strong>。 比如 <code v-pre>domain.blog.Author</code> 的别名为 <code v-pre>author</code>；若有注解，则别名为其注解值。见下面的例子：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Alias</span><span class="token punctuation">(</span><span class="token string">"author"</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3-设置-settings" tabindex="-1"><a class="header-anchor" href="#_3-设置-settings" aria-hidden="true">#</a> 3.设置（settings）</h2>
<p>这是 MyBatis 中极为重要的调整设置，它们会改变 MyBatis 运行时的行为。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271711429.png" alt="设置"></p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271711011.png" alt="设置2"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_4-其他设置" tabindex="-1"><a class="header-anchor" href="#_4-其他设置" aria-hidden="true">#</a> 4.其他设置</h2>
<p>类型处理器（typeHandlers）</p>
<p>对象工厂（objectFactory）</p>
<p>插件（plugins）</p>
<ol>
...
<h2 id="_5-映射器-mappers" tabindex="-1"><a class="header-anchor" href="#_5-映射器-mappers" aria-hidden="true">#</a> 5.映射器（mappers）</h2>
<p>MapperRegistry: 注册绑定 mapper 文件</p>
<p>方式一:</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- 使用相对于类路径的资源引用 --></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>mappers</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>方式二:使用 class 文件进行绑定注册</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- 使用映射器接口实现类的完全限定类名 --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>mappers</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>mappers</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>注意点:</strong></p>
<ul>
<li>接口和他的 mapper 配置文件必须同名</li>
<li>接口和他的 mapper 配置文件必须在同一个包下</li>
</ul>
<p>方式三:使用扫描包进行注入绑定</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!-- 将包内的映射器接口实现全部注册为映射器 --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>mappers</span><span class="token punctuation">></span></span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>mappers</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>注意点:</strong></p>
<ul>
<li>接口和他的 mapper 配置文件必须同名</li>
<li>接口和他的 mapper 配置文件必须在同一个包下</li>
</ul>
<h2 id="作用域-scope-和生命周期" tabindex="-1"><a class="header-anchor" href="#作用域-scope-和生命周期" aria-hidden="true">#</a> 作用域（Scope）和生命周期</h2>
<p>生命周期和作用域是至关重要的，因为错误的使用会导致非常严重的<strong>并发问题</strong></p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271711171.png" alt="作用域">
<strong>SqlSessionFactoryBuilder</strong></p>
<p>一旦创建了 SqlSessionFactoryBuilder 后,就不在需要了</p>
<p>可定义为局部变量</p>
<p><strong>SqlSessionFactory:</strong></p>
<p>可以想象为数据库连接池</p>
<p>一旦创建就应该在运行期间一直存在,<strong>没有任何理由去丢弃它后重新创建另一个实例</strong></p>
<p>因此 SqlSessionfactory 的最佳作用域是应用作用域</p>
<p>最简单的就死使用<strong>单例模式</strong>或者静态单例模式</p>
<p><strong>SqlSession:</strong></p>
<p>连接池的一个请求</p>
<p>用完之后需要感赶紧关闭,否则资源被占用</p>
</div></template>
