<template><div><h1 id="_7-resultmap-结果集映射" tabindex="-1"><a class="header-anchor" href="#_7-resultmap-结果集映射" aria-hidden="true">#</a> 7. ResultMap 结果集映射</h1>
<p>当 bean 属性名与数据库字段名不一致时</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271711674.png" alt="ResultMap">
会导致结果集映射不到</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271711121.png" alt="ResultMap2"></p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> <span class="token operator">*</span> <span class="token keyword">from</span> mybatis<span class="token punctuation">.</span>userwhere id <span class="token operator">=</span> <span class="token comment">#{id};</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>解决方法:</p>
<ul>
<li>起别名</li>
</ul>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">select</span> id<span class="token punctuation">,</span> name<span class="token punctuation">,</span> pwd <span class="token keyword">as</span> password <span class="token keyword">from</span> mybatis<span class="token punctuation">.</span>userwhere id <span class="token operator">=</span> <span class="token comment">#{id};</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>resultMap</code> 元素是 MyBatis 中最重要最强大的元素。</p>
