<template><div><h1 id="_8-日志" tabindex="-1"><a class="header-anchor" href="#_8-日志" aria-hidden="true">#</a> 8. 日志</h1>
<h2 id="_1-日志工厂" tabindex="-1"><a class="header-anchor" href="#_1-日志工厂" aria-hidden="true">#</a> 1. 日志工厂</h2>
<p>SLF4J</p>
<p>LOG4J(掌握)</p>
<p>LOG4J2</p>
<p>JDK_LOGGING</p>
...
<p>NO_LOGGING</p>
<h3 id="stdout-logging" tabindex="-1"><a class="header-anchor" href="#stdout-logging" aria-hidden="true">#</a> STDOUT_LOGGING</h3>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208271712929.png" alt="Log"></p>
<h3 id="log4j" tabindex="-1"><a class="header-anchor" href="#log4j" aria-hidden="true">#</a> LOG4J</h3>
<ul>
<li>Log4j 是<a href="https://baike.baidu.com/item/Apache/8512995" target="_blank" rel="noopener noreferrer">Apache<ExternalLinkIcon/></a>的一个开源项目，通过使用 Log4j，我们可以控制日志信息输送的目的地是<a href="https://baike.baidu.com/item/%E6%8E%A7%E5%88%B6%E5%8F%B0/2438626" target="_blank" rel="noopener noreferrer">控制台<ExternalLinkIcon/></a>、文件、<a href="https://baike.baidu.com/item/GUI" target="_blank" rel="noopener noreferrer">GUI<ExternalLinkIcon/></a>组件</li>
<li>我们可以控制每一条日志的输出格式</li>
<li>通过定义每一条信息的级别,我们能够更加细致的控制日志的生成过程</li>
...
<li>
<p>log4j.properties, 名字必须是 log4j</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">log4j.rootLogger</span><span class="token punctuation">=</span><span class="token value attr-value">DEBUG,console,file</span>
...
<li>
<p>导包</p>
<p><code v-pre>import org.apache.log4j.Logger;</code></p>
</li>
<li>
<p>获取日志对象</p>
<p><code v-pre>Logger logger = Logger.getLogger(MybatisTest.class);</code></p>
</li>
<li>
<p>设置日志级别</p>
<p><code v-pre>logger.info(&quot;info&quot;);</code></p>
<p><code v-pre>logger.debug(&quot;debug&quot;);</code></p>
<p><code v-pre>logger.error(&quot;error&quot;);</code></p>
</li>
</ul>
</li>
</ol>
