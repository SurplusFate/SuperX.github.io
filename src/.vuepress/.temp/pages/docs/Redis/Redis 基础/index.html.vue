<template><div><h1 id="安装-redis" tabindex="-1"><a class="header-anchor" href="#安装-redis" aria-hidden="true">#</a> 安装 Redis</h1>
<p>大多数企业都是基于 Linux 服务器来部署项目，而且 Redis 官方也没有提供 Windows 版本的安装包。</p>
<p>此处选择的 Linux 版本为 CentOS 7.</p>
<h2 id="依赖库" tabindex="-1"><a class="header-anchor" href="#依赖库" aria-hidden="true">#</a> 依赖库</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="下载并解压" tabindex="-1"><a class="header-anchor" href="#下载并解压" aria-hidden="true">#</a> 下载并解压</h2>
<p>Redis 的官方网站地址：https: /redis.io/</p>
<p>解压命令</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">tar</span> <span class="token parameter variable">-zxvf</span> redis-6.2.6.tar.gz
...
<blockquote>
<p>redis-cli：是 redis 提供的命令行客户端</p>
<p>redis-server：是 redis 的服务端启动脚本</p>
<p>redis-sentinel：是 redis 的哨兵启动脚本</p>
</blockquote>
<p>指定安装目录</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token function">make</span> <span class="token function">install</span> <span class="token assign-left variable">PREFIX</span><span class="token operator">=</span>/usr/local/redis
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="启动-redis-服务" tabindex="-1"><a class="header-anchor" href="#启动-redis-服务" aria-hidden="true">#</a> 启动 redis 服务</h2>
<h3 id="直接启动-了解" tabindex="-1"><a class="header-anchor" href="#直接启动-了解" aria-hidden="true">#</a> 直接启动(了解)</h3>
...
./redis-server
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="通过守护进程方式启动" tabindex="-1"><a class="header-anchor" href="#通过守护进程方式启动" aria-hidden="true">#</a> 通过守护进程方式启动</h3>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 第一步：从 redis 的源码目录中复制 redis.conf 到 redis 的安装目录</span>
...
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 允许访问的地址，默认是127.0.0.1，会导致只能在本地访问。</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>其他配置</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 监听的端口</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="开机自启" tabindex="-1"><a class="header-anchor" href="#开机自启" aria-hidden="true">#</a> 开机自启</h2>
<p>切换到 /lib/systemd/system/ 目录，创建 redis.service 文件。命令如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token builtin class-name">cd</span> /lib/systemd/system/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>设置开启自动启动:</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 开机自动启动</span>
...
<h3 id="redis-命令行客户端" tabindex="-1"><a class="header-anchor" href="#redis-命令行客户端" aria-hidden="true">#</a> Redis 命令行客户端</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>其中常见的 options 有：</p>
<p><code v-pre>-h 127.0.0.1</code>：指定要连接的 redis 节点的 IP 地址，默认是 127.0.0.1</p>
<p><code v-pre>-p 6379</code>：指定要连接的 redis 节点的端口，默认是 6379</p>
<p><code v-pre>-a 123321</code>：指定 redis 的访问密码</p>
<p>其中的 commonds 就是 Redis 的操作命令，例如：</p>
<p><code v-pre>ping</code>：与 redis 服务端做心跳测试，服务端正常会返回 <code v-pre>pong</code> 不指定 commond 时，会进入 <code v-pre>redis-cli</code> 的交互控制台.</p>
<h3 id="图形化桌面客户端" tabindex="-1"><a class="header-anchor" href="#图形化桌面客户端" aria-hidden="true">#</a> .图形化桌面客户端</h3>
<p><a href="https://github.com/uglide/RedisDesktopManager/releases/tag/2022.5" target="_blank" rel="noopener noreferrer">RedisDesktopManager<ExternalLinkIcon/></a></p>
<p>Redis 默认有 16 个仓库，编号从 0 至 15. 通过配置文件可以设置仓库数量，但是不超过 16，并且不能自定义仓库名称。 如果是基于 redis-cli 连接 Redis 服务，可以通过 select 命令来选择数据库：</p>
