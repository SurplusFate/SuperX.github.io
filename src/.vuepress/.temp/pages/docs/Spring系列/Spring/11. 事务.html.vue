<template><div><h1 id="_11-事务" tabindex="-1"><a class="header-anchor" href="#_11-事务" aria-hidden="true">#</a> 11. 事务</h1>
<h2 id="_1-事务回顾" tabindex="-1"><a class="header-anchor" href="#_1-事务回顾" aria-hidden="true">#</a> 1. 事务回顾</h2>
<ol>
<li>
<p>什么是事务</p>
<ol>
<li>讲 mysql 的时候,提出了事务 事务是指一组 sql 语句的集合</li>
<li>集合中有多条 sql 语句可能是 insert , update ,select ,delete</li>
<li><strong>我们希望这些多个 sql 语句都能成功, 或者都失败</strong>, 这些 sql 语句的执行是一致的,作为一个整体执行</li>
</ol>
</li>
<li>
<p>在什么时候想到使用事务</p>
<ol>
<li><strong>当我的操作,涉及得到多个表,或者是多个 sql 语句的 insert,update,delete</strong></li>
<li>需要保证这些语句都是成功才能完成我的功能,或者都失败,保证操作是符合要求的</li>
<li>在 java 代码中写程序,控制事务,此时事务应该放在那里呢？</li>
</ol>
<ul>
<li>service 类的业务方法上,因为业务方法会调用多个 dao 方法,执行多个 sql 语句</li>
</ul>
</li>
<li>
<p>通常使用 JDBC 访问数据库, 还是 mybatis 访问数据库怎么处理事务?</p>
<ol>
<li>jdbc 访问数据库,处理事务, <code v-pre>Connection conn ; conn.commit(); conn.rollback();</code></li>
<li>mybatis 访问数据库,处理事务, <code v-pre>SqlSession.commit(); SqlSession.rollback();</code></li>
<li>hibernate 访问数据库,处理事务, <code v-pre>Session.commit(); Session.rollback();</code></li>
</ol>
</li>
<li>
<p>3 问题中事务的处理方式,有什么不足</p>
<ol>
<li>不同的数据库访问技术,处理事务的对象,方法不同</li>
<li>需要了解不同数据库访问技术使用事务的原理</li>
<li>掌握多种数据库中事务的处理逻辑什么时候提交事务,什么时候回顾事务, 处理事务的多种方法</li>
<li>总结: 就是多种数据库的访问技术,有不同的事务处理的机制,对象,方法</li>
</ol>
</li>
</ol>
<h2 id="_2-spring-中的事务管理" tabindex="-1"><a class="header-anchor" href="#_2-spring-中的事务管理" aria-hidden="true">#</a> 2. Spring 中的事务管理</h2>
<ul>
<li>
<p>spring 提供一种处理事务的统一模型, 能使用统一步骤,方式完成多种不同数据库访问技术的事务处理</p>
<ul>
<li>使用 spring 的事务处理机制,可以完成 mybatis 访问数据库的事务处理</li>
<li>使用 spring 的事务处理机制,可以完成 hibernate 访问数据库的事务处理</li>
</ul>
</li>
<li>
<p>处理事务,需要怎么做,做什么</p>
<ul>
<li>
<p>spring 处理事务的模型,使用的步骤都是固定的把事务使用的信息提供给 spring 就可以了</p>
</li>
<li>
<p>事务内部提交,回滚事务,**使用的****事务管理器对象**,代替你完成 commit,rollback</p>
<ul>
<li>
<p>事务管理器是一个接口和他的众多实现类</p>
<ul>
<li>
<p>接口: PlatformTransactionManager ,定义了事务重要方法 commit ,rollback</p>
</li>
<li>
<p>实现类: spring 把每一种数据库访问技术对应的事务处理类都创建好了</p>
<ul>
<li>mybatis 访问数据库---spring 创建好的是 DataSourceTransactionManager</li>
<li>hibernate 访问数据库----spring 创建的是 HibernateTransactionManager</li>
</ul>
</li>
</ul>
</li>
...
<li>
<p>怎么使用: <strong>你需要告诉 spring 你用是那种数据库的访问技术</strong>,怎么告诉 spring 呢？</p>
<ul>
<li>
<p>声明数据库访问技术对应的事务管理器实现类, 在 spring 的配置文件中使用<code v-pre>&lt;bean&gt;</code>声明就可以了</p>
</li>
<li>
<p>例如,你要使用 mybatis 访问数据库,你应该在 xml 配置文件中配置<code v-pre>&lt;bean id=“xxx&quot; class=&quot;...DataSourceTransactionManager&quot;&gt;</code></p>
</li>
</ul>
</li>
<li>
<p>你的业务方法需要什么样的事务,<strong>说明需要事务的类型</strong></p>
<ul>
<li>
<p>说明方法需要的事务:</p>
<ul>
...
<li>READ_UNCOMMITTED: 读未提交未解决任何并发问题</li>
<li>READ_COMMITTED: 读已提交解决脏读,存在不可重复读与幻读</li>
<li>REPEATABLE_READ: 可重复读解决脏读、不可重复读,存在幻读</li>
<li>SERIALIZABLE: 串行化不存在并发问题</li>
</ul>
</li>
</ul>
</li>
<li>
<p>事务的超时时间: 表示一个方法最长的执行时间,如果方法执行时超过了时间,事务就回滚单位是秒, 整数值, 默认是 -1.</p>
</li>
<li>
<p>事务的传播行为 : 控制业务方法是不是有事务的, 是什么样的事务的</p>
<ul>
<li>7 个传播行为,表示你的业务方法调用时,事务在方法之间是如果使用的</li>
<li><strong>PROPAGATION_REQUIRED, PROPAGATION_REQUIRES_NEW, PROPAGATION_SUPPORTS(<strong>需要掌握</strong>)</strong></li>
<li>PROPAGATION_MANDATORY, PROPAGATION_NESTED, PROPAGATION_NEVER, PROPAGATION_NOT_SUPPORTED</li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li>
<p>当你的业务方法,执行成功,没有异常抛出,当方法执行完毕,spring 在方法执行后提交事务事务管理器 commit</p>
</li>
<li>
<p>当你的业务方法抛出运行时异常或 ERROR, spring 执行回滚,调用事务管理器的 rollback</p>
<ul>
<li>运行时异常的定义: RuntimeException 和他的子类都是运行时异常, 例如 NullPointException , NumberFormatException</li>
</ul>
</li>
<li>
<p>当你的业务方法抛出非运行时异常, 主要是受查异常时,提交事务</p>
<ul>
<li>受查异常: 在你写代码中,必须处理的异常例如 IOException, SQLException</li>
</ul>
</li>
</ul>
</li>
...
<ul>
<li>
<p>管理事务的是 事务管理和他的实现类</p>
</li>
<li>
<p>spring 的事务是一个统一模型</p>
<ul>
...
<h2 id="_3-模拟事务环境搭建" tabindex="-1"><a class="header-anchor" href="#_3-模拟事务环境搭建" aria-hidden="true">#</a> 3. 模拟事务环境搭建</h2>
<h3 id="_1-dao-层" tabindex="-1"><a class="header-anchor" href="#_1-dao-层" aria-hidden="true">#</a> 1. dao 层</h3>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>mapper</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-实体类" tabindex="-1"><a class="header-anchor" href="#_2-实体类" aria-hidden="true">#</a> 2. 实体类</h3>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_4-配置文件" tabindex="-1"><a class="header-anchor" href="#_4-配置文件" aria-hidden="true">#</a> 4. 配置文件</h3>
<ol>
<li>
<p>jdbc.properties</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token key attr-name">jdbc.url</span><span class="token punctuation">=</span><span class="token value attr-value">jdbc:mysql://localhost:3306/springtrans</span>
...
<h2 id="_4-事务处理" tabindex="-1"><a class="header-anchor" href="#_4-事务处理" aria-hidden="true">#</a> 4. 事务处理</h2>
<h3 id="_1-spring-框架中提供的事务处理方案" tabindex="-1"><a class="header-anchor" href="#_1-spring-框架中提供的事务处理方案" aria-hidden="true">#</a> 1. spring 框架中提供的事务处理方案</h3>
<ol>
<li>适合中小项目使用的, 注解方案</li>
<li>spring 框架自己用 aop 实现给业务方法增加事务的功能, 使用<code v-pre>@Transactional</code>注解增加事务</li>
<li><code v-pre>@Transactional</code>注解是 spring 框架自己注解,放在 public 方法的上面,表示当前方法具有事务</li>
<li><strong>可以给注解的属性赋值,表示具体的隔离级别,传播行为,异常信息等等</strong></li>
</ol>
<p>使用<code v-pre>@Transactional</code>的步骤:</p>
<ul>
<li>需要声明事务管理器对象<code v-pre>&lt;bean id=&quot;xx&quot; class=&quot;DataSourceTransactionManager&quot;&gt;</code></li>
</ul>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--使用spring的事务处理--></span>
...
<li>开启事务注解驱动, 告诉 spring 框架,我要使用注解的方式管理事务</li>
</ul>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--2. 开启事务注解驱动,告诉spring使用注解管理事务,创建代理对象
...
<li>spring 使用 aop 机制,创建<code v-pre>@Transactional</code>所在的类代理对象,给方法加入事务的功能</li>
</ul>
<p>spring 给业务方法加入事务:</p>
<ul>
<li>在你的业务方法执行之前,先开启事务,在业务方法之后提交或回滚事务,使用 aop 的环绕通知</li>
<li>在你的方法的上面加入<code v-pre>@Trancational</code></li>
</ul>
<p>在 applicationContext.xml 中声明和开启事务</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--使用spring的事务处理--></span>
<span class="token comment">&lt;!--1. 声明事务管理器--></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>bean</span> <span class="token attr-name">id</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>transactionManager<span class="token punctuation">"</span></span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>org.springframework.jdbc.datasource.DataSourceTransactionManager<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
  <span class="token comment">&lt;!--连接的数据库, 指定数据源--></span>
...
<span class="token comment">&lt;!--2. 开启事务注解驱动,告诉spring使用注解管理事务,创建代理对象
    ...
    --></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token namespace">tx:</span>annotation-driven</span> <span class="token attr-name">transaction-manager</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>transactionManager<span class="token punctuation">"</span></span> <span class="token punctuation">/></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>给 BuyGoodsServiceImpl 中的 buy()方法添加事务控制</p>
...
<span class="token keyword">public</span> <span class="token keyword">void</span> <span class="token function">buy</span><span class="token punctuation">(</span><span class="token class-name">Integer</span> goodsId<span class="token punctuation">,</span> <span class="token class-name">Integer</span> nums<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"=====buy方法的完成===="</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_2-使用-aspectj-的-aop-配置管理事务" tabindex="-1"><a class="header-anchor" href="#_2-使用-aspectj-的-aop-配置管理事务" aria-hidden="true">#</a> 2. 使用 aspectj 的 aop 配置管理事务</h3>
<p>适合大型项目,有很多的类,方法,需要大量的配置事务,使用 aspectj 框架功能,在 spring 配置文件中声明类,方法需要的事务这种方式业务方法和事务配置完全分离</p>
<p>实现步骤: 都是在 xml 配置文件中实现</p>
<ol>
<li>
<p>要使用的是 aspectj 框架,需要加入依赖</p>
...
<li>
<p>声明事务管理器对象</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--声明式事务处理: 和源代码完全分离的--></span>
...
<li>
<p>声明方法需要的事务类型（配置方法的事务属性【隔离级别,传播行为,超时】）</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code> <span class="token comment">&lt;!--2.声明业务方法它的事务属性（隔离级别,传播行为,超时时间）
...
<li>
<p>配置 aop: 指定哪些哪类要创建代理</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--配置aop--></span>
...
<li>
<p>BuyGoodsServiceImpl 中的 buy()方法</p>
