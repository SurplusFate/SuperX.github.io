<template><div><h1 id="_6-使用注解开发" tabindex="-1"><a class="header-anchor" href="#_6-使用注解开发" aria-hidden="true">#</a> 6. 使用注解开发</h1>
<p>基于注解的 di: 通过注解完成 java 对象创建,属性赋值</p>
<ol>
<li>
<p>加入 maven 的依赖 spring-context ,在你加入 spring-context 的同时, 间接加入 spring-aop 的依赖</p>
<p>使用注解必须使用 spring-aop 依赖</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202209052232849.png" alt="注解开发"></p>
</li>
<li>
<p>在类中加入 spring 的注解（多个不同功能的注解）</p>
</li>
<li>
<p>在 spring 的配置文件中,加入一个组件扫描器的标签,说明注解在你的项目中的位置</p>
</li>
<li>
<p>学习的注解:</p>
<ol>
<li><code v-pre>@Component</code></li>
<li><code v-pre>@Repository</code></li>
<li><code v-pre>@Service</code></li>
<li><code v-pre>@Controller</code></li>
<li><code v-pre>@Value</code></li>
<li><code v-pre>@Autowired</code></li>
<li><code v-pre>@Resource</code></li>
</ol>
</li>
</ol>
<h2 id="_1-导入-context-约束-增加注解支持" tabindex="-1"><a class="header-anchor" href="#_1-导入-context-约束-增加注解支持" aria-hidden="true">#</a> 1. 导入 Context 约束, 增加注解支持</h2>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_2-注解" tabindex="-1"><a class="header-anchor" href="#_2-注解" aria-hidden="true">#</a> 2. 注解</h2>
<ol>
<li>
<p><code v-pre>@Component</code></p>
<blockquote>
<ul>
<li>
<p>创建对象的注解, 等同于<code v-pre>&lt;bean&gt;</code>的功能</p>
</li>
<li>
<p>属性:</p>
</li>
<li>
<p>value 就是对象的名称,也就是 bean 的 id 值,value 的值是唯一的,创建的对象在整个 spring 容器中就一个</p>
</li>
<li>
<p>省略 value<code v-pre>@Component(&quot;user&quot;)</code></p>
</li>
<li>
<p>不指定对象名称,由 spring 提供默认名称: 类名的首字母小写<code v-pre>@Component</code></p>
</li>
<li>
<p>位置: 在类的上面</p>
</li>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Component</span><span class="token punctuation">(</span>value <span class="token operator">=</span> <span class="token string">"user"</span><span class="token punctuation">)</span>
...
<p><code v-pre>@Component</code>(value = &quot;user&quot;)等同于</p>
...
<ul>
<li>
<p><code v-pre>@Component</code>的衍生注解</p>
</li>
<li>
<p>dao [<code v-pre>@Repository</code>]</p>
</li>
<li>
<p>service[<code v-pre>@Service</code>]</p>
</li>
<li>
<p>controller[<code v-pre>@Controller</code>]</p>
</li>
</ul>
<p>以上三个注解的使用语法和<code v-pre>@Component</code>一样的 都能创建对象,但是这三个注解还有额外的功能</p>
<p><code v-pre>@Repository</code>,<code v-pre>@Service</code>,<code v-pre>@Controller</code>是给项目的对象分层的</p>
</blockquote>
</li>
<li>
...
<p>属性:</p>
<ul>
<li>value 是 String 类型的,表示简单类型的属性值</li>
</ul>
</li>
<li>
<p>位置:</p>
<ul>
<li>可以在属性上, 也可以在方法上, 在属性定义的上面,<strong>无需 set 方法</strong>, 推荐使用</li>
</ul>
</li>
</ul>
</blockquote>
...
<li>
<p><code v-pre>@Autowired</code></p>
<blockquote>
<ul>
<li>引用类型的赋值</li>
<li><code v-pre>@Autowired</code> spring 框架提供的注解,实现引用类型的赋值</li>
<li>spring 中通过注解给引用类型赋值,使用的是自动注入原理,支持 byName, byType</li>
<li><code v-pre>@Autowired</code>: 默认使用的是 byType 自动注入</li>
<li>属性: required,是一个 boolean 类型的,默认 true
<ul>
<li>required=true: 表示引用类型赋值失败,程序报错,并终止执行</li>
<li>required=false: 引用类型如果赋值失败, 程序正常执行,引用类型是 null</li>
</ul>
</li>
<li>位置:
<ul>
...
<li>
<p>如果要使用 byName 方式,需要做的是:</p>
</li>
<li>
<p>在属性上面加入<code v-pre>@Autowired</code></p>
</li>
<li>
<p>在属性上面加入<code v-pre>@Qualifier(value=&quot;bean的id&quot;)</code>: 表示使用指定名称的 bean 完成赋值</p>
</li>
</ul>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Student</span> <span class="token punctuation">{</span>
...
<li>
<p><code v-pre>@Resource</code></p>
<blockquote>
<ul>
<li>引用类型</li>
<li>来自 jdk 中的注解,spring 框架提供了对这个注解的功能支持,可以使用它给引用类型赋值, 使用的也是自动注入原理,支持 byName, byType ,默认是 byName</li>
<li>位置:
<ul>
<li>可以在属性上, 也可以在方法上, 在属性定义的上面,<strong>无需 set 方法</strong>, 推荐使用</li>
</ul>
</li>
<li>默认是 byName: 先使用 byName 自动注入,如果 byName 赋值失败,再使用 byType</li>
<li><code v-pre>@Resource</code> 只使用 byName 方式,需要增加一个属性 name</li>
<li>name 的值是 bean 的 id（名称）</li>
</ul>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Student</span> <span class="token punctuation">{</span>
...
<li>
<p>prototype 原型模式 -- 每次获取 Bean 的时候会有一个新的实例</p>
</li>
<li>
<p>request -- request 表示该针对每一次 HTTP 请求都会产生一个新的 bean,同时该 bean 仅在当前 HTTP request 内有效</p>
</li>
<li>
<p>session -- session 作用域表示该针对每一次 HTTP 请求都会产生一个新的 bean,同时该 bean 仅在当前 HTTP session 内有效</p>
</li>
<li>
<p>globalsession -- global session 作用域类似于标准的 HTTP Session 作用域,不过它仅仅在基于 portlet 的 web 应用中才有意义</p>
</li>
</ul>
</blockquote>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token annotation punctuation">@Component</span>
...
<ul>
<li>
<p>xml: 万能, 适用性任何场景, 维护简单方便</p>
</li>
<li>
<p>注解: 不是自己的类使用不了, 维护复杂</p>
</li>
<li>
<p>xml 与注解的最佳实践</p>
<ol>
