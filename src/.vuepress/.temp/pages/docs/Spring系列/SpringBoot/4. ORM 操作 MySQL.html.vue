<template><div><h1 id="_4-orm-操作-mysql" tabindex="-1"><a class="header-anchor" href="#_4-orm-操作-mysql" aria-hidden="true">#</a> 4. ORM 操作 MySQL</h1>
<p>使用 MyBatis 框架操作数据, 在 SpringBoot 框架集成 MyBatis</p>
<p>使用步骤:</p>
<blockquote>
<ol>
<li>
<p>mybatis 起步依赖: 完成 mybatis 对象自动配置, 对象放在容器中</p>
</li>
<li>
<p>pom.xml 指定把 src/main/java 目录中的 xml 文件包含到 classpath 中</p>
</li>
<li>
<p>创建实体类 Student</p>
</li>
<li>
<p>创建 Dao 接口 StudentDao, 创建一个查询学生的方法</p>
</li>
<li>
<p>创建 Dao 接口对应的 Mapper 文件, xml 文件, 写 sql 语句</p>
</li>
<li>
<p>创建 Service 层对象, 创建 StudentService 接口和他的实现类. 去 dao 对象的方法.完成数据库的操作</p>
</li>
<li>
<p>创建 Controller 对象, 访问 Service.</p>
</li>
<li>
<p>写 application.properties 文件, 配置数据库的连接信息.</p>
</li>
</ol>
</blockquote>
<h2 id="准备工作" tabindex="-1"><a class="header-anchor" href="#准备工作" aria-hidden="true">#</a> 准备工作</h2>
<p>数据表:</p>
<div class="language-sql line-numbers-mode" data-ext="sql"><pre v-pre class="language-sql"><code><span class="token keyword">SET</span> NAMES utf8mb4<span class="token punctuation">;</span>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--web起步依赖--></span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>StudentDao.xml:</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>service 实现类:</p>
...
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token comment">#连接数据库</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>pom.xml 中指定资源文件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="完成-mybatis-对象自动配置" tabindex="-1"><a class="header-anchor" href="#完成-mybatis-对象自动配置" aria-hidden="true">#</a> 完成 mybatis 对象自动配置</h2>
<h3 id="第一种方式-mapper" tabindex="-1"><a class="header-anchor" href="#第一种方式-mapper" aria-hidden="true">#</a> 第一种方式: @Mapper</h3>
<p><code v-pre>@Mapper</code>: 放在 dao 接口的上面, 每个 dao 接口都需要使用这个注解, 接口多的时候很不方便.</p>
...
<span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">StudentDao</span> <span class="token punctuation">{</span>
    ...
    <span class="token class-name">Student</span> <span class="token function">selectById</span><span class="token punctuation">(</span><span class="token annotation punctuation">@Param</span><span class="token punctuation">(</span><span class="token string">"stuId"</span><span class="token punctuation">)</span> <span class="token class-name">Integer</span> id<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="第二种方式-mapperscan" tabindex="-1"><a class="header-anchor" href="#第二种方式-mapperscan" aria-hidden="true">#</a> 第二种方式 @MapperScan</h3>
<p>在任意配置类中使用 <code v-pre>@MapperScan</code> 包扫描, 无需逐个添加 <code v-pre>@Mapper</code>.</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token doc-comment comment">/**
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">StudentDao</span> <span class="token punctuation">{</span>
    ...
    <span class="token class-name">Student</span> <span class="token function">selectById</span><span class="token punctuation">(</span><span class="token annotation punctuation">@Param</span><span class="token punctuation">(</span><span class="token string">"stuId"</span><span class="token punctuation">)</span> <span class="token class-name">Integer</span> id<span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>@MapperScan 源码:</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="第三种方式-mapper-文件和-dao-接口分开管理" tabindex="-1"><a class="header-anchor" href="#第三种方式-mapper-文件和-dao-接口分开管理" aria-hidden="true">#</a> 第三种方式: Mapper 文件和 Dao 接口分开管理</h3>
<blockquote>
<ol>
<li>
<p>在 resources 目录中创建子目录 （自定义的）, 例如 mapper</p>
</li>
<li>
<p>把 mapper 文件放到 mapper 目录中</p>
</li>
<li>
<p>在 application.properties 文件中, 指定 mapper 文件的目录</p>
</li>
</ol>
</blockquote>
<p>把 Mapper 文件放在 resources 目录下</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202209211016927.png" alt="image-20220921101639713"></p>
<p>添加配置:</p>
<div class="language-properties line-numbers-mode" data-ext="properties"><pre v-pre class="language-properties"><code><span class="token comment">#指定mapper文件的位置</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在 pom.xml 中指定 把 resources 目录中的文件, 编译到目标目录中</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--resources插件--></span>
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>resources</span><span class="token punctuation">></span></span>
   <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>resource</span><span class="token punctuation">></span></span>
...
<ol>
<li>
<p>管理事务的对象: 事务管理器（接口, 接口有很多的实现类）</p>
<p>例如:使用 Jdbc 或 mybatis 访问数据库, 使用的事务管理器: DataSourceTransactionManager</p>
</li>
<li>
<p>声明式事务: 在 xml 配置文件或者使用注解说明事务控制的内容</p>
...
<ol>
<li>
<p>Spring 框架中的 <code v-pre>@Transactional</code></p>
</li>
<li>
<p>aspectj 框架可以在 xml 配置文件中, 声明事务控制的内容</p>
</li>
</ol>
</li>
</ol>
</blockquote>
<p>SpringBoot 中使用事务: 上面的两种方式都可以.</p>
<blockquote>
<ol>
<li>
<p>在业务方法上面加入 <code v-pre>@Transactional</code>, 加入注解后, 方法有事务功能了.</p>
</li>
<li>
<p>明确的在主启动类的上面加入 <code v-pre>@EnableTransactionManagement</code>(不是必须).</p>
</li>
</ol>
</blockquote>
<p>业务方法:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>测试时会抛出 <code v-pre>java.lang.ArithmeticException: / by zero</code> 异常, 将 <code v-pre>int error = 10 / 0;</code> 取消掉后重新测试数据库能正常添加数据, 但主键因为设有自增所以结果会跳过前面一个数字, 例如直接从 3 跳到 5, 中间的 4 就是因为异常回滚的数据.</p>
</div></template>
