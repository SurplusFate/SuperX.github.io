<template><div><h1 id="_13-dockerfile-自定义镜像" tabindex="-1"><a class="header-anchor" href="#_13-dockerfile-自定义镜像" aria-hidden="true">#</a> 13. Dockerfile 自定义镜像</h1>
<p>常见的镜像在 DockerHub 就能找到，但是我们自己写的项目就必须自己构建镜像了。</p>
<p>而要自定义镜像，就必须先了解镜像的结构才行。</p>
<h2 id="_13-1-镜像结构" tabindex="-1"><a class="header-anchor" href="#_13-1-镜像结构" aria-hidden="true">#</a> 13.1.镜像结构</h2>
<p>镜像是将应用程序及其需要的系统函数库、环境、配置、依赖打包而成。</p>
<p>我们以 MySQL 为例，来看看镜像的组成结构：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210731175806273.png" alt="image-20210731175806273"></p>
<p>简单来说，镜像就是在系统函数库、运行环境基础上，添加应用程序文件、配置文件、依赖文件等组合，然后编写好启动脚本打包在一起形成的文件。</p>
<p>我们要构建镜像，其实就是实现上述打包的过程。</p>
<h2 id="_13-2-dockerfile-语法" tabindex="-1"><a class="header-anchor" href="#_13-2-dockerfile-语法" aria-hidden="true">#</a> 13.2.Dockerfile 语法</h2>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210731180321133.png" alt="image-20210731180321133"></p>
...
<h2 id="_13-3-构建-java-项目" tabindex="-1"><a class="header-anchor" href="#_13-3-构建-java-项目" aria-hidden="true">#</a> 13.3.构建 Java 项目</h2>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801101455590.png" alt="image-20210801101455590"></p>
<h3 id="_13-3-1-基于-ubuntu-构建-java-项目" tabindex="-1"><a class="header-anchor" href="#_13-3-1-基于-ubuntu-构建-java-项目" aria-hidden="true">#</a> 13.3.1.基于 Ubuntu 构建 Java 项目</h3>
<p>需求：基于 Ubuntu 镜像构建一个新镜像，运行一个 java 项目</p>
<ul>
<li>
<p>步骤 1：新建一个空文件夹 docker-demo</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801101207444.png" alt="image-20210801101207444"></p>
</li>
<li>
<p>步骤 2：拷贝 docker-demo.jar 文件到 docker-demo 这个目录</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801101314816.png" alt="image-20210801101314816"></p>
</li>
<li>
<p>步骤 3：拷贝 jdk8.tar.gz 文件到 docker-demo 这个目录</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801101410200.png" alt="image-20210801101410200"></p>
</li>
<li>
<p>步骤 4：拷贝 Dockerfile 到 docker-demo 这个目录</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801101455590.png" alt="image-20210801101455590"></p>
<p>其中的内容如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code><span class="token comment"># 指定基础镜像</span>
FROM ubuntu:16.04
...
<p>最后访问 <a href="http://192.168.150.101:8090/hello/count" target="_blank" rel="noopener noreferrer">http://192.168.150.101:8090/hello/count<ExternalLinkIcon/></a>，其中的 ip 改成你的虚拟机 ip</p>
<h3 id="_13-3-2-基于-java8-构建-java-项目" tabindex="-1"><a class="header-anchor" href="#_13-3-2-基于-java8-构建-java-项目" aria-hidden="true">#</a> 13.3.2.基于 java8 构建 Java 项目</h3>
...
<h2 id="_13-4-小结" tabindex="-1"><a class="header-anchor" href="#_13-4-小结" aria-hidden="true">#</a> 13.4.小结</h2>
<p>小结：</p>
<ol>
<li>
