<template><div><h1 id="_14-docker-compose" tabindex="-1"><a class="header-anchor" href="#_14-docker-compose" aria-hidden="true">#</a> 14. Docker-Compose</h1>
<p>Docker Compose 可以基于 Compose 文件帮我们快速的部署分布式应用，而无需手动一个个创建和运行容器！</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210731180921742.png" alt="image-20210731180921742"></p>
<h2 id="_14-1-初识-dockercompose" tabindex="-1"><a class="header-anchor" href="#_14-1-初识-dockercompose" aria-hidden="true">#</a> 14.1.初识 DockerCompose</h2>
...
<p>DockerCompose 的详细语法参考官网：<a href="https://docs.docker.com/compose/compose-file/" target="_blank" rel="noopener noreferrer">https://docs.docker.com/compose/compose-file/<ExternalLinkIcon/></a></p>
<p>其实 DockerCompose 文件可以看做是将多个 docker run 命令写到一个文件，只是语法稍有差异。</p>
<h2 id="_14-2-部署微服务集群" tabindex="-1"><a class="header-anchor" href="#_14-2-部署微服务集群" aria-hidden="true">#</a> 14.2.部署微服务集群</h2>
<p><strong>需求</strong>：将之前学习的 cloud-demo 微服务集群利用 DockerCompose 部署</p>
<p><strong>实现思路</strong>：</p>
<p>① 查看资料提供的 cloud-demo 文件夹，里面已经编写好了 docker-compose 文件</p>
...
<h3 id="_14-2-1-compose-文件" tabindex="-1"><a class="header-anchor" href="#_14-2-1-compose-文件" aria-hidden="true">#</a> 14.2.1.compose 文件</h3>
<p>docker-demo:</p>
<p>链接: <a href="https://pan.baidu.com/s/1I6_xG7eVRSB_ui3y0omCqA?pwd=i6pe" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1I6_xG7eVRSB_ui3y0omCqA?pwd=i6pe<ExternalLinkIcon/></a> 提取码: i6pe</p>
<p>docker-compose:</p>
<p>链接: <a href="https://pan.baidu.com/s/1DC5ZgzxLITyJvcwe40bnAg?pwd=gkcz" target="_blank" rel="noopener noreferrer">https://pan.baidu.com/s/1DC5ZgzxLITyJvcwe40bnAg?pwd=gkcz<ExternalLinkIcon/></a> 提取码: gkcz</p>
<p>里面已经编写好了 docker-compose 文件，而且每个微服务都准备了一个独立的目录：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210731181341330.png" alt="image-20210731181341330"></p>
<p>内容如下：</p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801095205034.png" alt="image-20210801095205034"></p>
<p>查看微服务目录，可以看到都包含 Dockerfile 文件：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801095320586.png" alt="image-20210801095320586"></p>
<p>内容如下：</p>
<div class="language-bash line-numbers-mode" data-ext="sh"><pre v-pre class="language-bash"><code>FROM java:8-alpine
COPY ./app.jar /tmp/app.jar
ENTRYPOINT <span class="token function">java</span> <span class="token parameter variable">-jar</span> /tmp/app.jar
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_14-2-2-修改微服务配置" tabindex="-1"><a class="header-anchor" href="#_14-2-2-修改微服务配置" aria-hidden="true">#</a> 14.2.2.修改微服务配置</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_14-2-3-打包" tabindex="-1"><a class="header-anchor" href="#_14-2-3-打包" aria-hidden="true">#</a> 14.2.3.打包</h3>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801095951030.png" alt="image-20210801095951030"></p>
<h3 id="_14-2-4-拷贝-jar-包到部署目录" tabindex="-1"><a class="header-anchor" href="#_14-2-4-拷贝-jar-包到部署目录" aria-hidden="true">#</a> 14.2.4.拷贝 jar 包到部署目录</h3>
<p>编译打包好的 app.jar 文件，需要放到 Dockerfile 的同级目录中。注意：每个微服务的 app.jar 放到与服务名称对应的目录，别搞错了。</p>
<p>user-service：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801100201253.png" alt="image-20210801100201253"></p>
<p>order-service：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801100231495.png" alt="image-20210801100231495"></p>
<p>gateway：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801100308102.png" alt="image-20210801100308102"></p>
<h3 id="_14-2-5-部署" tabindex="-1"><a class="header-anchor" href="#_14-2-5-部署" aria-hidden="true">#</a> 14.2.5.部署</h3>
<p>最后，我们需要将文件整个 cloud-demo 文件夹上传到虚拟机中，理由 DockerCompose 部署。</p>
<p>上传到任意目录：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210801100955653.png" alt="image-20210801100955653"></p>
<p>部署：</p>
