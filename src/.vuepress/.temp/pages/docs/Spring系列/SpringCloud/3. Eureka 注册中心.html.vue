<template><div><h1 id="_3-eureka-注册中心" tabindex="-1"><a class="header-anchor" href="#_3-eureka-注册中心" aria-hidden="true">#</a> 3. Eureka 注册中心</h1>
<p>假如我们的服务提供者 user-service 部署了多个实例，如图：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051338385.png" alt="image-20221105133826308"></p>
<p>大家思考几个问题：</p>
<ul>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051338311.png" alt="image-20221105133855211"></p>
<p>回答之前的各个问题。</p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051339753.png" alt="image-20221105133927663"></p>
...
<h3 id="_3-2-1-创建子模块" tabindex="-1"><a class="header-anchor" href="#_3-2-1-创建子模块" aria-hidden="true">#</a> 3.2.1.创建子模块</h3>
<p>首先搭建注册中心服务端：eureka-server，这必须是一个独立的微服务</p>
<p>在 cloud-demo 父工程下，创建一个子模块: eureka-server</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-2-编写启动类" tabindex="-1"><a class="header-anchor" href="#_3-2-2-编写启动类" aria-hidden="true">#</a> 3.2.2.编写启动类</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-2-3-编写配置文件" tabindex="-1"><a class="header-anchor" href="#_3-2-3-编写配置文件" aria-hidden="true">#</a> 3.2.3.编写配置文件</h3>
...
<p>看到下面结果应该是成功了：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051411100.png" alt="image-20210713222157190"></p>
...
<p>在 user-service 中，修改 application.yml 文件，<strong>添加</strong>服务名称、eureka 地址：</p>
...
<span class="token key atrule">eureka</span><span class="token punctuation">:</span>
  <span class="token key atrule">client</span><span class="token punctuation">:</span>
    <span class="token key atrule">service-url</span><span class="token punctuation">:</span>
      <span class="token key atrule">defaultZone</span><span class="token punctuation">:</span> http<span class="token punctuation">:</span>//127.0.0.1<span class="token punctuation">:</span>10086/eureka
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-3-3-启动多个-user-service-实例" tabindex="-1"><a class="header-anchor" href="#_3-3-3-启动多个-user-service-实例" aria-hidden="true">#</a> 3.3.3.启动多个 user-service 实例</h3>
<p>为了演示一个服务有多个实例的场景，我们添加一个 SpringBoot 的启动配置，再启动一个 user-service。</p>
<p>首先，复制原来的 user-service 启动配置：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051411787.png" alt="image-20210713222656562"></p>
<p>然后，在弹出的窗口中，填写信息：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051424572.png" alt="image-20210713222757702"></p>
<p>现在，SpringBoot 窗口会出现两个 user-service 启动配置：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051425539.png" alt="image-20210713222841951"></p>
<p>不过，第一个是 8081 端口，第二个是 8082 端口。</p>
<p>启动两个 user-service 实例：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210713223041491.png" alt="image-20210713223041491"></p>
<p>查看 eureka-server 管理页面：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051426388.png" alt="image-20210713223150650"></p>
...
<p>在 order-service 中，修改 application.yml 文件，<strong>添加</strong>服务名称、eureka 地址：</p>
<div class="language-yaml line-numbers-mode" data-ext="yml"><pre v-pre class="language-yaml"><code><span class="token key atrule">spring</span><span class="token punctuation">:</span>
  <span class="token key atrule">application</span><span class="token punctuation">:</span>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051429575.png" alt="image-20210713224049419"></p>
<p>修改 order-service 服务中的 cn.itcast.order.service 包下的 OrderService 类中的 queryOrderById 方法。修改访问的 url 路径，用服务名代替 ip、端口：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211051430195.png" alt="image-20210713224245731"></p>
