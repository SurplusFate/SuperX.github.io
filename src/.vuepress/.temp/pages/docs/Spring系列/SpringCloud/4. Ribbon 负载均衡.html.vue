<template><div><h1 id="_4-ribbon-负载均衡" tabindex="-1"><a class="header-anchor" href="#_4-ribbon-负载均衡" aria-hidden="true">#</a> 4. Ribbon 负载均衡</h1>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210713224517686.png" alt="image-20210713224517686"></p>
<p>那么我们发出的请求明明是 <a href="http://userservice/user/1" target="_blank" rel="noopener noreferrer">http://userservice/user/1<ExternalLinkIcon/></a>，怎么变成了 <a href="http://localhost:8081" target="_blank" rel="noopener noreferrer">http://localhost:8081<ExternalLinkIcon/></a> 的呢？</p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/1525620483637.png" alt="1525620483637"></p>
<p>可以看到这里的 intercept 方法，拦截了用户的 HttpRequest 请求，然后做了几件事：</p>
<ul>
<li><code v-pre>request.getURI()</code>：获取请求 uri，本例中就是 <a href="http://user-service/user/8" target="_blank" rel="noopener noreferrer">http://user-service/user/8<ExternalLinkIcon/></a></li>
...
<p>继续跟入 execute 方法：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/1525620787090.png" alt="1525620787090"></p>
<p>代码是这样的：</p>
<ul>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/1525620835911.png" alt="1525620835911"></p>
<p>果然实现了负载均衡。</p>
<h3 id="_4-2-3-负载均衡策略-irule" tabindex="-1"><a class="header-anchor" href="#_4-2-3-负载均衡策略-irule" aria-hidden="true">#</a> 4.2.3.负载均衡策略 IRule</h3>
<p>在刚才的代码中，可以看到获取服务使通过一个<code v-pre>getServer</code>方法来做负载均衡:</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/1525620835911.png" alt="1525620835911"></p>
<p>我们继续跟入：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/1544361421671.png" alt="1544361421671"></p>
<p>继续跟踪源码 chooseServer 方法，发现这么一段代码：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/1525622652849.png" alt="1525622652849"></p>
<p>我们看看这个 rule 是谁：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/1525622699666.png" alt="1525622699666"></p>
<p>这里的 rule 默认值是一个<code v-pre>RoundRobinRule</code>，看类的介绍：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/1525622754316.png" alt="1525622754316"></p>
<p>这不就是轮询的意思嘛。</p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210713224724673.png" alt="image-20210713224724673"></p>
<p>基本流程如下：</p>
<ul>
<li>拦截我们的 RestTemplate 请求 <a href="http://userservice/user/1" target="_blank" rel="noopener noreferrer">http://userservice/user/1<ExternalLinkIcon/></a></li>
...
<li>RibbonLoadBalancerClient 修改请求地址，用 localhost:8081 替代 userservice，得到 <a href="http://localhost:8081/user/1" target="_blank" rel="noopener noreferrer">http://localhost:8081/user/1<ExternalLinkIcon/></a>，发起真实请求</li>
</ul>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210713225653000.png" alt="image-20210713225653000"></p>
<p>不同规则的含义如下：</p>
<table>
<thead>
<tr>
