...
<h3 id="_6-1-1-在-nacos-中添加配置文件" tabindex="-1"><a class="header-anchor" href="#_6-1-1-在-nacos-中添加配置文件" aria-hidden="true">#</a> 6.1.1.在 nacos 中添加配置文件</h3>
<p>如何在 nacos 中管理配置呢？</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714164742924.png" alt="image-20210714164742924"></p>
<p>然后在弹出的表单中，填写配置信息：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714164856664.png" alt="image-20210714164856664"></p>
<blockquote>
<p>注意：项目的核心配置，需要热更新的配置才有放到 nacos 管理的必要。基本不会变更的一些配置还是保存在微服务本地比较好。</p>
</blockquote>
<h3 id="_6-1-2-从微服务拉取配置" tabindex="-1"><a class="header-anchor" href="#_6-1-2-从微服务拉取配置" aria-hidden="true">#</a> 6.1.2.从微服务拉取配置</h3>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/L0iFYNF.png" alt="img"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3）删除 application.yml 中的重复配置:</p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714170845901.png" alt="image-20210714170845901"></p>
<p>4）读取 nacos 配置</p>
<p>在 user-service 中的 UserController 中添加业务逻辑，读取 pattern.dateformat 配置：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714170337448.png" alt="image-20210714170337448"></p>
<p>完整代码：</p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714170449612.png" alt="image-20210714170449612"></p>
<h2 id="_6-2-配置热更新" tabindex="-1"><a class="header-anchor" href="#_6-2-配置热更新" aria-hidden="true">#</a> 6.2.配置热更新</h2>
<p>我们最终的目的，是修改 nacos 中的配置后，微服务中无需重启即可让配置生效，也就是<strong>配置热更新</strong>。</p>
<p>要实现配置热更新，可以使用两种方式：</p>
<h3 id="_6-2-1-方式一" tabindex="-1"><a class="header-anchor" href="#_6-2-1-方式一" aria-hidden="true">#</a> 6.2.1.方式一</h3>
<p>在@Value 注入的变量所在类上添加注解@RefreshScope：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714171036335.png" alt="image-20210714171036335"></p>
<h3 id="_6-2-2-方式二" tabindex="-1"><a class="header-anchor" href="#_6-2-2-方式二" aria-hidden="true">#</a> 6.2.2.方式二</h3>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714171316124.png" alt="image-20210714171316124"></p>
<p>完整代码：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">package</span> <span class="token namespace">cn<span class="token punctuation">.</span>itcast<span class="token punctuation">.</span>user<span class="token punctuation">.</span>web</span><span class="token punctuation">;</span>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">UserController</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">// 略</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_6-3-配置共享" tabindex="-1"><a class="header-anchor" href="#_6-3-配置共享" aria-hidden="true">#</a> 6.3.配置共享</h2>
...
<p>下面我们通过案例来测试配置共享</p>
<h3 id="_6-3-1-添加一个环境共享配置" tabindex="-1"><a class="header-anchor" href="#_6-3-1-添加一个环境共享配置" aria-hidden="true">#</a> 6.3.1.添加一个环境共享配置</h3>
<p>我们在 nacos 中添加一个 userservice.yaml 文件：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714173233650.png" alt="image-20210714173233650"></p>
<h3 id="_6-3-2-在-user-service-中读取共享配置" tabindex="-1"><a class="header-anchor" href="#_6-3-2-在-user-service-中读取共享配置" aria-hidden="true">#</a> 6.3.2.在 user-service 中读取共享配置</h3>
<p>在 user-service 服务中，修改 PatternProperties 类，读取新添加的属性：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714173324231.png" alt="image-20210714173324231"></p>
<p>在 user-service 服务中，修改 UserController，添加一个方法：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714173721309.png" alt="image-20210714173721309"></p>
<h3 id="_6-3-3-运行两个-userapplication-使用不同的-profile" tabindex="-1"><a class="header-anchor" href="#_6-3-3-运行两个-userapplication-使用不同的-profile" aria-hidden="true">#</a> 6.3.3.运行两个 UserApplication，使用不同的 profile</h3>
<p>修改 UserApplication2 这个启动项，改变其 profile 值：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714173538538.png" alt="image-20210714173538538"></p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img//image-20221107153326444.png" alt="image-20221107153326444"></p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20221107153440948.png" alt="image-20221107153440948"></p>
<p>这样，UserApplication(8081)使用的 profile 是 test，UserApplication2(8082)使用的 profile 是 dev。</p>
<p>启动 UserApplication 和 UserApplication2</p>
<p>访问 <a href="http://localhost:8081/user/prop" target="_blank" rel="noopener noreferrer">http://localhost:8081/user/prop<ExternalLinkIcon/></a>，结果：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20221107155104542.png" alt="image-20221107155104542"></p>
<p>访问 <a href="http://localhost:8082/user/prop" target="_blank" rel="noopener noreferrer">http://localhost:8082/user/prop<ExternalLinkIcon/></a>，结果：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20221107155120268.png" alt="image-20221107155120268"></p>
<p>可以看出来，不管是 dev，还是 test 环境，都读取到了 envSharedValue 这个属性的值。</p>
<h3 id="_6-3-4-配置共享的优先级" tabindex="-1"><a class="header-anchor" href="#_6-3-4-配置共享的优先级" aria-hidden="true">#</a> 6.3.4.配置共享的优先级</h3>
<p>当 nacos、服务本地同时出现相同属性时，优先级有高低之分：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714174623557.png" alt="image-20210714174623557"></p>
</div></template>
