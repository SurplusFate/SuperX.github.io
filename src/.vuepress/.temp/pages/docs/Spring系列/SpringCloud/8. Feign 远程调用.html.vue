<template><div><h1 id="_8-feign-远程调用" tabindex="-1"><a class="header-anchor" href="#_8-feign-远程调用" aria-hidden="true">#</a> 8. Feign 远程调用</h1>
...
<h2 id="_8-1-feign-替代-resttemplate" tabindex="-1"><a class="header-anchor" href="#_8-1-feign-替代-resttemplate" aria-hidden="true">#</a> 8.1.Feign 替代 RestTemplate</h2>
<p>Fegin 的使用步骤如下：</p>
<h3 id="_8-1-1-引入依赖" tabindex="-1"><a class="header-anchor" href="#_8-1-1-引入依赖" aria-hidden="true">#</a> 8.1.1.引入依赖</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_8-1-2-添加注解" tabindex="-1"><a class="header-anchor" href="#_8-1-2-添加注解" aria-hidden="true">#</a> 8.1.2.添加注解</h3>
<p>在 order-service 的启动类添加注解开启 Feign 的功能：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714175102524.png" alt="image-20210714175102524"></p>
<h3 id="_8-1-3-编写-feign-的客户端" tabindex="-1"><a class="header-anchor" href="#_8-1-3-编写-feign-的客户端" aria-hidden="true">#</a> 8.1.3.编写 Feign 的客户端</h3>
...
<h3 id="_8-1-4-测试" tabindex="-1"><a class="header-anchor" href="#_8-1-4-测试" aria-hidden="true">#</a> 8.1.4.测试</h3>
<p>修改 order-service 中的 OrderService 类中的 queryOrderById 方法，使用 Feign 客户端代替 RestTemplate：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714175415087.png" alt="image-20210714175415087"></p>
<p>是不是看起来优雅多了。</p>
<h3 id="_8-1-5-总结" tabindex="-1"><a class="header-anchor" href="#_8-1-5-总结" aria-hidden="true">#</a> 8.1.5.总结</h3>
<p>使用 Feign 的步骤：</p>
<p>① 引入依赖</p>
<p>② 添加@EnableFeignClients 注解</p>
<p>③ 编写 FeignClient 接口</p>
<p>④ 使用 FeignClient 中定义的方法代替 RestTemplate</p>
<h2 id="_8-2-自定义配置" tabindex="-1"><a class="header-anchor" href="#_8-2-自定义配置" aria-hidden="true">#</a> 8.2.自定义配置</h2>
...
<h3 id="_8-2-1-配置文件方式" tabindex="-1"><a class="header-anchor" href="#_8-2-1-配置文件方式" aria-hidden="true">#</a> 8.2.1.配置文件方式</h3>
...
<h3 id="_8-2-2-java-代码方式" tabindex="-1"><a class="header-anchor" href="#_8-2-2-java-代码方式" aria-hidden="true">#</a> 8.2.2.Java 代码方式</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="_8-3-feign-使用优化" tabindex="-1"><a class="header-anchor" href="#_8-3-feign-使用优化" aria-hidden="true">#</a> 8.3.Feign 使用优化</h2>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714185925910.png" alt="image-20210714185925910"></p>
<p>Debug 方式启动 order-service 服务，可以看到这里的 client，底层就是 Apache HttpClient：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714190041542.png" alt="image-20210714190041542"></p>
<p>总结，Feign 的优化：</p>
<p>1.日志级别尽量用 basic</p>
<p>2.使用 HttpClient 或 OKHttp 代替 URLConnection</p>
<p>① 引入 feign-httpClient 依赖</p>
<p>② 配置文件开启 httpClient 功能，设置连接池参数</p>
<h2 id="_8-4-最佳实践" tabindex="-1"><a class="header-anchor" href="#_8-4-最佳实践" aria-hidden="true">#</a> 8.4.最佳实践</h2>
<p>所谓最近实践，就是使用过程中总结的经验，最好的一种使用方式。</p>
<p>仔细观察可以发现，Feign 的客户端与服务提供者的 controller 代码非常相似：</p>
<p>feign 客户端：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714190542730.png" alt="image-20210714190542730"></p>
<p>UserController：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714190528450.png" alt="image-20210714190528450"></p>
<p>有没有一种办法简化这种重复的代码编写呢？</p>
<h3 id="_8-4-1-继承方式" tabindex="-1"><a class="header-anchor" href="#_8-4-1-继承方式" aria-hidden="true">#</a> 8.4.1.继承方式</h3>
<p>一样的代码可以通过继承来共享：</p>
<p>1）定义一个 API 接口，利用定义方法，并基于 SpringMVC 注解做声明。</p>
<p>2）Feign 客户端和 Controller 都集成改接口</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714190640857.png" alt="image-20210714190640857"></p>
<p>优点：</p>
<ul>
<li>简单</li>
<li>实现了代码共享</li>
...
<h3 id="_8-4-2-抽取方式" tabindex="-1"><a class="header-anchor" href="#_8-4-2-抽取方式" aria-hidden="true">#</a> 8.4.2.抽取方式</h3>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714214041796.png" alt="image-20210714214041796"></p>
<h3 id="_8-4-3-实现基于抽取的最佳实践" tabindex="-1"><a class="header-anchor" href="#_8-4-3-实现基于抽取的最佳实践" aria-hidden="true">#</a> 8.4.3.实现基于抽取的最佳实践</h3>
<h4 id="_1-抽取" tabindex="-1"><a class="header-anchor" href="#_1-抽取" aria-hidden="true">#</a> 1）抽取</h4>
<p>首先创建一个 module，命名为 feign-api：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714204557771.png" alt="image-20210714204557771"></p>
<p>项目结构：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714204656214.png" alt="image-20210714204656214"></p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714205221970.png" alt="image-20210714205221970"></p>
...
<p>重启后，发现服务报错了：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714205623048.png" alt="image-20210714205623048"></p>
