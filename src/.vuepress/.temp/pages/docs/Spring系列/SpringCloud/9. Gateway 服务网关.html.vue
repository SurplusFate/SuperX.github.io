...
<p>架构图：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714210131152.png" alt="image-20210714210131152"></p>
...
<h2 id="_9-2-gateway-快速入门" tabindex="-1"><a class="header-anchor" href="#_9-2-gateway-快速入门" aria-hidden="true">#</a> 9.2.gateway 快速入门</h2>
...
<h3 id="_9-2-1-创建-gateway-服务-引入依赖" tabindex="-1"><a class="header-anchor" href="#_9-2-1-创建-gateway-服务-引入依赖" aria-hidden="true">#</a> 9.2.1.创建 gateway 服务，引入依赖</h3>
<p>创建服务：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714210919458.png" alt="image-20210714210919458"></p>
<p>引入依赖：</p>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>dependency</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9-2-2-编写启动类" tabindex="-1"><a class="header-anchor" href="#_9-2-2-编写启动类" aria-hidden="true">#</a> 9.2.2.编写启动类</h3>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9-2-3-编写基础配置和路由规则" tabindex="-1"><a class="header-anchor" href="#_9-2-3-编写基础配置和路由规则" aria-hidden="true">#</a> 9.2.3.编写基础配置和路由规则</h3>
...
<h3 id="_9-2-4-重启测试" tabindex="-1"><a class="header-anchor" href="#_9-2-4-重启测试" aria-hidden="true">#</a> 9.2.4.重启测试</h3>
<p>重启网关，访问 <a href="http://localhost:10010/user/1" target="_blank" rel="noopener noreferrer">http://localhost:10010/user/1<ExternalLinkIcon/></a> 时，符合<code v-pre>/user/**</code>规则，请求转发到 uri：<a href="http://userservice/user/1" target="_blank" rel="noopener noreferrer">http://userservice/user/1<ExternalLinkIcon/></a>，得到了结果：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714211908341.png" alt="image-20210714211908341"></p>
<h3 id="_9-2-5-网关路由的流程图" tabindex="-1"><a class="header-anchor" href="#_9-2-5-网关路由的流程图" aria-hidden="true">#</a> 9.2.5.网关路由的流程图</h3>
<p>整个访问的流程如下：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714211742956.png" alt="image-20210714211742956"></p>
<p>总结：</p>
<p>网关搭建步骤：</p>
<ol>
<li>
...
<h2 id="_9-3-断言工厂" tabindex="-1"><a class="header-anchor" href="#_9-3-断言工厂" aria-hidden="true">#</a> 9.3.断言工厂</h2>
...
<p>我们只需要掌握 Path 这种路由工程就可以了。</p>
<h2 id="_9-4-过滤器工厂" tabindex="-1"><a class="header-anchor" href="#_9-4-过滤器工厂" aria-hidden="true">#</a> 9.4.过滤器工厂</h2>
<p>GatewayFilter 是网关中提供的一种过滤器，可以对进入网关的请求和微服务返回的响应做处理：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714212312871.png" alt="image-20210714212312871"></p>
<h3 id="_9-4-1-路由过滤器的种类" tabindex="-1"><a class="header-anchor" href="#_9-4-1-路由过滤器的种类" aria-hidden="true">#</a> 9.4.1.路由过滤器的种类</h3>
...
<h3 id="_9-4-2-请求头过滤器" tabindex="-1"><a class="header-anchor" href="#_9-4-2-请求头过滤器" aria-hidden="true">#</a> 9.4.2.请求头过滤器</h3>
...
<h3 id="_9-4-3-默认过滤器" tabindex="-1"><a class="header-anchor" href="#_9-4-3-默认过滤器" aria-hidden="true">#</a> 9.4.3.默认过滤器</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9-4-4-总结" tabindex="-1"><a class="header-anchor" href="#_9-4-4-总结" aria-hidden="true">#</a> 9.4.4.总结</h3>
<p>过滤器的作用是什么？</p>
<p>① 对路由的请求或响应做加工处理，比如添加请求头</p>
<p>② 配置在路由下的过滤器只对当前路由的请求生效</p>
<p>defaultFilters 的作用是什么？</p>
<p>① 对所有路由都生效的过滤器</p>
<h2 id="_9-5-全局过滤器" tabindex="-1"><a class="header-anchor" href="#_9-5-全局过滤器" aria-hidden="true">#</a> 9.5.全局过滤器</h2>
<p>上一节学习的过滤器，网关提供了 31 种，但每一种过滤器的作用都是固定的。如果我们希望拦截请求，做自己的业务逻辑则没办法实现。</p>
<h3 id="_9-5-1-全局过滤器作用" tabindex="-1"><a class="header-anchor" href="#_9-5-1-全局过滤器作用" aria-hidden="true">#</a> 9.5.1.全局过滤器作用</h3>
...
<h3 id="_9-5-2-自定义全局过滤器" tabindex="-1"><a class="header-anchor" href="#_9-5-2-自定义全局过滤器" aria-hidden="true">#</a> 9.5.2.自定义全局过滤器</h3>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">AuthorizeFilter</span> <span class="token keyword">implements</span> <span class="token class-name">GlobalFilter</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_9-5-3-过滤器执行顺序" tabindex="-1"><a class="header-anchor" href="#_9-5-3-过滤器执行顺序" aria-hidden="true">#</a> 9.5.3.过滤器执行顺序</h3>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714214228409.png" alt="image-20210714214228409"></p>
<p>排序的规则是什么呢？</p>
<ul>
...
<h2 id="_9-6-跨域问题" tabindex="-1"><a class="header-anchor" href="#_9-6-跨域问题" aria-hidden="true">#</a> 9.6.跨域问题</h2>
<h3 id="_9-6-1-什么是跨域问题" tabindex="-1"><a class="header-anchor" href="#_9-6-1-什么是跨域问题" aria-hidden="true">#</a> 9.6.1.什么是跨域问题</h3>
...
<h3 id="_9-6-2-模拟跨域问题" tabindex="-1"><a class="header-anchor" href="#_9-6-2-模拟跨域问题" aria-hidden="true">#</a> 9.6.2.模拟跨域问题</h3>
<p>找到课前资料的页面文件：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714215713563.png" alt="image-20210714215713563"></p>
<p>放入 tomcat 或者 nginx 这样的 web 服务器中，启动并访问。</p>
<p>可以在浏览器控制台看到下面的错误：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714215832675.png" alt="image-20210714215832675"></p>
<p>从 localhost:8090 访问 localhost:10010，端口不同，显然是跨域的请求。</p>
<h3 id="_9-6-3-解决跨域问题" tabindex="-1"><a class="header-anchor" href="#_9-6-3-解决跨域问题" aria-hidden="true">#</a> 9.6.3.解决跨域问题</h3>
