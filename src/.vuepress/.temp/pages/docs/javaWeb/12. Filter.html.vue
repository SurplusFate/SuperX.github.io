<template><div><h1 id="_12-filter" tabindex="-1"><a class="header-anchor" href="#_12-filter" aria-hidden="true">#</a> 12. Filter</h1>
<p>Filter：过滤器 ，用来过滤网站的数据；</p>
<ul>
<li>处理中文乱码</li>
<li>登录验证….</li>
</ul>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208291211519.png" alt="1568424858708"></p>
<p>Filter 开发步骤：</p>
<ol>
<li>
<p>导包</p>
...
<p>编写过滤器</p>
<p>导包不要错</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208291212506.png" alt="1568425162525"></p>
<p>实现 Filter 接口，重写对应的方法即可</p>
