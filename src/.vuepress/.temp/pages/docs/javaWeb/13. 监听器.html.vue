<template><div><h1 id="_13-监听器" tabindex="-1"><a class="header-anchor" href="#_13-监听器" aria-hidden="true">#</a> 13. 监听器</h1>
<p>监听器 Listener 就是在 application，session，request 三个对象创建，销毁，或者往其中添加修改删除属性时自动执行代码的功能组件。Listener 是 Servlet 的监听器，可以监听客户端的请求，服务端的操作等。</p>
<ul>
<li>
<p>编写一个监听器</p>
<p>实现监听器的接口</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">//统计网站在线人数 ： 统计session</span>
...
<li>
<p>web.xml 中注册监听器</p>
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code><span class="token comment">&lt;!--注册监听器--></span>
