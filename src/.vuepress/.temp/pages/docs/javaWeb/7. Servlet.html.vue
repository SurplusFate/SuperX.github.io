<template><div><h1 id="_7-servlet" tabindex="-1"><a class="header-anchor" href="#_7-servlet" aria-hidden="true">#</a> 7. Servlet</h1>
<p>什么是 Servlet</p>
<ol>
...
<h2 id="手动实现-servlet-程序" tabindex="-1"><a class="header-anchor" href="#手动实现-servlet-程序" aria-hidden="true">#</a> 手动实现 Servlet 程序</h2>
<ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>常见的错误 1：url-pattern 中配置的路径没有以斜杠打头。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272012751.png" alt="image-20220827201221652"></p>
<p>常见错误 2：servlet-name 配置的值不存在</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272012824.png" alt="image-20220827201232717"></p>
<p>常见错误 3：servlet-class 标签的全类名配置错误</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272012473.png" alt="image-20220827201245397"></p>
<p>url 地址到 Servlet 程序的访问</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272013149.png" alt="image-20220827201342040"></p>
<h2 id="注解实现-servlet-程序" tabindex="-1"><a class="header-anchor" href="#注解实现-servlet-程序" aria-hidden="true">#</a> 注解实现 Servlet 程序</h2>
<p>注释表示元数据。 如果使用注释，则不需要部署描述符 (<em>web.xml</em> 文件)。但是应该在 <code v-pre>tomcat7</code> 以上版本中部署运行，<code v-pre>tomcat7</code> 之前的版本是不支持注解的。 <code v-pre>@WebServlet</code>注释用于将 servlet 映射到指定的名称，这是 Servlet3 的特性，所以在创建项目时要指定 Servlet 的版本为 <code v-pre>3.0</code> 以上。</p>
<p>注解 WebServlet 用来描述一个 Servlet</p>
<ol>
<li>属性 name 描述 Servlet 的名字,可选</li>
<li>属性 urlPatterns 定义访问的 URL,或者使用属性 value 定义访问的 URL.(定义访问的 URL 是必选属性)</li>
</ol>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code>  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>servlet</span><span class="token punctuation">></span></span>
  ...
  <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>servlet-mapping</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="使用-idea-创建-servlet-程序" tabindex="-1"><a class="header-anchor" href="#使用-idea-创建-servlet-程序" aria-hidden="true">#</a> 使用 IDEA 创建 Servlet 程序</h2>
<p>菜单：new -&gt;Servlet 程序</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208290852411.png" alt="image-20220829085224548"></p>
<p>配置 Servlet 的信息：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272036873.png" alt="image-20220827203608810"></p>
<p>如果没有 servlet 可设置项目结构</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208290854508.png" alt="image-20220829085415691"></p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208290854787.png" alt="image-20220829085447667"></p>
<h2 id="servlet-类的继承体系" tabindex="-1"><a class="header-anchor" href="#servlet-类的继承体系" aria-hidden="true">#</a> Servlet 类的继承体系</h2>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272039487.png" alt="image-20220827203902373"></p>
<h2 id="servletconfig-类" tabindex="-1"><a class="header-anchor" href="#servletconfig-类" aria-hidden="true">#</a> ServletConfig 类</h2>
...
<h3 id="servletconfig-类的三大作用" tabindex="-1"><a class="header-anchor" href="#servletconfig-类的三大作用" aria-hidden="true">#</a> ServletConfig 类的三大作用</h3>
<ol>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272045144.png" alt="image-20220827204501064"></p>
<h2 id="servletcontext-类" tabindex="-1"><a class="header-anchor" href="#servletcontext-类" aria-hidden="true">#</a> ServletContext 类</h2>
<h3 id="什么是-servletcontext" tabindex="-1"><a class="header-anchor" href="#什么是-servletcontext" aria-hidden="true">#</a> 什么是 ServletContext?</h3>
<ol>
...
<h3 id="servletcontext-类的四个作用" tabindex="-1"><a class="header-anchor" href="#servletcontext-类的四个作用" aria-hidden="true">#</a> ServletContext 类的四个作用</h3>
<ol>
...
<div class="language-xml line-numbers-mode" data-ext="xml"><pre v-pre class="language-xml"><code> <span class="token comment">&lt;!--context-param是上下文参数(它属于整个web工程)--></span>
    ...
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>context-param</span><span class="token punctuation">></span></span>
        ...
        <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>param-value</span><span class="token punctuation">></span></span>root<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>param-value</span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>context-param</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>ServletContext 像 Map 一样存取数据：ContextServlet1 代码：</p>
...
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ContextServlet2</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="http-协议" tabindex="-1"><a class="header-anchor" href="#http-协议" aria-hidden="true">#</a> HTTP 协议</h3>
<p>什么是 HTTP 协议</p>
<p>什么是协议?</p>
<p>协议是指双方，或多方，相互约定好，大家都需要遵守的规则，叫协议。</p>
<p>所谓 HTTP 协议，就是指，客户端和服务器之间通信时，发送的数据，需要遵守的规则，叫 HTTP 协议。HTTP 协议中的数据又叫报文。</p>
<p>请求的 HTTP 协议格式</p>
<p>客户端给服务器发送数据叫请求。</p>
<p>服务器给客户端回传数据叫响应。</p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272100694.png" alt="image-20220827210022580"></p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272102392.png" alt="image-20220827210217243"></p>
...
<p><strong>哪些是 GET 请求，哪些是 POST 请求：</strong></p>
<p>GET 请求有哪些：</p>
<ol>
...
<p>POST 请求有哪些：</p>
<p>form 标签 method=post</p>
<h4 id="响应的-http-协议格式" tabindex="-1"><a class="header-anchor" href="#响应的-http-协议格式" aria-hidden="true">#</a> 响应的 HTTP 协议格式</h4>
<ol>
<li>
<p>响应行</p>
<p>响应的协议和版本号</p>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272105018.png" alt="image-20220827210507848"></p>
<h4 id="常用的响应码说明" tabindex="-1"><a class="header-anchor" href="#常用的响应码说明" aria-hidden="true">#</a> 常用的响应码说明</h4>
<blockquote>
<p>200 表示请求成功</p>
<p>302 表示请求重定向（明天讲）</p>
...
<h4 id="mime-类型说明" tabindex="-1"><a class="header-anchor" href="#mime-类型说明" aria-hidden="true">#</a> MIME 类型说明</h4>
<blockquote>
...
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272112369.png" alt="image-20220827211239233"></p>
<p>火狐浏览器如何查看 HTTP 协议：</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208272112376.png" alt="image-20220827211250242"></p>
<h2 id="httpservletrequest-类" tabindex="-1"><a class="header-anchor" href="#httpservletrequest-类" aria-hidden="true">#</a> HttpServletRequest 类</h2>
...
<h3 id="httpservletrequest-类的常用方法" tabindex="-1"><a class="header-anchor" href="#httpservletrequest-类的常用方法" aria-hidden="true">#</a> HttpServletRequest 类的常用方法</h3>
<table>
<thead>
<tr>
<th style="text-align:center">getRequestURI()</th>
<th style="text-align:center">获取请求的资源路径</th>
</tr>
</thead>
<tbody>
<tr>
...
<td style="text-align:center">获取客户端的 ip 地址</td>
</tr>
<tr>
...
<td style="text-align:center">获取请求的参数</td>
</tr>
<tr>
<td style="text-align:center">getParameterValues()</td>
<td style="text-align:center">获取请求的参数（多个值的时候使用）</td>
</tr>
<tr>
<td style="text-align:center">getMethod()</td>
<td style="text-align:center">获取请求的方式 GET 或 POST</td>
</tr>
<tr>
...
<td style="text-align:center">获取域数据</td>
</tr>
<tr>
...
<span class="token comment">//        vii.getMethod() 获取请求的方式GET或POST</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="如何获取请求参数" tabindex="-1"><a class="header-anchor" href="#如何获取请求参数" aria-hidden="true">#</a> 如何获取请求参数</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="解决乱码" tabindex="-1"><a class="header-anchor" href="#解决乱码" aria-hidden="true">#</a> 解决乱码</h4>
<p>doGet 请求的中文乱码解决：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 获取请求参数</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>或者在方法开始的第一行和第二行添加：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code>request<span class="token punctuation">.</span><span class="token function">setCharacterEncoding</span><span class="token punctuation">(</span><span class="token string">"UTF-8"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
response<span class="token punctuation">.</span><span class="token function">setContentType</span><span class="token punctuation">(</span><span class="token string">"text/html;charset=UTF-8"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>POST 请求的中文乱码解决</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token keyword">protected</span> <span class="token keyword">void</span> <span class="token function">doPost</span><span class="token punctuation">(</span><span class="token class-name">HttpServletRequest</span> request<span class="token punctuation">,</span> <span class="token class-name">HttpServletResponse</span> response<span class="token punctuation">)</span>
  <span class="token keyword">throws</span> <span class="token class-name">ServletException</span><span class="token punctuation">,</span> <span class="token class-name">IOException</span> <span class="token punctuation">{</span>
    ...
    <span class="token class-name">System</span><span class="token punctuation">.</span>out<span class="token punctuation">.</span><span class="token function">println</span><span class="token punctuation">(</span><span class="token string">"兴趣爱好："</span> <span class="token operator">+</span> <span class="token class-name">Arrays</span><span class="token punctuation">.</span><span class="token function">asList</span><span class="token punctuation">(</span>hobby<span class="token punctuation">)</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="请求的转发" tabindex="-1"><a class="header-anchor" href="#请求的转发" aria-hidden="true">#</a> 请求的转发</h3>
<p>什么是请求的转发? 请求转发是指，服务器收到请求后，从一次资源跳转到另一个资源的操作叫请求转发。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208291014113.png" alt="image-20220829101449316"></p>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Servlet2</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="base-标签的作用" tabindex="-1"><a class="header-anchor" href="#base-标签的作用" aria-hidden="true">#</a> base 标签的作用</h4>
...
<h4 id="web-中的相对路径和绝对路径" tabindex="-1"><a class="header-anchor" href="#web-中的相对路径和绝对路径" aria-hidden="true">#</a> Web 中的相对路径和绝对路径</h4>
<p>在 javaWeb 中，路径分为相对路径和绝对路径两种：</p>
<p>相对路径是：</p>
<p><code v-pre>.</code> 表示当前目录</p>
<p><code v-pre>..</code> 表示上一级目录</p>
<p><code v-pre>资源名</code> 表示当前目录/资源名</p>
<p>绝对路径：</p>
<p><code v-pre>http://ip:port/工程路径/资源路径</code></p>
<p>在实际开发中，路径都使用绝对路径，而不简单的使用相对路径。</p>
<ol>
<li>对路径</li>
<li>base+相对</li>
</ol>
<h4 id="web-中-斜杠的不同意义" tabindex="-1"><a class="header-anchor" href="#web-中-斜杠的不同意义" aria-hidden="true">#</a> web 中 <code v-pre>/</code> 斜杠的不同意义</h4>
<p>在 web 中 <code v-pre>/</code> 斜杠 是一种绝对路径。</p>
<p><code v-pre>/</code> 斜杠如果被浏览器解析，得到的地址是：<code v-pre>http://ip:port/</code></p>
<p><code v-pre>&lt;a href=&quot;/&quot;&gt;斜杠&lt;/a&gt;</code></p>
<p><code v-pre>/</code> 斜杠如果被服务器解析，得到的地址是：<code v-pre>http://ip:port/工程路径</code></p>
<ol>
<li><code v-pre>&lt;url-pattern&gt;/servlet1&lt;/url-pattern&gt;</code></li>
<li><code v-pre>servletContext.getRealPath(“/”);</code></li>
<li><code v-pre>request.getRequestDispatcher(“/”);</code></li>
</ol>
<p>特殊情况： <code v-pre>response.sendRediect(“/”);</code> 把斜杠发送给浏览器解析。得到 <code v-pre>http://ip:port/</code></p>
<h2 id="httpservletresponse-类" tabindex="-1"><a class="header-anchor" href="#httpservletresponse-类" aria-hidden="true">#</a> HttpServletResponse 类</h2>
<p>HttpServletResponse 类和 HttpServletRequest 类一样。每次请求进来，Tomcat 服务器都会创建一个 Response 对象传 递给 Servlet 程序去使用。HttpServletRequest 表示请求过来的信息，HttpServletResponse 表示所有响应的信息， 我们如果需要设置返回给客户端的信息，都可以通过 HttpServletResponse 对象来进行设置。</p>
<h3 id="两个输出流的说明" tabindex="-1"><a class="header-anchor" href="#两个输出流的说明" aria-hidden="true">#</a> 两个输出流的说明</h3>
<p>字节流 getOutputStream(); 常用于下载（传递二进制数据）</p>
<p>字符流 getWriter(); 常用于回传字符串（常用）</p>
<p>两个流同时只能使用一个。</p>
<p>使用了字节流，就不能再使用字符流，反之亦然，否则就会报错。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208291058846.png" alt="image-20220829105821688"></p>
<h3 id="如何往客户端回传数据" tabindex="-1"><a class="header-anchor" href="#如何往客户端回传数据" aria-hidden="true">#</a> 如何往客户端回传数据</h3>
...
<span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">ResponseIOServlet</span> <span class="token keyword">extends</span> <span class="token class-name">HttpServlet</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="响应的乱码解决" tabindex="-1"><a class="header-anchor" href="#响应的乱码解决" aria-hidden="true">#</a> 响应的乱码解决</h4>
<p>解决响应中文乱码方案一（不推荐使用）：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 设置服务器字符集为 UTF-8</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>解决响应中文乱码方案二（推荐）：</p>
<div class="language-java line-numbers-mode" data-ext="java"><pre v-pre class="language-java"><code><span class="token comment">// 它会同时设置服务器和客户端都使用 UTF-8 字符集，还设置了响应头</span>
<span class="token comment">// 此方法一定要在获取流对象之前调用才有效</span>
resp<span class="token punctuation">.</span><span class="token function">setContentType</span><span class="token punctuation">(</span><span class="token string">"text/html; charset=UTF-8"</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="请求重定向" tabindex="-1"><a class="header-anchor" href="#请求重定向" aria-hidden="true">#</a> 请求重定向</h3>
<p>请求重定向，是指客户端给服务器发请求，然后服务器告诉客户端说。我给你一些地址。你去新地址访问。叫请求 重定向（因为之前的地址可能已经被废弃）。</p>
<p><img src="https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202208291103118.png" alt="image-20220829110358949"></p>
<p>请求重定向的第一种方案：</p>
<p>设置响应状态码 302 ，表示重定向，（已搬迁）</p>
<p><code v-pre>resp.setStatus(302);</code></p>
<p>设置响应头，说明 新的地址在哪里</p>
<p><code v-pre>resp.setHeader(&quot;Location&quot;, &quot;http://localhost:8080&quot;);</code></p>
<p>请求重定向的第二种方案（推荐使用）：</p>
<p><code v-pre>resp.sendRedirect(&quot;http://localhost:8080&quot;)</code></p>
</div></template>
