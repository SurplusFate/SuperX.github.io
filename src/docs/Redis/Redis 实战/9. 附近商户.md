...
> redis zset 中 key 为 shop:gep: + shopType，value 为 商户 id，score 为 经纬度
>
> 1. 查询所以的店铺信息
> 2. 按照 shopType 进行分组
> 3. 存入 redis zset 中
...
![image-20221101182132580](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211012013081.png)
...
![image-20221101182220585](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211012013405.png)
