...
![image-20210723171948228](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211091704641.png)
...
![image-20210723172404836](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211091705099.png)
...
![image-20210723172917636](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211091705701.png)
...
![image-20210723173057733](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211091706273.png)

聚合的结果也与查询结果不同，API 也比较特殊。不过同样是 JSON 逐层解析：

![image-20210723173215728](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211091706427.png)

### 30.3.2.业务需求

需求：搜索页面的品牌、城市等信息不应该是在页面写死，而是通过聚合索引库中的酒店数据得来的：

![image-20210723192605566](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211091706757.png)
...
![image-20210723193730799](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211091706493.png)

请求**参数与搜索文档的参数完全一致**。

返回值类型就是页面要展示的最终结果：

![image-20210723203915982](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/202211091706662.png)
