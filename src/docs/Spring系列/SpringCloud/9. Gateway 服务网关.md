...
![image-20210714210131152](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714210131152.png)
...
### 9.2.1.创建 gateway 服务，引入依赖

创建服务：

![image-20210714210919458](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714210919458.png)
...
![image-20210714211908341](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714211908341.png)

### 9.2.5.网关路由的流程图

整个访问的流程如下：

![image-20210714211742956](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714211742956.png)
...
![image-20210714212312871](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714212312871.png)
...
![image-20210714214228409](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714214228409.png)
...
![image-20210714215713563](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714215713563.png)

放入 tomcat 或者 nginx 这样的 web 服务器中，启动并访问。

可以在浏览器控制台看到下面的错误：

![image-20210714215832675](https://gcore.jsdelivr.net/gh/SurplusFate/guide_img@main/img/image-20210714215832675.png)
